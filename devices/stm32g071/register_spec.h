...
constexpr static u32 IWDG_HWCFGR_BASE = IWDG_BASE + 1008;
constexpr static RegisterFieldDescriptor IWDG_HWCFGR_WINDOW = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor IWDG_HWCFGR_PR_DEFAULT = { 4, 4, 0 };


constexpr static u32 IWDG_VERR_BASE = IWDG_BASE + 1012;
constexpr static RegisterFieldDescriptor IWDG_VERR_MINREV = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor IWDG_VERR_MAJREV = { 4, 4, 1 };


constexpr static u32 IWDG_IPIDR_BASE = IWDG_BASE + 1016;
constexpr static RegisterFieldDescriptor IWDG_IPIDR_IPID = { 0, 32, 1 };


constexpr static u32 IWDG_SIDR_BASE = IWDG_BASE + 1020;
constexpr static RegisterFieldDescriptor IWDG_SIDR_SID = { 0, 32, 1 };
...
constexpr static RegisterFieldDescriptor FLASH_ACR_DBG_SWEN = { 18, 1, 0 };
...
constexpr static RegisterFieldDescriptor FLASH_SR_RDERR = { 14, 1, 0 };
...
constexpr static RegisterFieldDescriptor FLASH_CR_RDERRIE = { 26, 1, 0 };
constexpr static RegisterFieldDescriptor FLASH_CR_OBL_LAUNCH = { 27, 1, 0 };
constexpr static RegisterFieldDescriptor FLASH_CR_SEC_PROT = { 28, 1, 0 };
constexpr static RegisterFieldDescriptor FLASH_CR_SEC_PROT2 = { 29, 1, 0 };
...
constexpr static RegisterFieldDescriptor FLASH_ECCR_ADDR_ECC = { 0, 15, 1 };
...
constexpr static RegisterFieldDescriptor FLASH_OPTR_BOREN = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor FLASH_OPTR_BORF_LEV = { 9, 2, 0 };
constexpr static RegisterFieldDescriptor FLASH_OPTR_BORR_LEV = { 11, 2, 0 };
...
constexpr static RegisterFieldDescriptor FLASH_OPTR_nRSTS_HDW = { 15, 1, 0 };
...
constexpr static RegisterFieldDescriptor FLASH_OPTR_NRST_MODE = { 27, 2, 0 };
constexpr static RegisterFieldDescriptor FLASH_OPTR_IRHEN = { 29, 1, 0 };


constexpr static u32 FLASH_PCROP1ASR_BASE = FLASH_BASE + 36;
constexpr static RegisterFieldDescriptor FLASH_PCROP1ASR_PCROP1A_STRT = { 0, 8, 1 };


constexpr static u32 FLASH_PCROP1AER_BASE = FLASH_BASE + 40;
constexpr static RegisterFieldDescriptor FLASH_PCROP1AER_PCROP1A_END = { 0, 8, 1 };
constexpr static RegisterFieldDescriptor FLASH_PCROP1AER_PCROP_RDP = { 31, 1, 1 };


constexpr static u32 FLASH_WRP1AR_BASE = FLASH_BASE + 44;
constexpr static RegisterFieldDescriptor FLASH_WRP1AR_WRP1A_STRT = { 0, 6, 1 };
constexpr static RegisterFieldDescriptor FLASH_WRP1AR_WRP1A_END = { 16, 6, 1 };


constexpr static u32 FLASH_WRP1BR_BASE = FLASH_BASE + 48;
constexpr static RegisterFieldDescriptor FLASH_WRP1BR_WRP1B_STRT = { 0, 6, 1 };
constexpr static RegisterFieldDescriptor FLASH_WRP1BR_WRP1B_END = { 16, 6, 1 };


constexpr static u32 FLASH_PCROP1BSR_BASE = FLASH_BASE + 52;
constexpr static RegisterFieldDescriptor FLASH_PCROP1BSR_PCROP1B_STRT = { 0, 8, 1 };


constexpr static u32 FLASH_PCROP1BER_BASE = FLASH_BASE + 56;
constexpr static RegisterFieldDescriptor FLASH_PCROP1BER_PCROP1B_END = { 0, 8, 1 };


constexpr static u32 FLASH_SECR_BASE = FLASH_BASE + 128;
constexpr static RegisterFieldDescriptor FLASH_SECR_SEC_SIZE = { 0, 7, 1 };
constexpr static RegisterFieldDescriptor FLASH_SECR_BOOT_LOCK = { 16, 1, 1 };
...
constexpr static RegisterFieldDescriptor DBG_IDCODE_DEV_ID = { 0, 16, 1 };
...
constexpr static RegisterFieldDescriptor DBG_APB_FZ1_DBG_TIMER2_STOP = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor DBG_APB_FZ1_DBG_TIM3_STOP = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor DBG_APB_FZ1_DBG_TIMER6_STOP = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor DBG_APB_FZ1_DBG_TIM7_STOP = { 5, 1, 0 };
...
constexpr static RegisterFieldDescriptor DBG_APB_FZ1_DBG_LPTIM2_STOP = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor DBG_APB_FZ1_DBG_LPTIM1_STOP = { 31, 1, 0 };
...
constexpr static RegisterFieldDescriptor DBG_APB_FZ2_DBG_TIM15_STOP = { 16, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_CR_HSIRDY = { 10, 1, 1 };
...
constexpr static RegisterFieldDescriptor RCC_CR_HSERDY = { 17, 1, 1 };
...
constexpr static RegisterFieldDescriptor RCC_CR_HSI48ON = { 22, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_CR_HSI48RDY = { 23, 1, 1 };
constexpr static RegisterFieldDescriptor RCC_CR_PLLON = { 24, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_CR_PLLRDY = { 25, 1, 1 };
...
constexpr static RegisterFieldDescriptor RCC_CFGR_MCOPRE = { 28, 4, 0 };


constexpr static u32 RCC_PLLCFGR_BASE = RCC_BASE + 12;
constexpr static RegisterFieldDescriptor RCC_PLLCFGR_PLLSRC = { 0, 2, 0 };
constexpr static RegisterFieldDescriptor RCC_PLLCFGR_PLLM = { 4, 3, 0 };
constexpr static RegisterFieldDescriptor RCC_PLLCFGR_PLLN = { 8, 7, 0 };
constexpr static RegisterFieldDescriptor RCC_PLLCFGR_PLLPEN = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_PLLCFGR_PLLP = { 17, 5, 0 };
constexpr static RegisterFieldDescriptor RCC_PLLCFGR_PLLQEN = { 24, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_PLLCFGR_PLLQ = { 25, 3, 0 };
constexpr static RegisterFieldDescriptor RCC_PLLCFGR_PLLREN = { 28, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_PLLCFGR_PLLR = { 29, 3, 0 };


constexpr static u32 RCC_CRRCR_BASE = RCC_BASE + 20;
constexpr static RegisterFieldDescriptor RCC_CRRCR_HSI48CAL = { 0, 9, 1 };
...
constexpr static RegisterFieldDescriptor RCC_CIER_HSI48RDYIE = { 2, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_CIER_PLLRDYIE = { 5, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_CIFR_HSI48RDYF = { 2, 1, 1 };
...
constexpr static RegisterFieldDescriptor RCC_CIFR_PLLRDYF = { 5, 1, 1 };
...
constexpr static RegisterFieldDescriptor RCC_CICR_HSI48RDYC = { 2, 1, 2 };
...
constexpr static RegisterFieldDescriptor RCC_CICR_PLLRDYC = { 5, 1, 2 };
...
constexpr static RegisterFieldDescriptor RCC_AHBRSTR_AESRST = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_AHBRSTR_RNGRST = { 18, 1, 0 };


constexpr static u32 RCC_APBRSTR1_BASE = RCC_BASE + 44;
constexpr static RegisterFieldDescriptor RCC_APBRSTR1_TIM2RST = { 0, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBRSTR1_LPUART2RST = { 7, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBRSTR1_FDCANRST = { 12, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBRSTR1_CRSRST = { 16, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBRSTR1_LPUART1RST = { 20, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBRSTR1_CECRST = { 24, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBRSTR1_UCPD1RST = { 25, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBRSTR1_UCPD2RST = { 26, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBRSTR1_DAC1RST = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBRSTR1_LPTIM2RST = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBRSTR1_LPTIM1RST = { 31, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBENR1_TIM2EN = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBENR1_TIM3EN = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBENR1_TIM6EN = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBENR1_TIM7EN = { 5, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBENR1_USART3EN = { 18, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBENR1_USART4EN = { 19, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBENR1_LPUART1EN = { 20, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBENR1_CECEN = { 24, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBENR1_UCPD1EN = { 25, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBENR1_UCPD2EN = { 26, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBENR1_DAC1EN = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBENR1_LPTIM2EN = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBENR1_LPTIM1EN = { 31, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBENR2_TIM15EN = { 16, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_TIM2SMEN = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_TIM3SMEN = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_TIM6SMEN = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_TIM7SMEN = { 5, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_USART3SMEN = { 18, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_USART4SMEN = { 19, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_LPUART1SMEN = { 20, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_CECSMEN = { 24, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_UCPD1SMEN = { 25, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_UCPD2SMEN = { 26, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_DAC1SMEN = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_LPTIM2SMEN = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_APBSMENR1_LPTIM1SMEN = { 31, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_APBSMENR2_TIM15SMEN = { 16, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_CCIPR_USART2SEL = { 2, 2, 0 };
constexpr static RegisterFieldDescriptor RCC_CCIPR_USART3SEL = { 4, 2, 0 };
constexpr static RegisterFieldDescriptor RCC_CCIPR_CECSEL = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_CCIPR_LPUART1SEL = { 10, 2, 0 };
...
constexpr static RegisterFieldDescriptor RCC_CCIPR_LPTIM1SEL = { 18, 2, 0 };
constexpr static RegisterFieldDescriptor RCC_CCIPR_LPTIM2SEL = { 20, 2, 0 };
constexpr static RegisterFieldDescriptor RCC_CCIPR_TIM1SEL = { 22, 1, 0 };
constexpr static RegisterFieldDescriptor RCC_CCIPR_TIM15SEL = { 24, 1, 0 };
...
constexpr static RegisterFieldDescriptor RCC_CSR_IWWGRSTF = { 29, 1, 1 };
...
constexpr static RegisterFieldDescriptor PWR_CR2_PVDE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor PWR_CR2_PVDFT = { 1, 3, 0 };
constexpr static RegisterFieldDescriptor PWR_CR2_PVDRT = { 4, 3, 0 };
...
constexpr static RegisterFieldDescriptor PWR_CR3_RRS = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor PWR_CR3_ULPEN = { 9, 1, 0 };
...
constexpr static RegisterFieldDescriptor PWR_SR2_PVDO = { 11, 1, 1 };
...
constexpr static u32 DMAMUX_DMAMUX_C0CR_BASE = DMAMUX_BASE + 0;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C0CR_DMAREQ_ID = { 0, 8, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C0CR_SOIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C0CR_EGE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C0CR_SE = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C0CR_SPOL = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C0CR_NBREQ = { 19, 5, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C0CR_SYNC_ID = { 24, 5, 0 };


constexpr static u32 DMAMUX_DMAMUX_C1CR_BASE = DMAMUX_BASE + 4;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C1CR_DMAREQ_ID = { 0, 8, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C1CR_SOIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C1CR_EGE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C1CR_SE = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C1CR_SPOL = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C1CR_NBREQ = { 19, 5, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C1CR_SYNC_ID = { 24, 5, 0 };


constexpr static u32 DMAMUX_DMAMUX_C2CR_BASE = DMAMUX_BASE + 8;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C2CR_DMAREQ_ID = { 0, 8, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C2CR_SOIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C2CR_EGE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C2CR_SE = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C2CR_SPOL = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C2CR_NBREQ = { 19, 5, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C2CR_SYNC_ID = { 24, 5, 0 };


constexpr static u32 DMAMUX_DMAMUX_C3CR_BASE = DMAMUX_BASE + 12;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C3CR_DMAREQ_ID = { 0, 8, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C3CR_SOIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C3CR_EGE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C3CR_SE = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C3CR_SPOL = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C3CR_NBREQ = { 19, 5, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C3CR_SYNC_ID = { 24, 5, 0 };


constexpr static u32 DMAMUX_DMAMUX_C4CR_BASE = DMAMUX_BASE + 16;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C4CR_DMAREQ_ID = { 0, 8, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C4CR_SOIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C4CR_EGE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C4CR_SE = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C4CR_SPOL = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C4CR_NBREQ = { 19, 5, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C4CR_SYNC_ID = { 24, 5, 0 };


constexpr static u32 DMAMUX_DMAMUX_C5CR_BASE = DMAMUX_BASE + 20;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C5CR_DMAREQ_ID = { 0, 8, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C5CR_SOIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C5CR_EGE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C5CR_SE = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C5CR_SPOL = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C5CR_NBREQ = { 19, 5, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C5CR_SYNC_ID = { 24, 5, 0 };


constexpr static u32 DMAMUX_DMAMUX_C6CR_BASE = DMAMUX_BASE + 24;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C6CR_DMAREQ_ID = { 0, 8, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C6CR_SOIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C6CR_EGE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C6CR_SE = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C6CR_SPOL = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C6CR_NBREQ = { 19, 5, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_C6CR_SYNC_ID = { 24, 5, 0 };


constexpr static u32 DMAMUX_DMAMUX_CSR_BASE = DMAMUX_BASE + 128;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_CSR_SOF = { 0, 7, 1 };


constexpr static u32 DMAMUX_DMAMUX_CFR_BASE = DMAMUX_BASE + 132;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_CFR_CSOF = { 0, 7, 2 };


constexpr static u32 DMAMUX_DMAMUX_RG0CR_BASE = DMAMUX_BASE + 256;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG0CR_SIG_ID = { 0, 5, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG0CR_OIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG0CR_GE = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG0CR_GPOL = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG0CR_GNBREQ = { 19, 5, 0 };


constexpr static u32 DMAMUX_DMAMUX_RG1CR_BASE = DMAMUX_BASE + 260;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG1CR_SIG_ID = { 0, 5, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG1CR_OIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG1CR_GE = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG1CR_GPOL = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG1CR_GNBREQ = { 19, 5, 0 };


constexpr static u32 DMAMUX_DMAMUX_RG2CR_BASE = DMAMUX_BASE + 264;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG2CR_SIG_ID = { 0, 5, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG2CR_OIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG2CR_GE = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG2CR_GPOL = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG2CR_GNBREQ = { 19, 5, 0 };


constexpr static u32 DMAMUX_DMAMUX_RG3CR_BASE = DMAMUX_BASE + 268;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG3CR_SIG_ID = { 0, 5, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG3CR_OIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG3CR_GE = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG3CR_GPOL = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RG3CR_GNBREQ = { 19, 5, 0 };


constexpr static u32 DMAMUX_DMAMUX_RGSR_BASE = DMAMUX_BASE + 320;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RGSR_OF = { 0, 4, 1 };


constexpr static u32 DMAMUX_DMAMUX_RGCFR_BASE = DMAMUX_BASE + 324;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_RGCFR_COF = { 0, 4, 2 };


constexpr static u32 DMAMUX_DMAMUX_HWCFGR2_BASE = DMAMUX_BASE + 1004;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_HWCFGR2_NUM_DMA_EXT_REQ = { 0, 8, 1 };


constexpr static u32 DMAMUX_DMAMUX_HWCFGR1_BASE = DMAMUX_BASE + 1008;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_HWCFGR1_NUM_DMA_STREAMS = { 0, 8, 1 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_HWCFGR1_NUM_DMA_PERIPH_REQ = { 8, 8, 1 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_HWCFGR1_NUM_DMA_TRIG = { 16, 8, 1 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_HWCFGR1_NUM_DMA_REQGEN = { 24, 8, 1 };


constexpr static u32 DMAMUX_DMAMUX_VERR_BASE = DMAMUX_BASE + 1012;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_VERR_MINREV = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_VERR_MAJREV = { 4, 4, 1 };


constexpr static u32 DMAMUX_DMAMUX_IPIDR_BASE = DMAMUX_BASE + 1016;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_IPIDR_ID = { 0, 32, 1 };


constexpr static u32 DMAMUX_DMAMUX_SIDR_BASE = DMAMUX_BASE + 1020;
constexpr static RegisterFieldDescriptor DMAMUX_DMAMUX_SIDR_SID = { 0, 32, 1 };
...
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR0 = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR1 = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR2 = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR3 = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR4 = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR5 = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR6 = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR7 = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR8 = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR9 = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR10 = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR11 = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR12 = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR13 = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR14 = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR15 = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR16 = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR17 = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RTSR1_TR18 = { 18, 1, 0 };


constexpr static u32 EXTI_FTSR1_BASE = EXTI_BASE + 4;
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR0 = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR1 = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR2 = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR3 = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR4 = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR5 = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR6 = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR7 = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR8 = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR9 = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR10 = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR11 = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR12 = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR13 = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR14 = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR15 = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR16 = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR17 = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FTSR1_TR18 = { 18, 1, 0 };


constexpr static u32 EXTI_SWIER1_BASE = EXTI_BASE + 8;
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER0 = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER1 = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER2 = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER3 = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER4 = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER5 = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER6 = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER7 = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER8 = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER9 = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER10 = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER11 = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER12 = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER13 = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER14 = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER15 = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER16 = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER17 = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_SWIER1_SWIER18 = { 18, 1, 0 };
...
constexpr static RegisterFieldDescriptor EXTI_RPR1_RPIF16 = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RPR1_RPIF17 = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_RPR1_RPIF18 = { 18, 1, 0 };
...
constexpr static RegisterFieldDescriptor EXTI_FPR1_FPIF16 = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FPR1_FPIF17 = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_FPR1_FPIF18 = { 18, 1, 0 };
...
constexpr static RegisterFieldDescriptor EXTI_IMR1_IM16 = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_IMR1_IM17 = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_IMR1_IM18 = { 18, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_IMR1_IM19 = { 19, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_IMR1_IM20 = { 20, 1, 0 };
...
constexpr static RegisterFieldDescriptor EXTI_IMR1_IM27 = { 27, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_IMR1_IM28 = { 28, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_IMR1_IM29 = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_IMR1_IM30 = { 30, 1, 0 };
...
constexpr static RegisterFieldDescriptor EXTI_EMR1_EM16 = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_EMR1_EM17 = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_EMR1_EM18 = { 18, 1, 0 };
...
constexpr static RegisterFieldDescriptor EXTI_EMR1_EM27 = { 27, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_EMR1_EM28 = { 28, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_EMR1_EM29 = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_EMR1_EM30 = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_EMR1_EM31 = { 31, 1, 0 };


constexpr static u32 EXTI_IMR2_BASE = EXTI_BASE + 144;
constexpr static RegisterFieldDescriptor EXTI_IMR2_IM32 = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_IMR2_IM33 = { 1, 1, 0 };


constexpr static u32 EXTI_EMR2_BASE = EXTI_BASE + 148;
constexpr static RegisterFieldDescriptor EXTI_EMR2_EM32 = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor EXTI_EMR2_EM33 = { 1, 1, 0 };


constexpr static u32 EXTI_HWCFGR7_BASE = EXTI_BASE + 984;
constexpr static RegisterFieldDescriptor EXTI_HWCFGR7_CPUEVENT = { 0, 32, 0 };


constexpr static u32 EXTI_HWCFGR6_BASE = EXTI_BASE + 988;
constexpr static RegisterFieldDescriptor EXTI_HWCFGR6_CPUEVENT = { 0, 32, 0 };


constexpr static u32 EXTI_HWCFGR5_BASE = EXTI_BASE + 992;
constexpr static RegisterFieldDescriptor EXTI_HWCFGR5_CPUEVENT = { 0, 32, 0 };


constexpr static u32 EXTI_HWCFGR4_BASE = EXTI_BASE + 996;
constexpr static RegisterFieldDescriptor EXTI_HWCFGR4_EVENT_TRG = { 0, 32, 0 };


constexpr static u32 EXTI_HWCFGR3_BASE = EXTI_BASE + 1000;
constexpr static RegisterFieldDescriptor EXTI_HWCFGR3_EVENT_TRG = { 0, 32, 0 };


constexpr static u32 EXTI_HWCFGR2_BASE = EXTI_BASE + 1004;
constexpr static RegisterFieldDescriptor EXTI_HWCFGR2_EVENT_TRG = { 0, 32, 0 };


constexpr static u32 EXTI_HWCFGR1_BASE = EXTI_BASE + 1008;
constexpr static RegisterFieldDescriptor EXTI_HWCFGR1_NBEVENTS = { 0, 8, 1 };
constexpr static RegisterFieldDescriptor EXTI_HWCFGR1_NBCPUS = { 8, 4, 1 };
constexpr static RegisterFieldDescriptor EXTI_HWCFGR1_CPUEVTEN = { 12, 4, 1 };
constexpr static RegisterFieldDescriptor EXTI_HWCFGR1_NBIOPORT = { 16, 8, 1 };


constexpr static u32 EXTI_VERR_BASE = EXTI_BASE + 1012;
constexpr static RegisterFieldDescriptor EXTI_VERR_MINREV = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor EXTI_VERR_MAJREV = { 4, 4, 1 };


constexpr static u32 EXTI_IPIDR_BASE = EXTI_BASE + 1016;
constexpr static RegisterFieldDescriptor EXTI_IPIDR_ID = { 0, 32, 1 };


constexpr static u32 EXTI_SIDR_BASE = EXTI_BASE + 1020;
constexpr static RegisterFieldDescriptor EXTI_SIDR_ID = { 0, 32, 1 };
...
constexpr static RegisterFieldDescriptor TIM16_TISEL_TI2SEL = { 8, 4, 0 };
...
constexpr static RegisterFieldDescriptor TIM17_TISEL_TI2SEL = { 8, 4, 0 };




constexpr static u32 TIM15_BASE = 1073823744;
constexpr static u32 TIM15_CR1_BASE = TIM15_BASE + 0;
constexpr static RegisterFieldDescriptor TIM15_CR1_CEN = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR1_UDIS = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR1_URS = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR1_OPM = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR1_ARPE = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR1_CKD = { 8, 2, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR1_UIFREMAP = { 11, 1, 0 };


constexpr static u32 TIM15_CR2_BASE = TIM15_BASE + 4;
constexpr static RegisterFieldDescriptor TIM15_CR2_CCPC = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR2_CCUS = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR2_CCDS = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR2_MMS = { 4, 3, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR2_TI1S = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR2_OIS1 = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR2_OIS1N = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CR2_OIS2 = { 10, 1, 0 };


constexpr static u32 TIM15_SMCR_BASE = TIM15_BASE + 8;
constexpr static RegisterFieldDescriptor TIM15_SMCR_SMS1 = { 0, 3, 0 };
constexpr static RegisterFieldDescriptor TIM15_SMCR_TS1 = { 4, 3, 0 };
constexpr static RegisterFieldDescriptor TIM15_SMCR_MSM = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_SMCR_SMS2 = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_SMCR_TS2 = { 20, 2, 0 };


constexpr static u32 TIM15_DIER_BASE = TIM15_BASE + 12;
constexpr static RegisterFieldDescriptor TIM15_DIER_UIE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_DIER_CC1IE = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_DIER_CC2IE = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_DIER_COMIE = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_DIER_TIE = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_DIER_BIE = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_DIER_UDE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_DIER_CC1DE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_DIER_CC2DE = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_DIER_COMDE = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_DIER_TDE = { 14, 1, 0 };


constexpr static u32 TIM15_SR_BASE = TIM15_BASE + 16;
constexpr static RegisterFieldDescriptor TIM15_SR_UIF = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_SR_CC1IF = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_SR_CC2IF = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_SR_COMIF = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_SR_TIF = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_SR_BIF = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_SR_CC1OF = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_SR_CC2OF = { 10, 1, 0 };


constexpr static u32 TIM15_EGR_BASE = TIM15_BASE + 20;
constexpr static RegisterFieldDescriptor TIM15_EGR_UG = { 0, 1, 2 };
constexpr static RegisterFieldDescriptor TIM15_EGR_CC1G = { 1, 1, 2 };
constexpr static RegisterFieldDescriptor TIM15_EGR_CC2G = { 2, 1, 2 };
constexpr static RegisterFieldDescriptor TIM15_EGR_COMG = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_EGR_TG = { 6, 1, 2 };
constexpr static RegisterFieldDescriptor TIM15_EGR_BG = { 7, 1, 2 };


constexpr static u32 TIM15_CCMR1_Output_BASE = TIM15_BASE + 24;
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Output_CC1S = { 0, 2, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Output_OC1FE = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Output_OC1PE = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Output_OC1M1 = { 4, 3, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Output_CC2S = { 8, 2, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Output_OC2FE = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Output_OC2PE = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Output_OC2M1 = { 12, 3, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Output_OC1M2 = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Output_OC2M2 = { 24, 1, 0 };


constexpr static u32 TIM15_CCMR1_Input_BASE = TIM15_BASE + 24;
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Input_CC1S = { 0, 2, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Input_IC1PSC = { 2, 2, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Input_IC1F = { 4, 4, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Input_CC2S = { 8, 2, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Input_IC2PSC = { 10, 2, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCMR1_Input_IC2F = { 12, 4, 0 };


constexpr static u32 TIM15_CCER_BASE = TIM15_BASE + 32;
constexpr static RegisterFieldDescriptor TIM15_CCER_CC1E = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCER_CC1P = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCER_CC1NE = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCER_CC1NP = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCER_CC2E = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCER_CC2P = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_CCER_CC2NP = { 7, 1, 0 };


constexpr static u32 TIM15_CNT_BASE = TIM15_BASE + 36;
constexpr static RegisterFieldDescriptor TIM15_CNT_CNT = { 0, 16, 0 };
constexpr static RegisterFieldDescriptor TIM15_CNT_UIFCPY = { 31, 1, 1 };


constexpr static u32 TIM15_PSC_BASE = TIM15_BASE + 40;
constexpr static RegisterFieldDescriptor TIM15_PSC_PSC = { 0, 16, 0 };


constexpr static u32 TIM15_ARR_BASE = TIM15_BASE + 44;
constexpr static RegisterFieldDescriptor TIM15_ARR_ARR = { 0, 16, 0 };


constexpr static u32 TIM15_RCR_BASE = TIM15_BASE + 48;
constexpr static RegisterFieldDescriptor TIM15_RCR_REP = { 0, 8, 0 };


constexpr static u32 TIM15_CCR1_BASE = TIM15_BASE + 52;
constexpr static RegisterFieldDescriptor TIM15_CCR1_CCR1 = { 0, 16, 0 };


constexpr static u32 TIM15_CCR2_BASE = TIM15_BASE + 56;
constexpr static RegisterFieldDescriptor TIM15_CCR2_CCR2 = { 0, 16, 0 };


constexpr static u32 TIM15_BDTR_BASE = TIM15_BASE + 68;
constexpr static RegisterFieldDescriptor TIM15_BDTR_DTG = { 0, 8, 0 };
constexpr static RegisterFieldDescriptor TIM15_BDTR_LOCK = { 8, 2, 0 };
constexpr static RegisterFieldDescriptor TIM15_BDTR_OSSI = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_BDTR_OSSR = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_BDTR_BKE = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_BDTR_BKP = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_BDTR_AOE = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_BDTR_MOE = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_BDTR_BKF = { 16, 4, 0 };
constexpr static RegisterFieldDescriptor TIM15_BDTR_BKDSRM = { 26, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_BDTR_BKBID = { 28, 1, 0 };


constexpr static u32 TIM15_DCR_BASE = TIM15_BASE + 72;
constexpr static RegisterFieldDescriptor TIM15_DCR_DBA = { 0, 5, 0 };
constexpr static RegisterFieldDescriptor TIM15_DCR_DBL = { 8, 5, 0 };


constexpr static u32 TIM15_DMAR_BASE = TIM15_BASE + 76;
constexpr static RegisterFieldDescriptor TIM15_DMAR_DMAB = { 0, 16, 0 };


constexpr static u32 TIM15_AF1_BASE = TIM15_BASE + 96;
constexpr static RegisterFieldDescriptor TIM15_AF1_BKINE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_AF1_BKCMP1E = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_AF1_BKCMP2E = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_AF1_BKCMP3E = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_AF1_BKINP = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_AF1_BKCMP1P = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_AF1_BKCMP2P = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor TIM15_AF1_BKCMP3P = { 12, 1, 0 };


constexpr static u32 TIM15_TISEL_BASE = TIM15_BASE + 104;
constexpr static RegisterFieldDescriptor TIM15_TISEL_TI1SEL = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor TIM15_TISEL_TI2SEL = { 8, 4, 0 };
...
constexpr static u32 USART3_BASE = 1073760256;
constexpr static u32 USART3_CR1_BASE = USART3_BASE + 0;
constexpr static RegisterFieldDescriptor USART3_CR1_UE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_UESM = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_RE = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_TE = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_IDLEIE = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_RXNEIE = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_TCIE = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_TXEIE = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_PEIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_PS = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_PCE = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_WAKE = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_M0 = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_MME = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_CMIE = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_OVER8 = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_DEDT = { 16, 5, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_DEAT = { 21, 5, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_RTOIE = { 26, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_EOBIE = { 27, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_M1 = { 28, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_FIFOEN = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_TXFEIE = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR1_RXFFIE = { 31, 1, 0 };


constexpr static u32 USART3_CR2_BASE = USART3_BASE + 4;
constexpr static RegisterFieldDescriptor USART3_CR2_SLVEN = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_DIS_NSS = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_ADDM7 = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_LBDL = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_LBDIE = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_LBCL = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_CPHA = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_CPOL = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_CLKEN = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_STOP = { 12, 2, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_LINEN = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_SWAP = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_RXINV = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_TXINV = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_TAINV = { 18, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_MSBFIRST = { 19, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_ABREN = { 20, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_ABRMOD = { 21, 2, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_RTOEN = { 23, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_ADD0_3 = { 24, 4, 0 };
constexpr static RegisterFieldDescriptor USART3_CR2_ADD4_7 = { 28, 4, 0 };


constexpr static u32 USART3_CR3_BASE = USART3_BASE + 8;
constexpr static RegisterFieldDescriptor USART3_CR3_EIE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_IREN = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_IRLP = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_HDSEL = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_NACK = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_SCEN = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_DMAR = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_DMAT = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_RTSE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_CTSE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_CTSIE = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_ONEBIT = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_OVRDIS = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_DDRE = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_DEM = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_DEP = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_SCARCNT = { 17, 3, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_WUS = { 20, 2, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_WUFIE = { 22, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_TXFTIE = { 23, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_TCBGTIE = { 24, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_RXFTCFG = { 25, 3, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_RXFTIE = { 28, 1, 0 };
constexpr static RegisterFieldDescriptor USART3_CR3_TXFTCFG = { 29, 3, 0 };


constexpr static u32 USART3_BRR_BASE = USART3_BASE + 12;
constexpr static RegisterFieldDescriptor USART3_BRR_BRR_0_3 = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor USART3_BRR_BRR_4_15 = { 4, 12, 0 };


constexpr static u32 USART3_GTPR_BASE = USART3_BASE + 16;
constexpr static RegisterFieldDescriptor USART3_GTPR_PSC = { 0, 8, 0 };
constexpr static RegisterFieldDescriptor USART3_GTPR_GT = { 8, 8, 0 };


constexpr static u32 USART3_RTOR_BASE = USART3_BASE + 20;
constexpr static RegisterFieldDescriptor USART3_RTOR_RTO = { 0, 24, 0 };
constexpr static RegisterFieldDescriptor USART3_RTOR_BLEN = { 24, 8, 0 };


constexpr static u32 USART3_RQR_BASE = USART3_BASE + 24;
constexpr static RegisterFieldDescriptor USART3_RQR_ABRRQ = { 0, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_RQR_SBKRQ = { 1, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_RQR_MMRQ = { 2, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_RQR_RXFRQ = { 3, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_RQR_TXFRQ = { 4, 1, 2 };


constexpr static u32 USART3_ISR_BASE = USART3_BASE + 28;
constexpr static RegisterFieldDescriptor USART3_ISR_PE = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_FE = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_NF = { 2, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_ORE = { 3, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_IDLE = { 4, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_RXNE = { 5, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_TC = { 6, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_TXE = { 7, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_LBDF = { 8, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_CTSIF = { 9, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_CTS = { 10, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_RTOF = { 11, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_EOBF = { 12, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_UDR = { 13, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_ABRE = { 14, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_ABRF = { 15, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_BUSY = { 16, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_CMF = { 17, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_SBKF = { 18, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_RWU = { 19, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_WUF = { 20, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_TEACK = { 21, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_REACK = { 22, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_TXFE = { 23, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_RXFF = { 24, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_TCBGT = { 25, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_RXFT = { 26, 1, 1 };
constexpr static RegisterFieldDescriptor USART3_ISR_TXFT = { 27, 1, 1 };


constexpr static u32 USART3_ICR_BASE = USART3_BASE + 32;
constexpr static RegisterFieldDescriptor USART3_ICR_PECF = { 0, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_FECF = { 1, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_NCF = { 2, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_ORECF = { 3, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_IDLECF = { 4, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_TXFECF = { 5, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_TCCF = { 6, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_TCBGTCF = { 7, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_LBDCF = { 8, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_CTSCF = { 9, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_RTOCF = { 11, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_EOBCF = { 12, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_UDRCF = { 13, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_CMCF = { 17, 1, 2 };
constexpr static RegisterFieldDescriptor USART3_ICR_WUCF = { 20, 1, 2 };


constexpr static u32 USART3_RDR_BASE = USART3_BASE + 36;
constexpr static RegisterFieldDescriptor USART3_RDR_RDR = { 0, 9, 1 };


constexpr static u32 USART3_TDR_BASE = USART3_BASE + 40;
constexpr static RegisterFieldDescriptor USART3_TDR_TDR = { 0, 9, 0 };


constexpr static u32 USART3_PRESC_BASE = USART3_BASE + 44;
constexpr static RegisterFieldDescriptor USART3_PRESC_PRESCALER = { 0, 4, 0 };




constexpr static u32 USART4_BASE = 1073761280;
constexpr static u32 USART4_CR1_BASE = USART4_BASE + 0;
constexpr static RegisterFieldDescriptor USART4_CR1_UE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_UESM = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_RE = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_TE = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_IDLEIE = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_RXNEIE = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_TCIE = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_TXEIE = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_PEIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_PS = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_PCE = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_WAKE = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_M0 = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_MME = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_CMIE = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_OVER8 = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_DEDT = { 16, 5, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_DEAT = { 21, 5, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_RTOIE = { 26, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_EOBIE = { 27, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_M1 = { 28, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_FIFOEN = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_TXFEIE = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR1_RXFFIE = { 31, 1, 0 };


constexpr static u32 USART4_CR2_BASE = USART4_BASE + 4;
constexpr static RegisterFieldDescriptor USART4_CR2_SLVEN = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_DIS_NSS = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_ADDM7 = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_LBDL = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_LBDIE = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_LBCL = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_CPHA = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_CPOL = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_CLKEN = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_STOP = { 12, 2, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_LINEN = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_SWAP = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_RXINV = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_TXINV = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_TAINV = { 18, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_MSBFIRST = { 19, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_ABREN = { 20, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_ABRMOD = { 21, 2, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_RTOEN = { 23, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_ADD0_3 = { 24, 4, 0 };
constexpr static RegisterFieldDescriptor USART4_CR2_ADD4_7 = { 28, 4, 0 };


constexpr static u32 USART4_CR3_BASE = USART4_BASE + 8;
constexpr static RegisterFieldDescriptor USART4_CR3_EIE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_IREN = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_IRLP = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_HDSEL = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_NACK = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_SCEN = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_DMAR = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_DMAT = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_RTSE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_CTSE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_CTSIE = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_ONEBIT = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_OVRDIS = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_DDRE = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_DEM = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_DEP = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_SCARCNT = { 17, 3, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_WUS = { 20, 2, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_WUFIE = { 22, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_TXFTIE = { 23, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_TCBGTIE = { 24, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_RXFTCFG = { 25, 3, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_RXFTIE = { 28, 1, 0 };
constexpr static RegisterFieldDescriptor USART4_CR3_TXFTCFG = { 29, 3, 0 };


constexpr static u32 USART4_BRR_BASE = USART4_BASE + 12;
constexpr static RegisterFieldDescriptor USART4_BRR_BRR_0_3 = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor USART4_BRR_BRR_4_15 = { 4, 12, 0 };


constexpr static u32 USART4_GTPR_BASE = USART4_BASE + 16;
constexpr static RegisterFieldDescriptor USART4_GTPR_PSC = { 0, 8, 0 };
constexpr static RegisterFieldDescriptor USART4_GTPR_GT = { 8, 8, 0 };


constexpr static u32 USART4_RTOR_BASE = USART4_BASE + 20;
constexpr static RegisterFieldDescriptor USART4_RTOR_RTO = { 0, 24, 0 };
constexpr static RegisterFieldDescriptor USART4_RTOR_BLEN = { 24, 8, 0 };


constexpr static u32 USART4_RQR_BASE = USART4_BASE + 24;
constexpr static RegisterFieldDescriptor USART4_RQR_ABRRQ = { 0, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_RQR_SBKRQ = { 1, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_RQR_MMRQ = { 2, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_RQR_RXFRQ = { 3, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_RQR_TXFRQ = { 4, 1, 2 };


constexpr static u32 USART4_ISR_BASE = USART4_BASE + 28;
constexpr static RegisterFieldDescriptor USART4_ISR_PE = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_FE = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_NF = { 2, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_ORE = { 3, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_IDLE = { 4, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_RXNE = { 5, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_TC = { 6, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_TXE = { 7, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_LBDF = { 8, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_CTSIF = { 9, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_CTS = { 10, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_RTOF = { 11, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_EOBF = { 12, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_UDR = { 13, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_ABRE = { 14, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_ABRF = { 15, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_BUSY = { 16, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_CMF = { 17, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_SBKF = { 18, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_RWU = { 19, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_WUF = { 20, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_TEACK = { 21, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_REACK = { 22, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_TXFE = { 23, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_RXFF = { 24, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_TCBGT = { 25, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_RXFT = { 26, 1, 1 };
constexpr static RegisterFieldDescriptor USART4_ISR_TXFT = { 27, 1, 1 };


constexpr static u32 USART4_ICR_BASE = USART4_BASE + 32;
constexpr static RegisterFieldDescriptor USART4_ICR_PECF = { 0, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_FECF = { 1, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_NCF = { 2, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_ORECF = { 3, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_IDLECF = { 4, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_TXFECF = { 5, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_TCCF = { 6, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_TCBGTCF = { 7, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_LBDCF = { 8, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_CTSCF = { 9, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_RTOCF = { 11, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_EOBCF = { 12, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_UDRCF = { 13, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_CMCF = { 17, 1, 2 };
constexpr static RegisterFieldDescriptor USART4_ICR_WUCF = { 20, 1, 2 };


constexpr static u32 USART4_RDR_BASE = USART4_BASE + 36;
constexpr static RegisterFieldDescriptor USART4_RDR_RDR = { 0, 9, 1 };


constexpr static u32 USART4_TDR_BASE = USART4_BASE + 40;
constexpr static RegisterFieldDescriptor USART4_TDR_TDR = { 0, 9, 0 };


constexpr static u32 USART4_PRESC_BASE = USART4_BASE + 44;
constexpr static RegisterFieldDescriptor USART4_PRESC_PRESCALER = { 0, 4, 0 };
...
constexpr static u32 SPI1_HWCFGR_BASE = SPI1_BASE + 1008;
constexpr static RegisterFieldDescriptor SPI1_HWCFGR_CRCCFG = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor SPI1_HWCFGR_I2SCFG = { 4, 4, 1 };
constexpr static RegisterFieldDescriptor SPI1_HWCFGR_I2SCKCFG = { 8, 4, 1 };
constexpr static RegisterFieldDescriptor SPI1_HWCFGR_DSCFG = { 12, 4, 1 };
constexpr static RegisterFieldDescriptor SPI1_HWCFGR_NSSCFG = { 16, 4, 1 };


constexpr static u32 SPI1_VERR_BASE = SPI1_BASE + 1012;
constexpr static RegisterFieldDescriptor SPI1_VERR_MINREV = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor SPI1_VERR_MAJREV = { 4, 4, 1 };


constexpr static u32 SPI1_IPIDR_BASE = SPI1_BASE + 1016;
constexpr static RegisterFieldDescriptor SPI1_IPIDR_IPID = { 0, 32, 1 };


constexpr static u32 SPI1_SIDR_BASE = SPI1_BASE + 1020;
constexpr static RegisterFieldDescriptor SPI1_SIDR_SID = { 0, 32, 1 };
...
constexpr static u32 SPI2_HWCFGR_BASE = SPI2_BASE + 1008;
constexpr static RegisterFieldDescriptor SPI2_HWCFGR_CRCCFG = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor SPI2_HWCFGR_I2SCFG = { 4, 4, 1 };
constexpr static RegisterFieldDescriptor SPI2_HWCFGR_I2SCKCFG = { 8, 4, 1 };
constexpr static RegisterFieldDescriptor SPI2_HWCFGR_DSCFG = { 12, 4, 1 };
constexpr static RegisterFieldDescriptor SPI2_HWCFGR_NSSCFG = { 16, 4, 1 };


constexpr static u32 SPI2_VERR_BASE = SPI2_BASE + 1012;
constexpr static RegisterFieldDescriptor SPI2_VERR_MINREV = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor SPI2_VERR_MAJREV = { 4, 4, 1 };


constexpr static u32 SPI2_IPIDR_BASE = SPI2_BASE + 1016;
constexpr static RegisterFieldDescriptor SPI2_IPIDR_IPID = { 0, 32, 1 };


constexpr static u32 SPI2_SIDR_BASE = SPI2_BASE + 1020;
constexpr static RegisterFieldDescriptor SPI2_SIDR_SID = { 0, 32, 1 };
...
constexpr static u32 ADC_ADC_CHSELRMOD0_BASE = ADC_BASE + 40;
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL0 = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL1 = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL2 = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL3 = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL4 = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL5 = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL6 = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL7 = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL8 = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL9 = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL10 = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL11 = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL12 = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL13 = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL14 = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL15 = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL16 = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL17 = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD0_CHSEL18 = { 18, 1, 0 };


constexpr static u32 ADC_ADC_CHSELRMOD1_BASE = ADC_BASE + 40;
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD1_SQ1 = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD1_SQ2 = { 4, 4, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD1_SQ3 = { 8, 4, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD1_SQ4 = { 12, 4, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD1_SQ5 = { 16, 4, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD1_SQ6 = { 20, 4, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD1_SQ7 = { 24, 4, 0 };
constexpr static RegisterFieldDescriptor ADC_ADC_CHSELRMOD1_SQ8 = { 28, 4, 0 };
...
constexpr static u32 COMP_BASE = 1073807872;
constexpr static u32 COMP_COMP1_CSR_BASE = COMP_BASE + 0;
constexpr static RegisterFieldDescriptor COMP_COMP1_CSR_EN = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP1_CSR_INMSEL = { 4, 4, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP1_CSR_INPSEL = { 8, 2, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP1_CSR_WINMODE = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP1_CSR_WINOUT = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP1_CSR_POLARITY = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP1_CSR_HYST = { 16, 2, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP1_CSR_PWRMODE = { 18, 2, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP1_CSR_BLANKSEL = { 20, 5, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP1_CSR_VALUE = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP1_CSR_LOCK = { 31, 1, 0 };


constexpr static u32 COMP_COMP2_CSR_BASE = COMP_BASE + 4;
constexpr static RegisterFieldDescriptor COMP_COMP2_CSR_EN = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP2_CSR_INMSEL = { 4, 4, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP2_CSR_INPSEL = { 8, 2, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP2_CSR_WINMODE = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP2_CSR_WINOUT = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP2_CSR_POLARITY = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP2_CSR_HYST = { 16, 2, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP2_CSR_PWRMODE = { 18, 2, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP2_CSR_BLANKSEL = { 20, 5, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP2_CSR_VALUE = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor COMP_COMP2_CSR_LOCK = { 31, 1, 0 };
...
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE4_CRS = { 1, 1, 1 };
...
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE8_UCPD1 = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE8_UCPD2 = { 1, 1, 1 };
...
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE12_COMP1 = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE12_COMP2 = { 2, 1, 1 };
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE12_COMP3 = { 3, 1, 1 };
...
constexpr static u32 SYSCFG_ITLINE15_BASE = SYSCFG_BASE + 188;
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE15_TIM2 = { 0, 1, 1 };
...
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE17_DAC = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE17_LPTIM1 = { 2, 1, 1 };
...
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE18_LPTIM2 = { 1, 1, 1 };
...
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE21_FDCAN1_IT0 = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE21_FDCAN2_IT0 = { 2, 1, 1 };
...
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE22_FDCAN1_IT1 = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE22_FDCAN2_IT1 = { 2, 1, 1 };
...
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE28_LPUART2 = { 1, 1, 1 };
...
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE29_LPUART1 = { 2, 1, 1 };
...
constexpr static u32 SYSCFG_ITLINE30_BASE = SYSCFG_BASE + 248;
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE30_CEC = { 0, 1, 1 };


constexpr static u32 SYSCFG_ITLINE31_BASE = SYSCFG_BASE + 252;
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE31_RNG = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor SYSCFG_ITLINE31_AES = { 1, 1, 1 };




constexpr static u32 TAMP_BASE = 1073786880;
constexpr static u32 TAMP_CR1_BASE = TAMP_BASE + 0;
constexpr static RegisterFieldDescriptor TAMP_CR1_TAMP1E = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_CR1_TAMP2E = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_CR1_ITAMP1E = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_CR1_ITAMP3E = { 18, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_CR1_ITAMP4E = { 19, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_CR1_ITAMP5E = { 20, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_CR1_ITAMP6E = { 21, 1, 0 };


constexpr static u32 TAMP_CR2_BASE = TAMP_BASE + 4;
constexpr static RegisterFieldDescriptor TAMP_CR2_TAMP1NOER = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_CR2_TAMP2NOER = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_CR2_TAMP1MSK = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_CR2_TAMP2MSK = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_CR2_TAMP1TRG = { 24, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_CR2_TAMP2TRG = { 25, 1, 0 };


constexpr static u32 TAMP_FLTCR_BASE = TAMP_BASE + 12;
constexpr static RegisterFieldDescriptor TAMP_FLTCR_TAMPFREQ = { 0, 3, 0 };
constexpr static RegisterFieldDescriptor TAMP_FLTCR_TAMPFLT = { 3, 2, 0 };
constexpr static RegisterFieldDescriptor TAMP_FLTCR_TAMPPRCH = { 5, 2, 0 };
constexpr static RegisterFieldDescriptor TAMP_FLTCR_TAMPPUDIS = { 7, 1, 0 };


constexpr static u32 TAMP_IER_BASE = TAMP_BASE + 44;
constexpr static RegisterFieldDescriptor TAMP_IER_TAMP1IE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_IER_TAMP2IE = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_IER_ITAMP1IE = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_IER_ITAMP3IE = { 18, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_IER_ITAMP4IE = { 19, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_IER_ITAMP5IE = { 20, 1, 0 };
constexpr static RegisterFieldDescriptor TAMP_IER_ITAMP6IE = { 21, 1, 0 };


constexpr static u32 TAMP_SR_BASE = TAMP_BASE + 48;
constexpr static RegisterFieldDescriptor TAMP_SR_TAMP1F = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_SR_TAMP2F = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_SR_ITAMP1F = { 16, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_SR_ITAMP3F = { 18, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_SR_ITAMP4F = { 19, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_SR_ITAMP5F = { 20, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_SR_ITAMP6F = { 21, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_SR_ITAMP7F = { 22, 1, 1 };


constexpr static u32 TAMP_MISR_BASE = TAMP_BASE + 52;
constexpr static RegisterFieldDescriptor TAMP_MISR_TAMP1MF = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_MISR_TAMP2MF = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_MISR_ITAMP1MF = { 16, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_MISR_ITAMP3MF = { 18, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_MISR_ITAMP4MF = { 19, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_MISR_ITAMP5MF = { 20, 1, 1 };
constexpr static RegisterFieldDescriptor TAMP_MISR_ITAMP6MF = { 21, 1, 1 };


constexpr static u32 TAMP_SCR_BASE = TAMP_BASE + 60;
constexpr static RegisterFieldDescriptor TAMP_SCR_CTAMP1F = { 0, 1, 2 };
constexpr static RegisterFieldDescriptor TAMP_SCR_CTAMP2F = { 1, 1, 2 };
constexpr static RegisterFieldDescriptor TAMP_SCR_CITAMP1F = { 16, 1, 2 };
constexpr static RegisterFieldDescriptor TAMP_SCR_CITAMP3F = { 18, 1, 2 };
constexpr static RegisterFieldDescriptor TAMP_SCR_CITAMP4F = { 19, 1, 2 };
constexpr static RegisterFieldDescriptor TAMP_SCR_CITAMP5F = { 20, 1, 2 };
constexpr static RegisterFieldDescriptor TAMP_SCR_CITAMP6F = { 21, 1, 2 };
constexpr static RegisterFieldDescriptor TAMP_SCR_CITAMP7F = { 22, 1, 2 };


constexpr static u32 TAMP_BKP0R_BASE = TAMP_BASE + 256;
constexpr static RegisterFieldDescriptor TAMP_BKP0R_BKP = { 0, 32, 0 };


constexpr static u32 TAMP_BKP1R_BASE = TAMP_BASE + 260;
constexpr static RegisterFieldDescriptor TAMP_BKP1R_BKP = { 0, 32, 0 };


constexpr static u32 TAMP_BKP2R_BASE = TAMP_BASE + 264;
constexpr static RegisterFieldDescriptor TAMP_BKP2R_BKP = { 0, 32, 0 };


constexpr static u32 TAMP_BKP3R_BASE = TAMP_BASE + 268;
constexpr static RegisterFieldDescriptor TAMP_BKP3R_BKP = { 0, 32, 0 };


constexpr static u32 TAMP_BKP4R_BASE = TAMP_BASE + 272;
constexpr static RegisterFieldDescriptor TAMP_BKP4R_BKP = { 0, 32, 0 };


constexpr static u32 TAMP_HWCFGR2_BASE = TAMP_BASE + 1004;
constexpr static RegisterFieldDescriptor TAMP_HWCFGR2_PTIONREG_OUT = { 0, 8, 1 };
constexpr static RegisterFieldDescriptor TAMP_HWCFGR2_TRUST_ZONE = { 8, 4, 1 };


constexpr static u32 TAMP_HWCFGR1_BASE = TAMP_BASE + 1008;
constexpr static RegisterFieldDescriptor TAMP_HWCFGR1_BACKUP_REGS = { 0, 8, 1 };
constexpr static RegisterFieldDescriptor TAMP_HWCFGR1_TAMPER = { 8, 4, 1 };
constexpr static RegisterFieldDescriptor TAMP_HWCFGR1_ACTIVE_TAMPER = { 12, 4, 1 };
constexpr static RegisterFieldDescriptor TAMP_HWCFGR1_INT_TAMPER = { 16, 16, 1 };


constexpr static u32 TAMP_VERR_BASE = TAMP_BASE + 1012;
constexpr static RegisterFieldDescriptor TAMP_VERR_MINREV = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor TAMP_VERR_MAJREV = { 4, 4, 1 };


constexpr static u32 TAMP_IPIDR_BASE = TAMP_BASE + 1016;
constexpr static RegisterFieldDescriptor TAMP_IPIDR_IPID = { 0, 32, 1 };


constexpr static u32 TAMP_SIDR_BASE = TAMP_BASE + 1020;
constexpr static RegisterFieldDescriptor TAMP_SIDR_SID = { 0, 32, 1 };




constexpr static u32 UCPD1_BASE = 1073782784;
constexpr static u32 UCPD1_CFG1_BASE = UCPD1_BASE + 0;
constexpr static RegisterFieldDescriptor UCPD1_CFG1_HBITCLKDIV = { 0, 6, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG1_IFRGAP = { 6, 5, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG1_TRANSWIN = { 11, 5, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG1_PSC_USBPDCLK = { 17, 3, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG1_RXORDSETEN = { 20, 9, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG1_TXDMAEN = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG1_RXDMAEN = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG1_UCPDEN = { 31, 1, 0 };


constexpr static u32 UCPD1_CFG2_BASE = UCPD1_BASE + 4;
constexpr static RegisterFieldDescriptor UCPD1_CFG2_RXFILTDIS = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG2_RXFILT2N3 = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG2_FORCECLK = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG2_WUPEN = { 3, 1, 0 };


constexpr static u32 UCPD1_CFG3_BASE = UCPD1_BASE + 8;
constexpr static RegisterFieldDescriptor UCPD1_CFG3_TRIM1_NG_CCRPD = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG3_TRIM1_NG_CC1A5 = { 4, 5, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG3_TRIM1_NG_CC3A0 = { 9, 4, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG3_TRIM2_NG_CCRPD = { 16, 4, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG3_TRIM2_NG_CC1A5 = { 20, 5, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CFG3_TRIM2_NG_CC3A0 = { 25, 4, 0 };


constexpr static u32 UCPD1_CR_BASE = UCPD1_BASE + 12;
constexpr static RegisterFieldDescriptor UCPD1_CR_TXMODE = { 0, 2, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_TXSEND = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_TXHRST = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_RXMODE = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_PHYRXEN = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_PHYCCSEL = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_ANASUBMODE = { 7, 2, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_ANAMODE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_CCENABLE = { 10, 2, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_DBATTEN = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_FRSRXEN = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_FRSTX = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_RDCH = { 18, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_CC1TCDIS = { 20, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_CR_CC2TCDIS = { 21, 1, 0 };


constexpr static u32 UCPD1_IMR_BASE = UCPD1_BASE + 16;
constexpr static RegisterFieldDescriptor UCPD1_IMR_TXISIE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_TXMSGDISCIE = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_TXMSGSENTIE = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_TXMSGABTIE = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_HRSTDISCIE = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_HRSTSENTIE = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_TXUNDIE = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_RXNEIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_RXORDDETIE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_RXHRSTDETIE = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_RXOVRIE = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_RXMSGENDIE = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_TYPECEVT1IE = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_TYPECEVT2IE = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_IMR_FRSEVTIE = { 20, 1, 0 };


constexpr static u32 UCPD1_SR_BASE = UCPD1_BASE + 20;
constexpr static RegisterFieldDescriptor UCPD1_SR_TXIS = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_TXMSGDISC = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_TXMSGSENT = { 2, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_TXMSGABT = { 3, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_HRSTDISC = { 4, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_HRSTSENT = { 5, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_TXUND = { 6, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_RXNE = { 8, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_RXORDDET = { 9, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_RXHRSTDET = { 10, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_RXOVR = { 11, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_RXMSGEND = { 12, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_RXERR = { 13, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_TYPECEVT1 = { 14, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_TYPECEVT2 = { 15, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_TYPEC_VSTATE_CC1 = { 16, 2, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_TYPEC_VSTATE_CC2 = { 18, 2, 1 };
constexpr static RegisterFieldDescriptor UCPD1_SR_FRSEVT = { 20, 1, 1 };


constexpr static u32 UCPD1_ICR_BASE = UCPD1_BASE + 24;
constexpr static RegisterFieldDescriptor UCPD1_ICR_TXMSGDISCCF = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_ICR_TXMSGSENTCF = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_ICR_TXMSGABTCF = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_ICR_HRSTDISCCF = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_ICR_HRSTSENTCF = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_ICR_TXUNDCF = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_ICR_RXORDDETCF = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_ICR_RXHRSTDETCF = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_ICR_RXOVRCF = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_ICR_RXMSGENDCF = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_ICR_TYPECEVT1CF = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_ICR_TYPECEVT2CF = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD1_ICR_FRSEVTCF = { 20, 1, 0 };


constexpr static u32 UCPD1_TX_ORDSET_BASE = UCPD1_BASE + 28;
constexpr static RegisterFieldDescriptor UCPD1_TX_ORDSET_TXORDSET = { 0, 20, 0 };


constexpr static u32 UCPD1_TX_PAYSZ_BASE = UCPD1_BASE + 32;
constexpr static RegisterFieldDescriptor UCPD1_TX_PAYSZ_TXPAYSZ = { 0, 10, 0 };


constexpr static u32 UCPD1_TXDR_BASE = UCPD1_BASE + 36;
constexpr static RegisterFieldDescriptor UCPD1_TXDR_TXDATA = { 0, 8, 0 };


constexpr static u32 UCPD1_RX_ORDSET_BASE = UCPD1_BASE + 40;
constexpr static RegisterFieldDescriptor UCPD1_RX_ORDSET_RXORDSET = { 0, 3, 1 };
constexpr static RegisterFieldDescriptor UCPD1_RX_ORDSET_RXSOP3OF4 = { 3, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD1_RX_ORDSET_RXSOPKINVALID = { 4, 3, 1 };


constexpr static u32 UCPD1_RX_PAYSZ_BASE = UCPD1_BASE + 44;
constexpr static RegisterFieldDescriptor UCPD1_RX_PAYSZ_RXPAYSZ = { 0, 10, 0 };


constexpr static u32 UCPD1_RXDR_BASE = UCPD1_BASE + 48;
constexpr static RegisterFieldDescriptor UCPD1_RXDR_RXDATA = { 0, 8, 1 };


constexpr static u32 UCPD1_RX_ORDEXT1_BASE = UCPD1_BASE + 52;
constexpr static RegisterFieldDescriptor UCPD1_RX_ORDEXT1_RXSOPX1 = { 0, 20, 0 };


constexpr static u32 UCPD1_RX_ORDEXT2_BASE = UCPD1_BASE + 56;
constexpr static RegisterFieldDescriptor UCPD1_RX_ORDEXT2_RXSOPX2 = { 0, 20, 0 };


constexpr static u32 UCPD1_IPVER_BASE = UCPD1_BASE + 1012;
constexpr static RegisterFieldDescriptor UCPD1_IPVER_IPVER = { 0, 32, 1 };


constexpr static u32 UCPD1_IPID_BASE = UCPD1_BASE + 1016;
constexpr static RegisterFieldDescriptor UCPD1_IPID_IPID = { 0, 32, 1 };


constexpr static u32 UCPD1_MID_BASE = UCPD1_BASE + 1020;
constexpr static RegisterFieldDescriptor UCPD1_MID_IPID = { 0, 32, 1 };




constexpr static u32 UCPD2_BASE = 1073783808;
constexpr static u32 UCPD2_CFG1_BASE = UCPD2_BASE + 0;
constexpr static RegisterFieldDescriptor UCPD2_CFG1_HBITCLKDIV = { 0, 6, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG1_IFRGAP = { 6, 5, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG1_TRANSWIN = { 11, 5, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG1_PSC_USBPDCLK = { 17, 3, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG1_RXORDSETEN = { 20, 9, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG1_TXDMAEN = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG1_RXDMAEN = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG1_UCPDEN = { 31, 1, 0 };


constexpr static u32 UCPD2_CFG2_BASE = UCPD2_BASE + 4;
constexpr static RegisterFieldDescriptor UCPD2_CFG2_RXFILTDIS = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG2_RXFILT2N3 = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG2_FORCECLK = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG2_WUPEN = { 3, 1, 0 };


constexpr static u32 UCPD2_CFG3_BASE = UCPD2_BASE + 8;
constexpr static RegisterFieldDescriptor UCPD2_CFG3_TRIM1_NG_CCRPD = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG3_TRIM1_NG_CC1A5 = { 4, 5, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG3_TRIM1_NG_CC3A0 = { 9, 4, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG3_TRIM2_NG_CCRPD = { 16, 4, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG3_TRIM2_NG_CC1A5 = { 20, 5, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CFG3_TRIM2_NG_CC3A0 = { 25, 4, 0 };


constexpr static u32 UCPD2_CR_BASE = UCPD2_BASE + 12;
constexpr static RegisterFieldDescriptor UCPD2_CR_TXMODE = { 0, 2, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_TXSEND = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_TXHRST = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_RXMODE = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_PHYRXEN = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_PHYCCSEL = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_ANASUBMODE = { 7, 2, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_ANAMODE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_CCENABLE = { 10, 2, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_DBATTEN = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_FRSRXEN = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_FRSTX = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_RDCH = { 18, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_CC1TCDIS = { 20, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_CR_CC2TCDIS = { 21, 1, 0 };


constexpr static u32 UCPD2_IMR_BASE = UCPD2_BASE + 16;
constexpr static RegisterFieldDescriptor UCPD2_IMR_TXISIE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_TXMSGDISCIE = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_TXMSGSENTIE = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_TXMSGABTIE = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_HRSTDISCIE = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_HRSTSENTIE = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_TXUNDIE = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_RXNEIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_RXORDDETIE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_RXHRSTDETIE = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_RXOVRIE = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_RXMSGENDIE = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_TYPECEVT1IE = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_TYPECEVT2IE = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_IMR_FRSEVTIE = { 20, 1, 0 };


constexpr static u32 UCPD2_SR_BASE = UCPD2_BASE + 20;
constexpr static RegisterFieldDescriptor UCPD2_SR_TXIS = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_TXMSGDISC = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_TXMSGSENT = { 2, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_TXMSGABT = { 3, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_HRSTDISC = { 4, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_HRSTSENT = { 5, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_TXUND = { 6, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_RXNE = { 8, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_RXORDDET = { 9, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_RXHRSTDET = { 10, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_RXOVR = { 11, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_RXMSGEND = { 12, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_RXERR = { 13, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_TYPECEVT1 = { 14, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_TYPECEVT2 = { 15, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_TYPEC_VSTATE_CC1 = { 16, 2, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_TYPEC_VSTATE_CC2 = { 18, 2, 1 };
constexpr static RegisterFieldDescriptor UCPD2_SR_FRSEVT = { 20, 1, 1 };


constexpr static u32 UCPD2_ICR_BASE = UCPD2_BASE + 24;
constexpr static RegisterFieldDescriptor UCPD2_ICR_TXMSGDISCCF = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_ICR_TXMSGSENTCF = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_ICR_TXMSGABTCF = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_ICR_HRSTDISCCF = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_ICR_HRSTSENTCF = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_ICR_TXUNDCF = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_ICR_RXORDDETCF = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_ICR_RXHRSTDETCF = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_ICR_RXOVRCF = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_ICR_RXMSGENDCF = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_ICR_TYPECEVT1CF = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_ICR_TYPECEVT2CF = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor UCPD2_ICR_FRSEVTCF = { 20, 1, 0 };


constexpr static u32 UCPD2_TX_ORDSET_BASE = UCPD2_BASE + 28;
constexpr static RegisterFieldDescriptor UCPD2_TX_ORDSET_TXORDSET = { 0, 20, 0 };


constexpr static u32 UCPD2_TX_PAYSZ_BASE = UCPD2_BASE + 32;
constexpr static RegisterFieldDescriptor UCPD2_TX_PAYSZ_TXPAYSZ = { 0, 10, 0 };


constexpr static u32 UCPD2_TXDR_BASE = UCPD2_BASE + 36;
constexpr static RegisterFieldDescriptor UCPD2_TXDR_TXDATA = { 0, 8, 0 };


constexpr static u32 UCPD2_RX_ORDSET_BASE = UCPD2_BASE + 40;
constexpr static RegisterFieldDescriptor UCPD2_RX_ORDSET_RXORDSET = { 0, 3, 1 };
constexpr static RegisterFieldDescriptor UCPD2_RX_ORDSET_RXSOP3OF4 = { 3, 1, 1 };
constexpr static RegisterFieldDescriptor UCPD2_RX_ORDSET_RXSOPKINVALID = { 4, 3, 1 };


constexpr static u32 UCPD2_RX_PAYSZ_BASE = UCPD2_BASE + 44;
constexpr static RegisterFieldDescriptor UCPD2_RX_PAYSZ_RXPAYSZ = { 0, 10, 0 };


constexpr static u32 UCPD2_RXDR_BASE = UCPD2_BASE + 48;
constexpr static RegisterFieldDescriptor UCPD2_RXDR_RXDATA = { 0, 8, 1 };


constexpr static u32 UCPD2_RX_ORDEXT1_BASE = UCPD2_BASE + 52;
constexpr static RegisterFieldDescriptor UCPD2_RX_ORDEXT1_RXSOPX1 = { 0, 20, 0 };


constexpr static u32 UCPD2_RX_ORDEXT2_BASE = UCPD2_BASE + 56;
constexpr static RegisterFieldDescriptor UCPD2_RX_ORDEXT2_RXSOPX2 = { 0, 20, 0 };


constexpr static u32 UCPD2_IPVER_BASE = UCPD2_BASE + 1012;
constexpr static RegisterFieldDescriptor UCPD2_IPVER_IPVER = { 0, 32, 1 };


constexpr static u32 UCPD2_IPID_BASE = UCPD2_BASE + 1016;
constexpr static RegisterFieldDescriptor UCPD2_IPID_IPID = { 0, 32, 1 };


constexpr static u32 UCPD2_MID_BASE = UCPD2_BASE + 1020;
constexpr static RegisterFieldDescriptor UCPD2_MID_IPID = { 0, 32, 1 };




constexpr static u32 LPTIM1_BASE = 1073773568;
constexpr static u32 LPTIM1_ISR_BASE = LPTIM1_BASE + 0;
constexpr static RegisterFieldDescriptor LPTIM1_ISR_CMPM = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor LPTIM1_ISR_ARRM = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor LPTIM1_ISR_EXTTRIG = { 2, 1, 1 };
constexpr static RegisterFieldDescriptor LPTIM1_ISR_CMPOK = { 3, 1, 1 };
constexpr static RegisterFieldDescriptor LPTIM1_ISR_ARROK = { 4, 1, 1 };
constexpr static RegisterFieldDescriptor LPTIM1_ISR_UP = { 5, 1, 1 };
constexpr static RegisterFieldDescriptor LPTIM1_ISR_DOWN = { 6, 1, 1 };


constexpr static u32 LPTIM1_ICR_BASE = LPTIM1_BASE + 4;
constexpr static RegisterFieldDescriptor LPTIM1_ICR_CMPMCF = { 0, 1, 2 };
constexpr static RegisterFieldDescriptor LPTIM1_ICR_ARRMCF = { 1, 1, 2 };
constexpr static RegisterFieldDescriptor LPTIM1_ICR_EXTTRIGCF = { 2, 1, 2 };
constexpr static RegisterFieldDescriptor LPTIM1_ICR_CMPOKCF = { 3, 1, 2 };
constexpr static RegisterFieldDescriptor LPTIM1_ICR_ARROKCF = { 4, 1, 2 };
constexpr static RegisterFieldDescriptor LPTIM1_ICR_UPCF = { 5, 1, 2 };
constexpr static RegisterFieldDescriptor LPTIM1_ICR_DOWNCF = { 6, 1, 2 };


constexpr static u32 LPTIM1_IER_BASE = LPTIM1_BASE + 8;
constexpr static RegisterFieldDescriptor LPTIM1_IER_CMPMIE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_IER_ARRMIE = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_IER_EXTTRIGIE = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_IER_CMPOKIE = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_IER_ARROKIE = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_IER_UPIE = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_IER_DOWNIE = { 6, 1, 0 };


constexpr static u32 LPTIM1_CFGR_BASE = LPTIM1_BASE + 12;
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_CKSEL = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_CKPOL = { 1, 2, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_CKFLT = { 3, 2, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_TRGFLT = { 6, 2, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_PRESC = { 9, 3, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_TRIGSEL = { 13, 3, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_TRIGEN = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_TIMOUT = { 19, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_WAVE = { 20, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_WAVPOL = { 21, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_PRELOAD = { 22, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_COUNTMODE = { 23, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR_ENC = { 24, 1, 0 };


constexpr static u32 LPTIM1_CR_BASE = LPTIM1_BASE + 16;
constexpr static RegisterFieldDescriptor LPTIM1_CR_ENABLE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CR_SNGSTRT = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CR_CNTSTRT = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CR_COUNTRST = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CR_RSTARE = { 4, 1, 0 };


constexpr static u32 LPTIM1_CMP_BASE = LPTIM1_BASE + 20;
constexpr static RegisterFieldDescriptor LPTIM1_CMP_CMP = { 0, 16, 0 };


constexpr static u32 LPTIM1_ARR_BASE = LPTIM1_BASE + 24;
constexpr static RegisterFieldDescriptor LPTIM1_ARR_ARR = { 0, 16, 0 };


constexpr static u32 LPTIM1_CNT_BASE = LPTIM1_BASE + 28;
constexpr static RegisterFieldDescriptor LPTIM1_CNT_CNT = { 0, 16, 1 };


constexpr static u32 LPTIM1_CFGR2_BASE = LPTIM1_BASE + 36;
constexpr static RegisterFieldDescriptor LPTIM1_CFGR2_IN1SEL = { 0, 2, 0 };
constexpr static RegisterFieldDescriptor LPTIM1_CFGR2_IN2SEL = { 4, 2, 0 };




constexpr static u32 LPTIM2_BASE = 1073779712;
constexpr static u32 LPTIM2_ISR_BASE = LPTIM2_BASE + 0;
constexpr static RegisterFieldDescriptor LPTIM2_ISR_CMPM = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor LPTIM2_ISR_ARRM = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor LPTIM2_ISR_EXTTRIG = { 2, 1, 1 };
constexpr static RegisterFieldDescriptor LPTIM2_ISR_CMPOK = { 3, 1, 1 };
constexpr static RegisterFieldDescriptor LPTIM2_ISR_ARROK = { 4, 1, 1 };
constexpr static RegisterFieldDescriptor LPTIM2_ISR_UP = { 5, 1, 1 };
constexpr static RegisterFieldDescriptor LPTIM2_ISR_DOWN = { 6, 1, 1 };


constexpr static u32 LPTIM2_ICR_BASE = LPTIM2_BASE + 4;
constexpr static RegisterFieldDescriptor LPTIM2_ICR_CMPMCF = { 0, 1, 2 };
constexpr static RegisterFieldDescriptor LPTIM2_ICR_ARRMCF = { 1, 1, 2 };
constexpr static RegisterFieldDescriptor LPTIM2_ICR_EXTTRIGCF = { 2, 1, 2 };
constexpr static RegisterFieldDescriptor LPTIM2_ICR_CMPOKCF = { 3, 1, 2 };
constexpr static RegisterFieldDescriptor LPTIM2_ICR_ARROKCF = { 4, 1, 2 };
constexpr static RegisterFieldDescriptor LPTIM2_ICR_UPCF = { 5, 1, 2 };
constexpr static RegisterFieldDescriptor LPTIM2_ICR_DOWNCF = { 6, 1, 2 };


constexpr static u32 LPTIM2_IER_BASE = LPTIM2_BASE + 8;
constexpr static RegisterFieldDescriptor LPTIM2_IER_CMPMIE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_IER_ARRMIE = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_IER_EXTTRIGIE = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_IER_CMPOKIE = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_IER_ARROKIE = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_IER_UPIE = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_IER_DOWNIE = { 6, 1, 0 };


constexpr static u32 LPTIM2_CFGR_BASE = LPTIM2_BASE + 12;
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_CKSEL = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_CKPOL = { 1, 2, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_CKFLT = { 3, 2, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_TRGFLT = { 6, 2, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_PRESC = { 9, 3, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_TRIGSEL = { 13, 3, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_TRIGEN = { 17, 2, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_TIMOUT = { 19, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_WAVE = { 20, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_WAVPOL = { 21, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_PRELOAD = { 22, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_COUNTMODE = { 23, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR_ENC = { 24, 1, 0 };


constexpr static u32 LPTIM2_CR_BASE = LPTIM2_BASE + 16;
constexpr static RegisterFieldDescriptor LPTIM2_CR_ENABLE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CR_SNGSTRT = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CR_CNTSTRT = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CR_COUNTRST = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CR_RSTARE = { 4, 1, 0 };


constexpr static u32 LPTIM2_CMP_BASE = LPTIM2_BASE + 20;
constexpr static RegisterFieldDescriptor LPTIM2_CMP_CMP = { 0, 16, 0 };


constexpr static u32 LPTIM2_ARR_BASE = LPTIM2_BASE + 24;
constexpr static RegisterFieldDescriptor LPTIM2_ARR_ARR = { 0, 16, 0 };


constexpr static u32 LPTIM2_CNT_BASE = LPTIM2_BASE + 28;
constexpr static RegisterFieldDescriptor LPTIM2_CNT_CNT = { 0, 16, 1 };


constexpr static u32 LPTIM2_CFGR2_BASE = LPTIM2_BASE + 36;
constexpr static RegisterFieldDescriptor LPTIM2_CFGR2_IN1SEL = { 0, 2, 0 };
constexpr static RegisterFieldDescriptor LPTIM2_CFGR2_IN2SEL = { 4, 2, 0 };




constexpr static u32 LPUART_BASE = 1073774592;
constexpr static u32 LPUART_CR1_BASE = LPUART_BASE + 0;
constexpr static RegisterFieldDescriptor LPUART_CR1_UE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_UESM = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_RE = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_TE = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_IDLEIE = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_RXNEIE = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_TCIE = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_TXEIE = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_PEIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_PS = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_PCE = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_WAKE = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_M0 = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_MME = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_CMIE = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_DEDT0 = { 16, 5, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_DEAT = { 21, 5, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_M1 = { 28, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_FIFOEN = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_TXFEIE = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR1_RXFFIE = { 31, 1, 0 };


constexpr static u32 LPUART_CR2_BASE = LPUART_BASE + 4;
constexpr static RegisterFieldDescriptor LPUART_CR2_ADDM7 = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR2_STOP = { 12, 2, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR2_SWAP = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR2_RXINV = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR2_TXINV = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR2_TAINV = { 18, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR2_MSBFIRST = { 19, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR2_ADD0_3 = { 24, 4, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR2_ADD4_7 = { 28, 4, 0 };


constexpr static u32 LPUART_CR3_BASE = LPUART_BASE + 8;
constexpr static RegisterFieldDescriptor LPUART_CR3_EIE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_HDSEL = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_DMAR = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_DMAT = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_RTSE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_CTSE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_CTSIE = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_OVRDIS = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_DDRE = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_DEM = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_DEP = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_WUS = { 20, 2, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_WUFIE = { 22, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_TXFTIE = { 23, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_RXFTCFG = { 25, 3, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_RXFTIE = { 28, 1, 0 };
constexpr static RegisterFieldDescriptor LPUART_CR3_TXFTCFG = { 29, 3, 0 };


constexpr static u32 LPUART_BRR_BASE = LPUART_BASE + 12;
constexpr static RegisterFieldDescriptor LPUART_BRR_BRR = { 0, 20, 0 };


constexpr static u32 LPUART_RQR_BASE = LPUART_BASE + 24;
constexpr static RegisterFieldDescriptor LPUART_RQR_ABRRQ = { 0, 1, 2 };
constexpr static RegisterFieldDescriptor LPUART_RQR_SBKRQ = { 1, 1, 2 };
constexpr static RegisterFieldDescriptor LPUART_RQR_MMRQ = { 2, 1, 2 };
constexpr static RegisterFieldDescriptor LPUART_RQR_RXFRQ = { 3, 1, 2 };
constexpr static RegisterFieldDescriptor LPUART_RQR_TXFRQ = { 4, 1, 2 };


constexpr static u32 LPUART_ISR_BASE = LPUART_BASE + 28;
constexpr static RegisterFieldDescriptor LPUART_ISR_PE = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_FE = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_NF = { 2, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_ORE = { 3, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_IDLE = { 4, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_RXNE = { 5, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_TC = { 6, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_TXE = { 7, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_CTSIF = { 9, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_CTS = { 10, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_BUSY = { 16, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_CMF = { 17, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_SBKF = { 18, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_RWU = { 19, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_WUF = { 20, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_TEACK = { 21, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_REACK = { 22, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_TXFE = { 23, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_RXFF = { 24, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_RXFT = { 26, 1, 1 };
constexpr static RegisterFieldDescriptor LPUART_ISR_TXFT = { 27, 1, 1 };


constexpr static u32 LPUART_ICR_BASE = LPUART_BASE + 32;
constexpr static RegisterFieldDescriptor LPUART_ICR_PECF = { 0, 1, 2 };
constexpr static RegisterFieldDescriptor LPUART_ICR_FECF = { 1, 1, 2 };
constexpr static RegisterFieldDescriptor LPUART_ICR_NCF = { 2, 1, 2 };
constexpr static RegisterFieldDescriptor LPUART_ICR_ORECF = { 3, 1, 2 };
constexpr static RegisterFieldDescriptor LPUART_ICR_IDLECF = { 4, 1, 2 };
constexpr static RegisterFieldDescriptor LPUART_ICR_TCCF = { 6, 1, 2 };
constexpr static RegisterFieldDescriptor LPUART_ICR_CTSCF = { 9, 1, 2 };
constexpr static RegisterFieldDescriptor LPUART_ICR_CMCF = { 17, 1, 2 };
constexpr static RegisterFieldDescriptor LPUART_ICR_WUCF = { 20, 1, 2 };


constexpr static u32 LPUART_RDR_BASE = LPUART_BASE + 36;
constexpr static RegisterFieldDescriptor LPUART_RDR_RDR = { 0, 9, 1 };


constexpr static u32 LPUART_TDR_BASE = LPUART_BASE + 40;
constexpr static RegisterFieldDescriptor LPUART_TDR_TDR = { 0, 9, 0 };


constexpr static u32 LPUART_PRESC_BASE = LPUART_BASE + 44;
constexpr static RegisterFieldDescriptor LPUART_PRESC_PRESCALER = { 0, 4, 0 };


constexpr static u32 LPUART_HWCFGR2_BASE = LPUART_BASE + 1004;
constexpr static RegisterFieldDescriptor LPUART_HWCFGR2_CFG1 = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor LPUART_HWCFGR2_CFG2 = { 4, 4, 0 };


constexpr static u32 LPUART_HWCFGR1_BASE = LPUART_BASE + 1008;
constexpr static RegisterFieldDescriptor LPUART_HWCFGR1_CFG1 = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor LPUART_HWCFGR1_CFG2 = { 4, 4, 0 };
constexpr static RegisterFieldDescriptor LPUART_HWCFGR1_CFG3 = { 8, 4, 0 };
constexpr static RegisterFieldDescriptor LPUART_HWCFGR1_CFG4 = { 12, 4, 0 };
constexpr static RegisterFieldDescriptor LPUART_HWCFGR1_CFG5 = { 16, 4, 0 };
constexpr static RegisterFieldDescriptor LPUART_HWCFGR1_CFG6 = { 20, 4, 0 };
constexpr static RegisterFieldDescriptor LPUART_HWCFGR1_CFG7 = { 24, 4, 0 };
constexpr static RegisterFieldDescriptor LPUART_HWCFGR1_CFG8 = { 28, 4, 0 };


constexpr static u32 LPUART_VERR_BASE = LPUART_BASE + 1012;
constexpr static RegisterFieldDescriptor LPUART_VERR_MINREV = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor LPUART_VERR_MAJREV = { 4, 4, 1 };


constexpr static u32 LPUART_IPIDR_BASE = LPUART_BASE + 1016;
constexpr static RegisterFieldDescriptor LPUART_IPIDR_IPID = { 0, 32, 1 };


constexpr static u32 LPUART_SIDR_BASE = LPUART_BASE + 1020;
constexpr static RegisterFieldDescriptor LPUART_SIDR_SID = { 0, 32, 1 };




constexpr static u32 HDMI_CEC_BASE = 1073772544;
constexpr static u32 HDMI_CEC_CEC_CR_BASE = HDMI_CEC_BASE + 0;
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_CR_CECEN = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_CR_TXSOM = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_CR_TXEOM = { 2, 1, 0 };


constexpr static u32 HDMI_CEC_CEC_CFGR_BASE = HDMI_CEC_BASE + 4;
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_CFGR_SFT = { 0, 3, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_CFGR_RXTOL = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_CFGR_BRESTP = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_CFGR_BREGEN = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_CFGR_LBPEGEN = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_CFGR_BRDNOGEN = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_CFGR_SFTOPT = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_CFGR_OAR = { 16, 15, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_CFGR_LSTN = { 31, 1, 0 };


constexpr static u32 HDMI_CEC_CEC_TXDR_BASE = HDMI_CEC_BASE + 8;
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_TXDR_TXD = { 0, 8, 2 };


constexpr static u32 HDMI_CEC_CEC_RXDR_BASE = HDMI_CEC_BASE + 12;
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_RXDR_RXD = { 0, 8, 1 };


constexpr static u32 HDMI_CEC_CEC_ISR_BASE = HDMI_CEC_BASE + 16;
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_RXBR = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_RXEND = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_RXOVR = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_BRE = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_SBPE = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_LBPE = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_RXACKE = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_ARBLST = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_TXBR = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_TXEND = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_TXUDR = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_TXERR = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_ISR_TXACKE = { 12, 1, 0 };


constexpr static u32 HDMI_CEC_CEC_IER_BASE = HDMI_CEC_BASE + 20;
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_RXBRIE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_RXENDIE = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_RXOVRIE = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_BREIE = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_SBPEIE = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_LBPEIE = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_RXACKIE = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_ARBLSTIE = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_TXBRIE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_TXENDIE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_TXUDRIE = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_TXERRIE = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor HDMI_CEC_CEC_IER_TXACKIE = { 12, 1, 0 };




constexpr static u32 DAC_BASE = 1073771520;
constexpr static u32 DAC_DAC_CR_BASE = DAC_BASE + 0;
constexpr static RegisterFieldDescriptor DAC_DAC_CR_EN1 = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_TEN1 = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_TSEL1 = { 2, 4, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_WAVE1 = { 6, 2, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_MAMP1 = { 8, 4, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_DMAEN1 = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_DMAUDRIE1 = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_CEN1 = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_EN2 = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_TEN2 = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_TSEL2 = { 18, 4, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_WAVE2 = { 22, 2, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_MAMP2 = { 24, 4, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_DMAEN2 = { 28, 1, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_DMAUDRIE2 = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CR_CEN2 = { 30, 1, 0 };


constexpr static u32 DAC_DAC_SWTRGR_BASE = DAC_BASE + 4;
constexpr static RegisterFieldDescriptor DAC_DAC_SWTRGR_SWTRIG1 = { 0, 1, 2 };
constexpr static RegisterFieldDescriptor DAC_DAC_SWTRGR_SWTRIG2 = { 1, 1, 2 };


constexpr static u32 DAC_DAC_DHR12R1_BASE = DAC_BASE + 8;
constexpr static RegisterFieldDescriptor DAC_DAC_DHR12R1_DACC1DHR = { 0, 12, 0 };


constexpr static u32 DAC_DAC_DHR12L1_BASE = DAC_BASE + 12;
constexpr static RegisterFieldDescriptor DAC_DAC_DHR12L1_DACC1DHR = { 4, 12, 0 };


constexpr static u32 DAC_DAC_DHR8R1_BASE = DAC_BASE + 16;
constexpr static RegisterFieldDescriptor DAC_DAC_DHR8R1_DACC1DHR = { 0, 8, 0 };


constexpr static u32 DAC_DAC_DHR12R2_BASE = DAC_BASE + 20;
constexpr static RegisterFieldDescriptor DAC_DAC_DHR12R2_DACC2DHR = { 0, 12, 0 };


constexpr static u32 DAC_DAC_DHR12L2_BASE = DAC_BASE + 24;
constexpr static RegisterFieldDescriptor DAC_DAC_DHR12L2_DACC2DHR = { 4, 12, 0 };


constexpr static u32 DAC_DAC_DHR8R2_BASE = DAC_BASE + 28;
constexpr static RegisterFieldDescriptor DAC_DAC_DHR8R2_DACC2DHR = { 0, 8, 0 };


constexpr static u32 DAC_DAC_DHR12RD_BASE = DAC_BASE + 32;
constexpr static RegisterFieldDescriptor DAC_DAC_DHR12RD_DACC1DHR = { 0, 12, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_DHR12RD_DACC2DHR = { 16, 12, 0 };


constexpr static u32 DAC_DAC_DHR12LD_BASE = DAC_BASE + 36;
constexpr static RegisterFieldDescriptor DAC_DAC_DHR12LD_DACC1DHR = { 4, 12, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_DHR12LD_DACC2DHR = { 20, 12, 0 };


constexpr static u32 DAC_DAC_DHR8RD_BASE = DAC_BASE + 40;
constexpr static RegisterFieldDescriptor DAC_DAC_DHR8RD_DACC1DHR = { 0, 8, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_DHR8RD_DACC2DHR = { 8, 8, 0 };


constexpr static u32 DAC_DAC_DOR1_BASE = DAC_BASE + 44;
constexpr static RegisterFieldDescriptor DAC_DAC_DOR1_DACC1DOR = { 0, 12, 1 };


constexpr static u32 DAC_DAC_DOR2_BASE = DAC_BASE + 48;
constexpr static RegisterFieldDescriptor DAC_DAC_DOR2_DACC2DOR = { 0, 12, 1 };


constexpr static u32 DAC_DAC_SR_BASE = DAC_BASE + 52;
constexpr static RegisterFieldDescriptor DAC_DAC_SR_DMAUDR1 = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_SR_CAL_FLAG1 = { 14, 1, 1 };
constexpr static RegisterFieldDescriptor DAC_DAC_SR_BWST1 = { 15, 1, 1 };
constexpr static RegisterFieldDescriptor DAC_DAC_SR_DMAUDR2 = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_SR_CAL_FLAG2 = { 30, 1, 1 };
constexpr static RegisterFieldDescriptor DAC_DAC_SR_BWST2 = { 31, 1, 1 };


constexpr static u32 DAC_DAC_CCR_BASE = DAC_BASE + 56;
constexpr static RegisterFieldDescriptor DAC_DAC_CCR_OTRIM1 = { 0, 5, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_CCR_OTRIM2 = { 16, 5, 0 };


constexpr static u32 DAC_DAC_MCR_BASE = DAC_BASE + 60;
constexpr static RegisterFieldDescriptor DAC_DAC_MCR_MODE1 = { 0, 3, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_MCR_MODE2 = { 16, 3, 0 };


constexpr static u32 DAC_DAC_SHSR1_BASE = DAC_BASE + 64;
constexpr static RegisterFieldDescriptor DAC_DAC_SHSR1_TSAMPLE1 = { 0, 10, 0 };


constexpr static u32 DAC_DAC_SHSR2_BASE = DAC_BASE + 68;
constexpr static RegisterFieldDescriptor DAC_DAC_SHSR2_TSAMPLE2 = { 0, 10, 0 };


constexpr static u32 DAC_DAC_SHHR_BASE = DAC_BASE + 72;
constexpr static RegisterFieldDescriptor DAC_DAC_SHHR_THOLD1 = { 0, 10, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_SHHR_THOLD2 = { 16, 10, 0 };


constexpr static u32 DAC_DAC_SHRR_BASE = DAC_BASE + 76;
constexpr static RegisterFieldDescriptor DAC_DAC_SHRR_TREFRESH1 = { 0, 8, 0 };
constexpr static RegisterFieldDescriptor DAC_DAC_SHRR_TREFRESH2 = { 16, 8, 0 };


constexpr static u32 DAC_IP_HWCFGR0_BASE = DAC_BASE + 1008;
constexpr static RegisterFieldDescriptor DAC_IP_HWCFGR0_DUAL = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor DAC_IP_HWCFGR0_LFSR = { 4, 4, 0 };
constexpr static RegisterFieldDescriptor DAC_IP_HWCFGR0_TRIANGLE = { 8, 4, 0 };
constexpr static RegisterFieldDescriptor DAC_IP_HWCFGR0_SAMPLE = { 12, 4, 0 };
constexpr static RegisterFieldDescriptor DAC_IP_HWCFGR0_OR_CFG = { 16, 8, 0 };


constexpr static u32 DAC_VERR_BASE = DAC_BASE + 1012;
constexpr static RegisterFieldDescriptor DAC_VERR_MINREV = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor DAC_VERR_MAJREV = { 4, 4, 1 };


constexpr static u32 DAC_IPIDR_BASE = DAC_BASE + 1016;
constexpr static RegisterFieldDescriptor DAC_IPIDR_IPID = { 0, 32, 1 };


constexpr static u32 DAC_SIDR_BASE = DAC_BASE + 1020;
constexpr static RegisterFieldDescriptor DAC_SIDR_SID = { 0, 32, 1 };
...
constexpr static u32 RTC_TR_BASE = RTC_BASE + 0;
constexpr static RegisterFieldDescriptor RTC_TR_SU = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_TR_ST = { 4, 3, 0 };
constexpr static RegisterFieldDescriptor RTC_TR_MNU = { 8, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_TR_MNT = { 12, 3, 0 };
constexpr static RegisterFieldDescriptor RTC_TR_HU = { 16, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_TR_HT = { 20, 2, 0 };
constexpr static RegisterFieldDescriptor RTC_TR_PM = { 22, 1, 0 };


constexpr static u32 RTC_DR_BASE = RTC_BASE + 4;
constexpr static RegisterFieldDescriptor RTC_DR_DU = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_DR_DT = { 4, 2, 0 };
constexpr static RegisterFieldDescriptor RTC_DR_MU = { 8, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_DR_MT = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_DR_WDU = { 13, 3, 0 };
constexpr static RegisterFieldDescriptor RTC_DR_YU = { 16, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_DR_YT = { 20, 4, 0 };


constexpr static u32 RTC_SSR_BASE = RTC_BASE + 8;
constexpr static RegisterFieldDescriptor RTC_SSR_SS = { 0, 16, 1 };


constexpr static u32 RTC_ICSR_BASE = RTC_BASE + 12;
constexpr static RegisterFieldDescriptor RTC_ICSR_ALRAWF = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_ICSR_ALRBWF = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_ICSR_WUTWF = { 2, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_ICSR_SHPF = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ICSR_INITS = { 4, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_ICSR_RSF = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ICSR_INITF = { 6, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_ICSR_INIT = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ICSR_RECALPF = { 16, 1, 1 };


constexpr static u32 RTC_PRER_BASE = RTC_BASE + 16;
constexpr static RegisterFieldDescriptor RTC_PRER_PREDIV_S = { 0, 15, 0 };
constexpr static RegisterFieldDescriptor RTC_PRER_PREDIV_A = { 16, 7, 0 };


constexpr static u32 RTC_WUTR_BASE = RTC_BASE + 20;
constexpr static RegisterFieldDescriptor RTC_WUTR_WUT = { 0, 16, 0 };


constexpr static u32 RTC_CR_BASE = RTC_BASE + 24;
constexpr static RegisterFieldDescriptor RTC_CR_WUCKSEL = { 0, 3, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_TSEDGE = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_REFCKON = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_BYPSHAD = { 5, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_FMT = { 6, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_ALRAE = { 8, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_ALRBE = { 9, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_WUTE = { 10, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_TSE = { 11, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_ALRAIE = { 12, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_ALRBIE = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_WUTIE = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_TSIE = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_ADD1H = { 16, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_SUB1H = { 17, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_BKP = { 18, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_COSEL = { 19, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_POL = { 20, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_OSEL = { 21, 2, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_COE = { 23, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_ITSE = { 24, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_TAMPTS = { 25, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_TAMPOE = { 26, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_TAMPALRM_PU = { 29, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_TAMPALRM_TYPE = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CR_OUT2EN = { 31, 1, 0 };


constexpr static u32 RTC_WPR_BASE = RTC_BASE + 36;
constexpr static RegisterFieldDescriptor RTC_WPR_KEY = { 0, 8, 2 };


constexpr static u32 RTC_CALR_BASE = RTC_BASE + 40;
constexpr static RegisterFieldDescriptor RTC_CALR_CALM = { 0, 9, 0 };
constexpr static RegisterFieldDescriptor RTC_CALR_CALW16 = { 13, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CALR_CALW8 = { 14, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_CALR_CALP = { 15, 1, 0 };


constexpr static u32 RTC_SHIFTR_BASE = RTC_BASE + 44;
constexpr static RegisterFieldDescriptor RTC_SHIFTR_SUBFS = { 0, 15, 2 };
constexpr static RegisterFieldDescriptor RTC_SHIFTR_ADD1S = { 31, 1, 2 };


constexpr static u32 RTC_TSTR_BASE = RTC_BASE + 48;
constexpr static RegisterFieldDescriptor RTC_TSTR_SU = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor RTC_TSTR_ST = { 4, 3, 1 };
constexpr static RegisterFieldDescriptor RTC_TSTR_MNU = { 8, 4, 1 };
constexpr static RegisterFieldDescriptor RTC_TSTR_MNT = { 12, 3, 1 };
constexpr static RegisterFieldDescriptor RTC_TSTR_HU = { 16, 4, 1 };
constexpr static RegisterFieldDescriptor RTC_TSTR_HT = { 20, 2, 1 };
constexpr static RegisterFieldDescriptor RTC_TSTR_PM = { 22, 1, 1 };


constexpr static u32 RTC_TSDR_BASE = RTC_BASE + 52;
constexpr static RegisterFieldDescriptor RTC_TSDR_DU = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor RTC_TSDR_DT = { 4, 2, 1 };
constexpr static RegisterFieldDescriptor RTC_TSDR_MU = { 8, 4, 1 };
constexpr static RegisterFieldDescriptor RTC_TSDR_MT = { 12, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_TSDR_WDU = { 13, 3, 1 };


constexpr static u32 RTC_TSSSR_BASE = RTC_BASE + 56;
constexpr static RegisterFieldDescriptor RTC_TSSSR_SS = { 0, 16, 1 };


constexpr static u32 RTC_ALRMAR_BASE = RTC_BASE + 64;
constexpr static RegisterFieldDescriptor RTC_ALRMAR_SU = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_ST = { 4, 3, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_MSK1 = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_MNU = { 8, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_MNT = { 12, 3, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_MSK2 = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_HU = { 16, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_HT = { 20, 2, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_PM = { 22, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_MSK3 = { 23, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_DU = { 24, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_DT = { 28, 2, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_WDSEL = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMAR_MSK4 = { 31, 1, 0 };


constexpr static u32 RTC_ALRMASSR_BASE = RTC_BASE + 68;
constexpr static RegisterFieldDescriptor RTC_ALRMASSR_SS = { 0, 15, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMASSR_MASKSS = { 24, 4, 0 };


constexpr static u32 RTC_ALRMBR_BASE = RTC_BASE + 72;
constexpr static RegisterFieldDescriptor RTC_ALRMBR_SU = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_ST = { 4, 3, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_MSK1 = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_MNU = { 8, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_MNT = { 12, 3, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_MSK2 = { 15, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_HU = { 16, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_HT = { 20, 2, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_PM = { 22, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_MSK3 = { 23, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_DU = { 24, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_DT = { 28, 2, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_WDSEL = { 30, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBR_MSK4 = { 31, 1, 0 };


constexpr static u32 RTC_ALRMBSSR_BASE = RTC_BASE + 76;
constexpr static RegisterFieldDescriptor RTC_ALRMBSSR_SS = { 0, 15, 0 };
constexpr static RegisterFieldDescriptor RTC_ALRMBSSR_MASKSS = { 24, 4, 0 };


constexpr static u32 RTC_SR_BASE = RTC_BASE + 80;
constexpr static RegisterFieldDescriptor RTC_SR_ALRAF = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_SR_ALRBF = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_SR_WUTF = { 2, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_SR_TSF = { 3, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_SR_TSOVF = { 4, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_SR_ITSF = { 5, 1, 1 };


constexpr static u32 RTC_MISR_BASE = RTC_BASE + 84;
constexpr static RegisterFieldDescriptor RTC_MISR_ALRAMF = { 0, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_MISR_ALRBMF = { 1, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_MISR_WUTMF = { 2, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_MISR_TSMF = { 3, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_MISR_TSOVMF = { 4, 1, 1 };
constexpr static RegisterFieldDescriptor RTC_MISR_ITSMF = { 5, 1, 1 };


constexpr static u32 RTC_SCR_BASE = RTC_BASE + 92;
constexpr static RegisterFieldDescriptor RTC_SCR_CALRAF = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_SCR_CALRBF = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_SCR_CWUTF = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_SCR_CTSF = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_SCR_CTSOVF = { 4, 1, 0 };
constexpr static RegisterFieldDescriptor RTC_SCR_CITSF = { 5, 1, 0 };


constexpr static u32 RTC_HWCFGR_BASE = RTC_BASE + 1008;
constexpr static RegisterFieldDescriptor RTC_HWCFGR_ALARMB = { 0, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_HWCFGR_WAKEUP = { 4, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_HWCFGR_SMOOTH_CALIB = { 8, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_HWCFGR_TIMESTAMP = { 12, 4, 0 };
constexpr static RegisterFieldDescriptor RTC_HWCFGR_OPTIONREG_OUT = { 16, 8, 0 };
constexpr static RegisterFieldDescriptor RTC_HWCFGR_TRUST_ZONE = { 24, 4, 0 };


constexpr static u32 RTC_VERR_BASE = RTC_BASE + 1012;
constexpr static RegisterFieldDescriptor RTC_VERR_MINREV = { 0, 4, 1 };
constexpr static RegisterFieldDescriptor RTC_VERR_MAJREV = { 4, 4, 1 };


constexpr static u32 RTC_IPIDR_BASE = RTC_BASE + 1016;
constexpr static RegisterFieldDescriptor RTC_IPIDR_IPID = { 0, 32, 1 };


constexpr static u32 RTC_SIDR_BASE = RTC_BASE + 1020;
constexpr static RegisterFieldDescriptor RTC_SIDR_SID = { 0, 32, 1 };
...
constexpr static u32 TIM6_BASE = 1073745920;
constexpr static u32 TIM6_CR1_BASE = TIM6_BASE + 0;
constexpr static RegisterFieldDescriptor TIM6_CR1_CEN = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TIM6_CR1_UDIS = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor TIM6_CR1_URS = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor TIM6_CR1_OPM = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor TIM6_CR1_ARPE = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor TIM6_CR1_UIFREMAP = { 11, 1, 0 };


constexpr static u32 TIM6_CR2_BASE = TIM6_BASE + 4;
constexpr static RegisterFieldDescriptor TIM6_CR2_MMS = { 4, 3, 0 };


constexpr static u32 TIM6_DIER_BASE = TIM6_BASE + 12;
constexpr static RegisterFieldDescriptor TIM6_DIER_UIE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TIM6_DIER_UDE = { 8, 1, 0 };


constexpr static u32 TIM6_SR_BASE = TIM6_BASE + 16;
constexpr static RegisterFieldDescriptor TIM6_SR_UIF = { 0, 1, 0 };


constexpr static u32 TIM6_EGR_BASE = TIM6_BASE + 20;
constexpr static RegisterFieldDescriptor TIM6_EGR_UG = { 0, 1, 2 };


constexpr static u32 TIM6_CNT_BASE = TIM6_BASE + 36;
constexpr static RegisterFieldDescriptor TIM6_CNT_CNT = { 0, 16, 0 };
constexpr static RegisterFieldDescriptor TIM6_CNT_UIFCPY = { 31, 1, 0 };


constexpr static u32 TIM6_PSC_BASE = TIM6_BASE + 40;
constexpr static RegisterFieldDescriptor TIM6_PSC_PSC = { 0, 16, 0 };


constexpr static u32 TIM6_ARR_BASE = TIM6_BASE + 44;
constexpr static RegisterFieldDescriptor TIM6_ARR_ARR = { 0, 16, 0 };




constexpr static u32 TIM7_BASE = 1073746944;
constexpr static u32 TIM7_CR1_BASE = TIM7_BASE + 0;
constexpr static RegisterFieldDescriptor TIM7_CR1_CEN = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TIM7_CR1_UDIS = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor TIM7_CR1_URS = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor TIM7_CR1_OPM = { 3, 1, 0 };
constexpr static RegisterFieldDescriptor TIM7_CR1_ARPE = { 7, 1, 0 };
constexpr static RegisterFieldDescriptor TIM7_CR1_UIFREMAP = { 11, 1, 0 };


constexpr static u32 TIM7_CR2_BASE = TIM7_BASE + 4;
constexpr static RegisterFieldDescriptor TIM7_CR2_MMS = { 4, 3, 0 };


constexpr static u32 TIM7_DIER_BASE = TIM7_BASE + 12;
constexpr static RegisterFieldDescriptor TIM7_DIER_UIE = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor TIM7_DIER_UDE = { 8, 1, 0 };


constexpr static u32 TIM7_SR_BASE = TIM7_BASE + 16;
constexpr static RegisterFieldDescriptor TIM7_SR_UIF = { 0, 1, 0 };


constexpr static u32 TIM7_EGR_BASE = TIM7_BASE + 20;
constexpr static RegisterFieldDescriptor TIM7_EGR_UG = { 0, 1, 2 };


constexpr static u32 TIM7_CNT_BASE = TIM7_BASE + 36;
constexpr static RegisterFieldDescriptor TIM7_CNT_CNT = { 0, 16, 0 };
constexpr static RegisterFieldDescriptor TIM7_CNT_UIFCPY = { 31, 1, 0 };


constexpr static u32 TIM7_PSC_BASE = TIM7_BASE + 40;
constexpr static RegisterFieldDescriptor TIM7_PSC_PSC = { 0, 16, 0 };


constexpr static u32 TIM7_ARR_BASE = TIM7_BASE + 44;
constexpr static RegisterFieldDescriptor TIM7_ARR_ARR = { 0, 16, 0 };
...
constexpr static u32 VREFBUF_VREFBUF_CSR_BASE = VREFBUF_BASE + 0;
constexpr static RegisterFieldDescriptor VREFBUF_VREFBUF_CSR_ENVR = { 0, 1, 0 };
constexpr static RegisterFieldDescriptor VREFBUF_VREFBUF_CSR_HIZ = { 1, 1, 0 };
constexpr static RegisterFieldDescriptor VREFBUF_VREFBUF_CSR_VRS = { 2, 1, 0 };
constexpr static RegisterFieldDescriptor VREFBUF_VREFBUF_CSR_VRR = { 3, 1, 1 };


constexpr static u32 VREFBUF_VREFBUF_CCR_BASE = VREFBUF_BASE + 4;
constexpr static RegisterFieldDescriptor VREFBUF_VREFBUF_CCR_TRIM = { 0, 6, 0 };
...
struct IWDG {
	...
	struct HWCFGR {
		DECL_REGISTER(IWDG_HWCFGR_BASE);
		constexpr static RegisterField<IWDG_HWCFGR_WINDOW> WINDOW {};
		constexpr static RegisterField<IWDG_HWCFGR_PR_DEFAULT> PR_DEFAULT {};
	};

	struct VERR {
		DECL_REGISTER(IWDG_VERR_BASE);
		constexpr static RegisterField<IWDG_VERR_MINREV> MINREV {};
		constexpr static RegisterField<IWDG_VERR_MAJREV> MAJREV {};
	};

	struct IPIDR {
		DECL_REGISTER(IWDG_IPIDR_BASE);
		constexpr static RegisterField<IWDG_IPIDR_IPID> IPID {};
	};

	struct SIDR {
		DECL_REGISTER(IWDG_SIDR_BASE);
		constexpr static RegisterField<IWDG_SIDR_SID> SID {};
	};
...
struct FLASH {
	struct ACR {
		...
		constexpr static RegisterField<FLASH_ACR_DBG_SWEN> DBG_SWEN {};
	};
	...
	struct SR {
		...
		constexpr static RegisterField<FLASH_SR_RDERR> RDERR {};
	...
	struct CR {
		...
		constexpr static RegisterField<FLASH_CR_RDERRIE> RDERRIE {};
		constexpr static RegisterField<FLASH_CR_OBL_LAUNCH> OBL_LAUNCH {};
		constexpr static RegisterField<FLASH_CR_SEC_PROT> SEC_PROT {};
		constexpr static RegisterField<FLASH_CR_SEC_PROT2> SEC_PROT2 {};
	...
	struct OPTR {
		...
		constexpr static RegisterField<FLASH_OPTR_BOREN> BOREN {};
		constexpr static RegisterField<FLASH_OPTR_BORF_LEV> BORF_LEV {};
		constexpr static RegisterField<FLASH_OPTR_BORR_LEV> BORR_LEV {};
		...
		constexpr static RegisterField<FLASH_OPTR_nRSTS_HDW> nRSTS_HDW {};
		...
		constexpr static RegisterField<FLASH_OPTR_NRST_MODE> NRST_MODE {};
		constexpr static RegisterField<FLASH_OPTR_IRHEN> IRHEN {};
	};

	struct PCROP1ASR {
		DECL_REGISTER(FLASH_PCROP1ASR_BASE);
		constexpr static RegisterField<FLASH_PCROP1ASR_PCROP1A_STRT> PCROP1A_STRT {};
	};

	struct PCROP1AER {
		DECL_REGISTER(FLASH_PCROP1AER_BASE);
		constexpr static RegisterField<FLASH_PCROP1AER_PCROP1A_END> PCROP1A_END {};
		constexpr static RegisterField<FLASH_PCROP1AER_PCROP_RDP> PCROP_RDP {};
	};
	...
	struct PCROP1BSR {
		DECL_REGISTER(FLASH_PCROP1BSR_BASE);
		constexpr static RegisterField<FLASH_PCROP1BSR_PCROP1B_STRT> PCROP1B_STRT {};
	};

	struct PCROP1BER {
		DECL_REGISTER(FLASH_PCROP1BER_BASE);
		constexpr static RegisterField<FLASH_PCROP1BER_PCROP1B_END> PCROP1B_END {};
	};

	struct SECR {
		DECL_REGISTER(FLASH_SECR_BASE);
		constexpr static RegisterField<FLASH_SECR_SEC_SIZE> SEC_SIZE {};
		constexpr static RegisterField<FLASH_SECR_BOOT_LOCK> BOOT_LOCK {};
	};
...
struct DBG {
	...
	struct APB_FZ1 {
		...
		constexpr static RegisterField<DBG_APB_FZ1_DBG_TIMER2_STOP> DBG_TIMER2_STOP {};
		constexpr static RegisterField<DBG_APB_FZ1_DBG_TIM3_STOP> DBG_TIM3_STOP {};
		constexpr static RegisterField<DBG_APB_FZ1_DBG_TIMER6_STOP> DBG_TIMER6_STOP {};
		constexpr static RegisterField<DBG_APB_FZ1_DBG_TIM7_STOP> DBG_TIM7_STOP {};
		...
		constexpr static RegisterField<DBG_APB_FZ1_DBG_LPTIM2_STOP> DBG_LPTIM2_STOP {};
		constexpr static RegisterField<DBG_APB_FZ1_DBG_LPTIM1_STOP> DBG_LPTIM1_STOP {};
	};
	...
	struct APB_FZ2 {
		...
		constexpr static RegisterField<DBG_APB_FZ2_DBG_TIM15_STOP> DBG_TIM15_STOP {};
...
struct RCC {
	struct CR {
		...
		constexpr static RegisterField<RCC_CR_HSI48ON> HSI48ON {};
		constexpr static RegisterField<RCC_CR_HSI48RDY> HSI48RDY {};
	...
	struct PLLCFGR {
		DECL_REGISTER(RCC_PLLCFGR_BASE);
		constexpr static RegisterField<RCC_PLLCFGR_PLLSRC> PLLSRC {};
		constexpr static RegisterField<RCC_PLLCFGR_PLLM> PLLM {};
		constexpr static RegisterField<RCC_PLLCFGR_PLLN> PLLN {};
		constexpr static RegisterField<RCC_PLLCFGR_PLLPEN> PLLPEN {};
		constexpr static RegisterField<RCC_PLLCFGR_PLLP> PLLP {};
		constexpr static RegisterField<RCC_PLLCFGR_PLLQEN> PLLQEN {};
		constexpr static RegisterField<RCC_PLLCFGR_PLLQ> PLLQ {};
		constexpr static RegisterField<RCC_PLLCFGR_PLLREN> PLLREN {};
		constexpr static RegisterField<RCC_PLLCFGR_PLLR> PLLR {};
	};

	struct CRRCR {
		DECL_REGISTER(RCC_CRRCR_BASE);
		constexpr static RegisterField<RCC_CRRCR_HSI48CAL> HSI48CAL {};
	};
	...
	struct CIER {
		...
		constexpr static RegisterField<RCC_CIER_HSI48RDYIE> HSI48RDYIE {};
		constexpr static RegisterField<RCC_CIER_HSIRDYIE> HSIRDYIE {};
		constexpr static RegisterField<RCC_CIER_HSERDYIE> HSERDYIE {};
		constexpr static RegisterField<RCC_CIER_PLLRDYIE> PLLRDYIE {};
	};
	...
	struct CIFR {
		...
		constexpr static RegisterField<RCC_CIFR_HSI48RDYF> HSI48RDYF {};
		constexpr static RegisterField<RCC_CIFR_HSIRDYF> HSIRDYF {};
		constexpr static RegisterField<RCC_CIFR_HSERDYF> HSERDYF {};
		constexpr static RegisterField<RCC_CIFR_PLLRDYF> PLLRDYF {};
	...
	struct CICR {
		...
		constexpr static RegisterField<RCC_CICR_HSI48RDYC> HSI48RDYC {};
		constexpr static RegisterField<RCC_CICR_HSIRDYC> HSIRDYC {};
		constexpr static RegisterField<RCC_CICR_HSERDYC> HSERDYC {};
		constexpr static RegisterField<RCC_CICR_PLLRDYC> PLLRDYC {};
	...
	struct AHBRSTR {
		...
		constexpr static RegisterField<RCC_AHBRSTR_AESRST> AESRST {};
		constexpr static RegisterField<RCC_AHBRSTR_RNGRST> RNGRST {};
	};

	struct APBRSTR1 {
		DECL_REGISTER(RCC_APBRSTR1_BASE);
		constexpr static RegisterField<RCC_APBRSTR1_TIM2RST> TIM2RST {};
		...
		constexpr static RegisterField<RCC_APBRSTR1_LPUART2RST> LPUART2RST {};
		...
		constexpr static RegisterField<RCC_APBRSTR1_FDCANRST> FDCANRST {};
		...
		constexpr static RegisterField<RCC_APBRSTR1_CRSRST> CRSRST {};
		...
		constexpr static RegisterField<RCC_APBRSTR1_LPUART1RST> LPUART1RST {};
		...
		constexpr static RegisterField<RCC_APBRSTR1_CECRST> CECRST {};
		constexpr static RegisterField<RCC_APBRSTR1_UCPD1RST> UCPD1RST {};
		constexpr static RegisterField<RCC_APBRSTR1_UCPD2RST> UCPD2RST {};
		constexpr static RegisterField<RCC_APBRSTR1_DBGRST> DBGRST {};
		constexpr static RegisterField<RCC_APBRSTR1_PWRRST> PWRRST {};
		constexpr static RegisterField<RCC_APBRSTR1_DAC1RST> DAC1RST {};
		constexpr static RegisterField<RCC_APBRSTR1_LPTIM2RST> LPTIM2RST {};
		constexpr static RegisterField<RCC_APBRSTR1_LPTIM1RST> LPTIM1RST {};
	};
	...
	struct APBENR1 {
		...
		constexpr static RegisterField<RCC_APBENR1_TIM2EN> TIM2EN {};
		constexpr static RegisterField<RCC_APBENR1_TIM3EN> TIM3EN {};
		constexpr static RegisterField<RCC_APBENR1_TIM6EN> TIM6EN {};
		constexpr static RegisterField<RCC_APBENR1_TIM7EN> TIM7EN {};
		...
		constexpr static RegisterField<RCC_APBENR1_USART3EN> USART3EN {};
		constexpr static RegisterField<RCC_APBENR1_USART4EN> USART4EN {};
		constexpr static RegisterField<RCC_APBENR1_LPUART1EN> LPUART1EN {};
		constexpr static RegisterField<RCC_APBENR1_I2C1EN> I2C1EN {};
		constexpr static RegisterField<RCC_APBENR1_I2C2EN> I2C2EN {};
		constexpr static RegisterField<RCC_APBENR1_CECEN> CECEN {};
		constexpr static RegisterField<RCC_APBENR1_UCPD1EN> UCPD1EN {};
		constexpr static RegisterField<RCC_APBENR1_UCPD2EN> UCPD2EN {};
		constexpr static RegisterField<RCC_APBENR1_DBGEN> DBGEN {};
		constexpr static RegisterField<RCC_APBENR1_PWREN> PWREN {};
		constexpr static RegisterField<RCC_APBENR1_DAC1EN> DAC1EN {};
		constexpr static RegisterField<RCC_APBENR1_LPTIM2EN> LPTIM2EN {};
		constexpr static RegisterField<RCC_APBENR1_LPTIM1EN> LPTIM1EN {};
	};
	...
	struct APBENR2 {
		...
		constexpr static RegisterField<RCC_APBENR2_TIM15EN> TIM15EN {};
	...
	struct APBSMENR1 {
		...
		constexpr static RegisterField<RCC_APBSMENR1_TIM2SMEN> TIM2SMEN {};
		constexpr static RegisterField<RCC_APBSMENR1_TIM3SMEN> TIM3SMEN {};
		constexpr static RegisterField<RCC_APBSMENR1_TIM6SMEN> TIM6SMEN {};
		constexpr static RegisterField<RCC_APBSMENR1_TIM7SMEN> TIM7SMEN {};
		...
		constexpr static RegisterField<RCC_APBSMENR1_USART3SMEN> USART3SMEN {};
		constexpr static RegisterField<RCC_APBSMENR1_USART4SMEN> USART4SMEN {};
		constexpr static RegisterField<RCC_APBSMENR1_LPUART1SMEN> LPUART1SMEN {};
		...
		constexpr static RegisterField<RCC_APBSMENR1_CECSMEN> CECSMEN {};
		constexpr static RegisterField<RCC_APBSMENR1_UCPD1SMEN> UCPD1SMEN {};
		constexpr static RegisterField<RCC_APBSMENR1_UCPD2SMEN> UCPD2SMEN {};
		constexpr static RegisterField<RCC_APBSMENR1_DBGSMEN> DBGSMEN {};
		constexpr static RegisterField<RCC_APBSMENR1_PWRSMEN> PWRSMEN {};
		constexpr static RegisterField<RCC_APBSMENR1_DAC1SMEN> DAC1SMEN {};
		constexpr static RegisterField<RCC_APBSMENR1_LPTIM2SMEN> LPTIM2SMEN {};
		constexpr static RegisterField<RCC_APBSMENR1_LPTIM1SMEN> LPTIM1SMEN {};
	};
	...
	struct APBSMENR2 {
		...
		constexpr static RegisterField<RCC_APBSMENR2_TIM15SMEN> TIM15SMEN {};
	...
	struct CCIPR {
		...
		constexpr static RegisterField<RCC_CCIPR_USART2SEL> USART2SEL {};
		constexpr static RegisterField<RCC_CCIPR_USART3SEL> USART3SEL {};
		constexpr static RegisterField<RCC_CCIPR_CECSEL> CECSEL {};
		constexpr static RegisterField<RCC_CCIPR_LPUART1SEL> LPUART1SEL {};
		constexpr static RegisterField<RCC_CCIPR_I2C1SEL> I2C1SEL {};
		constexpr static RegisterField<RCC_CCIPR_I2C2I2S1SEL> I2C2I2S1SEL {};
		constexpr static RegisterField<RCC_CCIPR_LPTIM1SEL> LPTIM1SEL {};
		constexpr static RegisterField<RCC_CCIPR_LPTIM2SEL> LPTIM2SEL {};
		constexpr static RegisterField<RCC_CCIPR_TIM1SEL> TIM1SEL {};
		constexpr static RegisterField<RCC_CCIPR_TIM15SEL> TIM15SEL {};
	...
	struct CSR {
		...
		constexpr static RegisterField<RCC_CSR_IWWGRSTF> IWWGRSTF {};
...
struct PWR {
	...
	struct CR2 {
		...
		constexpr static RegisterField<PWR_CR2_PVDE> PVDE {};
		constexpr static RegisterField<PWR_CR2_PVDFT> PVDFT {};
		constexpr static RegisterField<PWR_CR2_PVDRT> PVDRT {};
	};
	...
	struct CR3 {
		...
		constexpr static RegisterField<PWR_CR3_RRS> RRS {};
		constexpr static RegisterField<PWR_CR3_ULPEN> ULPEN {};
	...
	struct SR2 {
		...
		constexpr static RegisterField<PWR_SR2_PVDO> PVDO {};
	};
...
struct DMAMUX {
	struct DMAMUX_C0CR {
		DECL_REGISTER(DMAMUX_DMAMUX_C0CR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_C0CR_DMAREQ_ID> DMAREQ_ID {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C0CR_SOIE> SOIE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C0CR_EGE> EGE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C0CR_SE> SE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C0CR_SPOL> SPOL {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C0CR_NBREQ> NBREQ {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C0CR_SYNC_ID> SYNC_ID {};
	};

	struct DMAMUX_C1CR {
		DECL_REGISTER(DMAMUX_DMAMUX_C1CR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_C1CR_DMAREQ_ID> DMAREQ_ID {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C1CR_SOIE> SOIE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C1CR_EGE> EGE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C1CR_SE> SE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C1CR_SPOL> SPOL {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C1CR_NBREQ> NBREQ {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C1CR_SYNC_ID> SYNC_ID {};
	};

	struct DMAMUX_C2CR {
		DECL_REGISTER(DMAMUX_DMAMUX_C2CR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_C2CR_DMAREQ_ID> DMAREQ_ID {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C2CR_SOIE> SOIE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C2CR_EGE> EGE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C2CR_SE> SE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C2CR_SPOL> SPOL {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C2CR_NBREQ> NBREQ {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C2CR_SYNC_ID> SYNC_ID {};
	};

	struct DMAMUX_C3CR {
		DECL_REGISTER(DMAMUX_DMAMUX_C3CR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_C3CR_DMAREQ_ID> DMAREQ_ID {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C3CR_SOIE> SOIE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C3CR_EGE> EGE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C3CR_SE> SE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C3CR_SPOL> SPOL {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C3CR_NBREQ> NBREQ {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C3CR_SYNC_ID> SYNC_ID {};
	};

	struct DMAMUX_C4CR {
		DECL_REGISTER(DMAMUX_DMAMUX_C4CR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_C4CR_DMAREQ_ID> DMAREQ_ID {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C4CR_SOIE> SOIE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C4CR_EGE> EGE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C4CR_SE> SE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C4CR_SPOL> SPOL {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C4CR_NBREQ> NBREQ {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C4CR_SYNC_ID> SYNC_ID {};
	};

	struct DMAMUX_C5CR {
		DECL_REGISTER(DMAMUX_DMAMUX_C5CR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_C5CR_DMAREQ_ID> DMAREQ_ID {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C5CR_SOIE> SOIE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C5CR_EGE> EGE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C5CR_SE> SE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C5CR_SPOL> SPOL {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C5CR_NBREQ> NBREQ {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C5CR_SYNC_ID> SYNC_ID {};
	};

	struct DMAMUX_C6CR {
		DECL_REGISTER(DMAMUX_DMAMUX_C6CR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_C6CR_DMAREQ_ID> DMAREQ_ID {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C6CR_SOIE> SOIE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C6CR_EGE> EGE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C6CR_SE> SE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C6CR_SPOL> SPOL {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C6CR_NBREQ> NBREQ {};
		constexpr static RegisterField<DMAMUX_DMAMUX_C6CR_SYNC_ID> SYNC_ID {};
	};

	struct DMAMUX_CSR {
		DECL_REGISTER(DMAMUX_DMAMUX_CSR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_CSR_SOF> SOF {};
	};

	struct DMAMUX_CFR {
		DECL_REGISTER(DMAMUX_DMAMUX_CFR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_CFR_CSOF> CSOF {};
	};

	struct DMAMUX_RG0CR {
		DECL_REGISTER(DMAMUX_DMAMUX_RG0CR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_RG0CR_SIG_ID> SIG_ID {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG0CR_OIE> OIE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG0CR_GE> GE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG0CR_GPOL> GPOL {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG0CR_GNBREQ> GNBREQ {};
	};

	struct DMAMUX_RG1CR {
		DECL_REGISTER(DMAMUX_DMAMUX_RG1CR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_RG1CR_SIG_ID> SIG_ID {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG1CR_OIE> OIE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG1CR_GE> GE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG1CR_GPOL> GPOL {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG1CR_GNBREQ> GNBREQ {};
	};

	struct DMAMUX_RG2CR {
		DECL_REGISTER(DMAMUX_DMAMUX_RG2CR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_RG2CR_SIG_ID> SIG_ID {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG2CR_OIE> OIE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG2CR_GE> GE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG2CR_GPOL> GPOL {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG2CR_GNBREQ> GNBREQ {};
	};

	struct DMAMUX_RG3CR {
		DECL_REGISTER(DMAMUX_DMAMUX_RG3CR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_RG3CR_SIG_ID> SIG_ID {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG3CR_OIE> OIE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG3CR_GE> GE {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG3CR_GPOL> GPOL {};
		constexpr static RegisterField<DMAMUX_DMAMUX_RG3CR_GNBREQ> GNBREQ {};
	};

	struct DMAMUX_RGSR {
		DECL_REGISTER(DMAMUX_DMAMUX_RGSR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_RGSR_OF> OF {};
	};

	struct DMAMUX_RGCFR {
		DECL_REGISTER(DMAMUX_DMAMUX_RGCFR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_RGCFR_COF> COF {};
	};

	struct DMAMUX_HWCFGR2 {
		DECL_REGISTER(DMAMUX_DMAMUX_HWCFGR2_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_HWCFGR2_NUM_DMA_EXT_REQ> NUM_DMA_EXT_REQ {};
	};

	struct DMAMUX_HWCFGR1 {
		DECL_REGISTER(DMAMUX_DMAMUX_HWCFGR1_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_HWCFGR1_NUM_DMA_STREAMS> NUM_DMA_STREAMS {};
		constexpr static RegisterField<DMAMUX_DMAMUX_HWCFGR1_NUM_DMA_PERIPH_REQ> NUM_DMA_PERIPH_REQ {};
		constexpr static RegisterField<DMAMUX_DMAMUX_HWCFGR1_NUM_DMA_TRIG> NUM_DMA_TRIG {};
		constexpr static RegisterField<DMAMUX_DMAMUX_HWCFGR1_NUM_DMA_REQGEN> NUM_DMA_REQGEN {};
	};

	struct DMAMUX_VERR {
		DECL_REGISTER(DMAMUX_DMAMUX_VERR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_VERR_MINREV> MINREV {};
		constexpr static RegisterField<DMAMUX_DMAMUX_VERR_MAJREV> MAJREV {};
	};

	struct DMAMUX_IPIDR {
		DECL_REGISTER(DMAMUX_DMAMUX_IPIDR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_IPIDR_ID> ID {};
	};

	struct DMAMUX_SIDR {
		DECL_REGISTER(DMAMUX_DMAMUX_SIDR_BASE);
		constexpr static RegisterField<DMAMUX_DMAMUX_SIDR_SID> SID {};
	};
...
struct EXTI {
	struct RTSR1 {
		...
		constexpr static RegisterField<EXTI_RTSR1_TR0> TR0 {};
		constexpr static RegisterField<EXTI_RTSR1_TR1> TR1 {};
		constexpr static RegisterField<EXTI_RTSR1_TR2> TR2 {};
		constexpr static RegisterField<EXTI_RTSR1_TR3> TR3 {};
		constexpr static RegisterField<EXTI_RTSR1_TR4> TR4 {};
		constexpr static RegisterField<EXTI_RTSR1_TR5> TR5 {};
		constexpr static RegisterField<EXTI_RTSR1_TR6> TR6 {};
		constexpr static RegisterField<EXTI_RTSR1_TR7> TR7 {};
		constexpr static RegisterField<EXTI_RTSR1_TR8> TR8 {};
		constexpr static RegisterField<EXTI_RTSR1_TR9> TR9 {};
		constexpr static RegisterField<EXTI_RTSR1_TR10> TR10 {};
		constexpr static RegisterField<EXTI_RTSR1_TR11> TR11 {};
		constexpr static RegisterField<EXTI_RTSR1_TR12> TR12 {};
		constexpr static RegisterField<EXTI_RTSR1_TR13> TR13 {};
		constexpr static RegisterField<EXTI_RTSR1_TR14> TR14 {};
		constexpr static RegisterField<EXTI_RTSR1_TR15> TR15 {};
		constexpr static RegisterField<EXTI_RTSR1_TR16> TR16 {};
		constexpr static RegisterField<EXTI_RTSR1_TR17> TR17 {};
		constexpr static RegisterField<EXTI_RTSR1_TR18> TR18 {};
	};

	struct FTSR1 {
		DECL_REGISTER(EXTI_FTSR1_BASE);
		constexpr static RegisterField<EXTI_FTSR1_TR0> TR0 {};
		constexpr static RegisterField<EXTI_FTSR1_TR1> TR1 {};
		constexpr static RegisterField<EXTI_FTSR1_TR2> TR2 {};
		constexpr static RegisterField<EXTI_FTSR1_TR3> TR3 {};
		constexpr static RegisterField<EXTI_FTSR1_TR4> TR4 {};
		constexpr static RegisterField<EXTI_FTSR1_TR5> TR5 {};
		constexpr static RegisterField<EXTI_FTSR1_TR6> TR6 {};
		constexpr static RegisterField<EXTI_FTSR1_TR7> TR7 {};
		constexpr static RegisterField<EXTI_FTSR1_TR8> TR8 {};
		constexpr static RegisterField<EXTI_FTSR1_TR9> TR9 {};
		constexpr static RegisterField<EXTI_FTSR1_TR10> TR10 {};
		constexpr static RegisterField<EXTI_FTSR1_TR11> TR11 {};
		constexpr static RegisterField<EXTI_FTSR1_TR12> TR12 {};
		constexpr static RegisterField<EXTI_FTSR1_TR13> TR13 {};
		constexpr static RegisterField<EXTI_FTSR1_TR14> TR14 {};
		constexpr static RegisterField<EXTI_FTSR1_TR15> TR15 {};
		constexpr static RegisterField<EXTI_FTSR1_TR16> TR16 {};
		constexpr static RegisterField<EXTI_FTSR1_TR17> TR17 {};
		constexpr static RegisterField<EXTI_FTSR1_TR18> TR18 {};
	};

	struct SWIER1 {
		DECL_REGISTER(EXTI_SWIER1_BASE);
		constexpr static RegisterField<EXTI_SWIER1_SWIER0> SWIER0 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER1> SWIER1V {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER2> SWIER2 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER3> SWIER3 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER4> SWIER4 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER5> SWIER5 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER6> SWIER6 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER7> SWIER7 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER8> SWIER8 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER9> SWIER9 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER10> SWIER10 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER11> SWIER11 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER12> SWIER12 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER13> SWIER13 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER14> SWIER14 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER15> SWIER15 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER16> SWIER16 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER17> SWIER17 {};
		constexpr static RegisterField<EXTI_SWIER1_SWIER18> SWIER18 {};
	};
	...
	struct RPR1 {
		...
		constexpr static RegisterField<EXTI_RPR1_RPIF16> RPIF16 {};
		constexpr static RegisterField<EXTI_RPR1_RPIF17> RPIF17 {};
		constexpr static RegisterField<EXTI_RPR1_RPIF18> RPIF18 {};
	};
	...
	struct FPR1 {
		...
		constexpr static RegisterField<EXTI_FPR1_FPIF16> FPIF16 {};
		constexpr static RegisterField<EXTI_FPR1_FPIF17> FPIF17 {};
		constexpr static RegisterField<EXTI_FPR1_FPIF18> FPIF18 {};
	};
	...
	struct IMR1 {
		...
		constexpr static RegisterField<EXTI_IMR1_IM16> IM16 {};
		constexpr static RegisterField<EXTI_IMR1_IM17> IM17 {};
		constexpr static RegisterField<EXTI_IMR1_IM18> IM18 {};
		constexpr static RegisterField<EXTI_IMR1_IM19> IM19 {};
		constexpr static RegisterField<EXTI_IMR1_IM20> IM20 {};
		...
		constexpr static RegisterField<EXTI_IMR1_IM27> IM27 {};
		constexpr static RegisterField<EXTI_IMR1_IM28> IM28 {};
		constexpr static RegisterField<EXTI_IMR1_IM29> IM29 {};
		constexpr static RegisterField<EXTI_IMR1_IM30> IM30 {};
	...
	struct EMR1 {
		...
		constexpr static RegisterField<EXTI_EMR1_EM16> EM16 {};
		constexpr static RegisterField<EXTI_EMR1_EM17> EM17 {};
		constexpr static RegisterField<EXTI_EMR1_EM18> EM18 {};
		...
		constexpr static RegisterField<EXTI_EMR1_EM27> EM27 {};
		constexpr static RegisterField<EXTI_EMR1_EM28> EM28 {};
		constexpr static RegisterField<EXTI_EMR1_EM29> EM29 {};
		constexpr static RegisterField<EXTI_EMR1_EM30> EM30 {};
		constexpr static RegisterField<EXTI_EMR1_EM31> EM31 {};
	};

	struct IMR2 {
		DECL_REGISTER(EXTI_IMR2_BASE);
		constexpr static RegisterField<EXTI_IMR2_IM32> IM32 {};
		constexpr static RegisterField<EXTI_IMR2_IM33> IM33 {};
	};

	struct EMR2 {
		DECL_REGISTER(EXTI_EMR2_BASE);
		constexpr static RegisterField<EXTI_EMR2_EM32> EM32 {};
		constexpr static RegisterField<EXTI_EMR2_EM33> EM33 {};
	};

	struct HWCFGR7 {
		DECL_REGISTER(EXTI_HWCFGR7_BASE);
		constexpr static RegisterField<EXTI_HWCFGR7_CPUEVENT> CPUEVENT {};
	};

	struct HWCFGR6 {
		DECL_REGISTER(EXTI_HWCFGR6_BASE);
		constexpr static RegisterField<EXTI_HWCFGR6_CPUEVENT> CPUEVENT {};
	};

	struct HWCFGR5 {
		DECL_REGISTER(EXTI_HWCFGR5_BASE);
		constexpr static RegisterField<EXTI_HWCFGR5_CPUEVENT> CPUEVENT {};
	};

	struct HWCFGR4 {
		DECL_REGISTER(EXTI_HWCFGR4_BASE);
		constexpr static RegisterField<EXTI_HWCFGR4_EVENT_TRG> EVENT_TRG {};
	};

	struct HWCFGR3 {
		DECL_REGISTER(EXTI_HWCFGR3_BASE);
		constexpr static RegisterField<EXTI_HWCFGR3_EVENT_TRG> EVENT_TRG {};
	};

	struct HWCFGR2 {
		DECL_REGISTER(EXTI_HWCFGR2_BASE);
		constexpr static RegisterField<EXTI_HWCFGR2_EVENT_TRG> EVENT_TRG {};
	};

	struct HWCFGR1 {
		DECL_REGISTER(EXTI_HWCFGR1_BASE);
		constexpr static RegisterField<EXTI_HWCFGR1_NBEVENTS> NBEVENTS {};
		constexpr static RegisterField<EXTI_HWCFGR1_NBCPUS> NBCPUS {};
		constexpr static RegisterField<EXTI_HWCFGR1_CPUEVTEN> CPUEVTEN {};
		constexpr static RegisterField<EXTI_HWCFGR1_NBIOPORT> NBIOPORT {};
	};

	struct VERR {
		DECL_REGISTER(EXTI_VERR_BASE);
		constexpr static RegisterField<EXTI_VERR_MINREV> MINREV {};
		constexpr static RegisterField<EXTI_VERR_MAJREV> MAJREV {};
	};

	struct IPIDR {
		DECL_REGISTER(EXTI_IPIDR_BASE);
		constexpr static RegisterField<EXTI_IPIDR_ID> ID {};
	};

	struct SIDR {
		DECL_REGISTER(EXTI_SIDR_BASE);
		constexpr static RegisterField<EXTI_SIDR_ID> ID {};
	};
...
struct TIM16 {
	...
	struct TISEL {
		...
		constexpr static RegisterField<TIM16_TISEL_TI2SEL> TI2SEL {};
	};
...
struct TIM17 {
	...
	struct TISEL {
		...
		constexpr static RegisterField<TIM17_TISEL_TI2SEL> TI2SEL {};
	};
...
struct TIM15 {
	struct CR1 {
		DECL_REGISTER(TIM15_CR1_BASE);
		constexpr static RegisterField<TIM15_CR1_CEN> CEN {};
		constexpr static RegisterField<TIM15_CR1_UDIS> UDIS {};
		constexpr static RegisterField<TIM15_CR1_URS> URS {};
		constexpr static RegisterField<TIM15_CR1_OPM> OPM {};
		constexpr static RegisterField<TIM15_CR1_ARPE> ARPE {};
		constexpr static RegisterField<TIM15_CR1_CKD> CKD {};
		constexpr static RegisterField<TIM15_CR1_UIFREMAP> UIFREMAP {};
	};

	struct CR2 {
		DECL_REGISTER(TIM15_CR2_BASE);
		constexpr static RegisterField<TIM15_CR2_CCPC> CCPC {};
		constexpr static RegisterField<TIM15_CR2_CCUS> CCUS {};
		constexpr static RegisterField<TIM15_CR2_CCDS> CCDS {};
		constexpr static RegisterField<TIM15_CR2_MMS> MMS {};
		constexpr static RegisterField<TIM15_CR2_TI1S> TI1S {};
		constexpr static RegisterField<TIM15_CR2_OIS1> OIS1 {};
		constexpr static RegisterField<TIM15_CR2_OIS1N> OIS1N {};
		constexpr static RegisterField<TIM15_CR2_OIS2> OIS2 {};
	};

	struct SMCR {
		DECL_REGISTER(TIM15_SMCR_BASE);
		constexpr static RegisterField<TIM15_SMCR_SMS1> SMS1 {};
		constexpr static RegisterField<TIM15_SMCR_TS1> TS1 {};
		constexpr static RegisterField<TIM15_SMCR_MSM> MSM {};
		constexpr static RegisterField<TIM15_SMCR_SMS2> SMS2 {};
		constexpr static RegisterField<TIM15_SMCR_TS2> TS2 {};
	};

	struct DIER {
		DECL_REGISTER(TIM15_DIER_BASE);
		constexpr static RegisterField<TIM15_DIER_UIE> UIE {};
		constexpr static RegisterField<TIM15_DIER_CC1IE> CC1IE {};
		constexpr static RegisterField<TIM15_DIER_CC2IE> CC2IE {};
		constexpr static RegisterField<TIM15_DIER_COMIE> COMIE {};
		constexpr static RegisterField<TIM15_DIER_TIE> TIE {};
		constexpr static RegisterField<TIM15_DIER_BIE> BIE {};
		constexpr static RegisterField<TIM15_DIER_UDE> UDE {};
		constexpr static RegisterField<TIM15_DIER_CC1DE> CC1DE {};
		constexpr static RegisterField<TIM15_DIER_CC2DE> CC2DE {};
		constexpr static RegisterField<TIM15_DIER_COMDE> COMDE {};
		constexpr static RegisterField<TIM15_DIER_TDE> TDE {};
	};

	struct SR {
		DECL_REGISTER(TIM15_SR_BASE);
		constexpr static RegisterField<TIM15_SR_UIF> UIF {};
		constexpr static RegisterField<TIM15_SR_CC1IF> CC1IF {};
		constexpr static RegisterField<TIM15_SR_CC2IF> CC2IF {};
		constexpr static RegisterField<TIM15_SR_COMIF> COMIF {};
		constexpr static RegisterField<TIM15_SR_TIF> TIF {};
		constexpr static RegisterField<TIM15_SR_BIF> BIF {};
		constexpr static RegisterField<TIM15_SR_CC1OF> CC1OF {};
		constexpr static RegisterField<TIM15_SR_CC2OF> CC2OF {};
	};

	struct EGR {
		DECL_REGISTER(TIM15_EGR_BASE);
		constexpr static RegisterField<TIM15_EGR_UG> UG {};
		constexpr static RegisterField<TIM15_EGR_CC1G> CC1G {};
		constexpr static RegisterField<TIM15_EGR_CC2G> CC2G {};
		constexpr static RegisterField<TIM15_EGR_COMG> COMG {};
		constexpr static RegisterField<TIM15_EGR_TG> TG {};
		constexpr static RegisterField<TIM15_EGR_BG> BG {};
	};

	struct CCMR1_Output {
		DECL_REGISTER(TIM15_CCMR1_Output_BASE);
		constexpr static RegisterField<TIM15_CCMR1_Output_CC1S> CC1S {};
		constexpr static RegisterField<TIM15_CCMR1_Output_OC1FE> OC1FE {};
		constexpr static RegisterField<TIM15_CCMR1_Output_OC1PE> OC1PE {};
		constexpr static RegisterField<TIM15_CCMR1_Output_OC1M1> OC1M1 {};
		constexpr static RegisterField<TIM15_CCMR1_Output_CC2S> CC2S {};
		constexpr static RegisterField<TIM15_CCMR1_Output_OC2FE> OC2FE {};
		constexpr static RegisterField<TIM15_CCMR1_Output_OC2PE> OC2PE {};
		constexpr static RegisterField<TIM15_CCMR1_Output_OC2M1> OC2M1 {};
		constexpr static RegisterField<TIM15_CCMR1_Output_OC1M2> OC1M2 {};
		constexpr static RegisterField<TIM15_CCMR1_Output_OC2M2> OC2M2 {};
	};

	struct CCMR1_Input {
		DECL_REGISTER(TIM15_CCMR1_Input_BASE);
		constexpr static RegisterField<TIM15_CCMR1_Input_CC1S> CC1S {};
		constexpr static RegisterField<TIM15_CCMR1_Input_IC1PSC> IC1PSC {};
		constexpr static RegisterField<TIM15_CCMR1_Input_IC1F> IC1F {};
		constexpr static RegisterField<TIM15_CCMR1_Input_CC2S> CC2S {};
		constexpr static RegisterField<TIM15_CCMR1_Input_IC2PSC> IC2PSC {};
		constexpr static RegisterField<TIM15_CCMR1_Input_IC2F> IC2F {};
	};

	struct CCER {
		DECL_REGISTER(TIM15_CCER_BASE);
		constexpr static RegisterField<TIM15_CCER_CC1E> CC1E {};
		constexpr static RegisterField<TIM15_CCER_CC1P> CC1P {};
		constexpr static RegisterField<TIM15_CCER_CC1NE> CC1NE {};
		constexpr static RegisterField<TIM15_CCER_CC1NP> CC1NP {};
		constexpr static RegisterField<TIM15_CCER_CC2E> CC2E {};
		constexpr static RegisterField<TIM15_CCER_CC2P> CC2P {};
		constexpr static RegisterField<TIM15_CCER_CC2NP> CC2NP {};
	};

	struct CNT {
		DECL_REGISTER(TIM15_CNT_BASE);
		constexpr static RegisterField<TIM15_CNT_CNT> CNTV {};
		constexpr static RegisterField<TIM15_CNT_UIFCPY> UIFCPY {};
	};

	struct PSC {
		DECL_REGISTER(TIM15_PSC_BASE);
		constexpr static RegisterField<TIM15_PSC_PSC> PSCV {};
	};

	struct ARR {
		DECL_REGISTER(TIM15_ARR_BASE);
		constexpr static RegisterField<TIM15_ARR_ARR> ARRV {};
	};

	struct RCR {
		DECL_REGISTER(TIM15_RCR_BASE);
		constexpr static RegisterField<TIM15_RCR_REP> REP {};
	};

	struct CCR1 {
		DECL_REGISTER(TIM15_CCR1_BASE);
		constexpr static RegisterField<TIM15_CCR1_CCR1> CCR1V {};
	};

	struct CCR2 {
		DECL_REGISTER(TIM15_CCR2_BASE);
		constexpr static RegisterField<TIM15_CCR2_CCR2> CCR2V {};
	};

	struct BDTR {
		DECL_REGISTER(TIM15_BDTR_BASE);
		constexpr static RegisterField<TIM15_BDTR_DTG> DTG {};
		constexpr static RegisterField<TIM15_BDTR_LOCK> LOCK {};
		constexpr static RegisterField<TIM15_BDTR_OSSI> OSSI {};
		constexpr static RegisterField<TIM15_BDTR_OSSR> OSSR {};
		constexpr static RegisterField<TIM15_BDTR_BKE> BKE {};
		constexpr static RegisterField<TIM15_BDTR_BKP> BKP {};
		constexpr static RegisterField<TIM15_BDTR_AOE> AOE {};
		constexpr static RegisterField<TIM15_BDTR_MOE> MOE {};
		constexpr static RegisterField<TIM15_BDTR_BKF> BKF {};
		constexpr static RegisterField<TIM15_BDTR_BKDSRM> BKDSRM {};
		constexpr static RegisterField<TIM15_BDTR_BKBID> BKBID {};
	};

	struct DCR {
		DECL_REGISTER(TIM15_DCR_BASE);
		constexpr static RegisterField<TIM15_DCR_DBA> DBA {};
		constexpr static RegisterField<TIM15_DCR_DBL> DBL {};
	};

	struct DMAR {
		DECL_REGISTER(TIM15_DMAR_BASE);
		constexpr static RegisterField<TIM15_DMAR_DMAB> DMAB {};
	};

	struct AF1 {
		DECL_REGISTER(TIM15_AF1_BASE);
		constexpr static RegisterField<TIM15_AF1_BKINE> BKINE {};
		constexpr static RegisterField<TIM15_AF1_BKCMP1E> BKCMP1E {};
		constexpr static RegisterField<TIM15_AF1_BKCMP2E> BKCMP2E {};
		constexpr static RegisterField<TIM15_AF1_BKCMP3E> BKCMP3E {};
		constexpr static RegisterField<TIM15_AF1_BKINP> BKINP {};
		constexpr static RegisterField<TIM15_AF1_BKCMP1P> BKCMP1P {};
		constexpr static RegisterField<TIM15_AF1_BKCMP2P> BKCMP2P {};
		constexpr static RegisterField<TIM15_AF1_BKCMP3P> BKCMP3P {};
	};

	struct TISEL {
		DECL_REGISTER(TIM15_TISEL_BASE);
		constexpr static RegisterField<TIM15_TISEL_TI1SEL> TI1SEL {};
		constexpr static RegisterField<TIM15_TISEL_TI2SEL> TI2SEL {};
	};
...
struct USART3 {
	struct CR1 {
		DECL_REGISTER(USART3_CR1_BASE);
		constexpr static RegisterField<USART3_CR1_UE> UE {};
		constexpr static RegisterField<USART3_CR1_UESM> UESM {};
		constexpr static RegisterField<USART3_CR1_RE> RE {};
		constexpr static RegisterField<USART3_CR1_TE> TE {};
		constexpr static RegisterField<USART3_CR1_IDLEIE> IDLEIE {};
		constexpr static RegisterField<USART3_CR1_RXNEIE> RXNEIE {};
		constexpr static RegisterField<USART3_CR1_TCIE> TCIE {};
		constexpr static RegisterField<USART3_CR1_TXEIE> TXEIE {};
		constexpr static RegisterField<USART3_CR1_PEIE> PEIE {};
		constexpr static RegisterField<USART3_CR1_PS> PS {};
		constexpr static RegisterField<USART3_CR1_PCE> PCE {};
		constexpr static RegisterField<USART3_CR1_WAKE> WAKE {};
		constexpr static RegisterField<USART3_CR1_M0> M0 {};
		constexpr static RegisterField<USART3_CR1_MME> MME {};
		constexpr static RegisterField<USART3_CR1_CMIE> CMIE {};
		constexpr static RegisterField<USART3_CR1_OVER8> OVER8 {};
		constexpr static RegisterField<USART3_CR1_DEDT> DEDT {};
		constexpr static RegisterField<USART3_CR1_DEAT> DEAT {};
		constexpr static RegisterField<USART3_CR1_RTOIE> RTOIE {};
		constexpr static RegisterField<USART3_CR1_EOBIE> EOBIE {};
		constexpr static RegisterField<USART3_CR1_M1> M1 {};
		constexpr static RegisterField<USART3_CR1_FIFOEN> FIFOEN {};
		constexpr static RegisterField<USART3_CR1_TXFEIE> TXFEIE {};
		constexpr static RegisterField<USART3_CR1_RXFFIE> RXFFIE {};
	};

	struct CR2 {
		DECL_REGISTER(USART3_CR2_BASE);
		constexpr static RegisterField<USART3_CR2_SLVEN> SLVEN {};
		constexpr static RegisterField<USART3_CR2_DIS_NSS> DIS_NSS {};
		constexpr static RegisterField<USART3_CR2_ADDM7> ADDM7 {};
		constexpr static RegisterField<USART3_CR2_LBDL> LBDL {};
		constexpr static RegisterField<USART3_CR2_LBDIE> LBDIE {};
		constexpr static RegisterField<USART3_CR2_LBCL> LBCL {};
		constexpr static RegisterField<USART3_CR2_CPHA> CPHA {};
		constexpr static RegisterField<USART3_CR2_CPOL> CPOL {};
		constexpr static RegisterField<USART3_CR2_CLKEN> CLKEN {};
		constexpr static RegisterField<USART3_CR2_STOP> STOP {};
		constexpr static RegisterField<USART3_CR2_LINEN> LINEN {};
		constexpr static RegisterField<USART3_CR2_SWAP> SWAP {};
		constexpr static RegisterField<USART3_CR2_RXINV> RXINV {};
		constexpr static RegisterField<USART3_CR2_TXINV> TXINV {};
		constexpr static RegisterField<USART3_CR2_TAINV> TAINV {};
		constexpr static RegisterField<USART3_CR2_MSBFIRST> MSBFIRST {};
		constexpr static RegisterField<USART3_CR2_ABREN> ABREN {};
		constexpr static RegisterField<USART3_CR2_ABRMOD> ABRMOD {};
		constexpr static RegisterField<USART3_CR2_RTOEN> RTOEN {};
		constexpr static RegisterField<USART3_CR2_ADD0_3> ADD0_3 {};
		constexpr static RegisterField<USART3_CR2_ADD4_7> ADD4_7 {};
	};

	struct CR3 {
		DECL_REGISTER(USART3_CR3_BASE);
		constexpr static RegisterField<USART3_CR3_EIE> EIE {};
		constexpr static RegisterField<USART3_CR3_IREN> IREN {};
		constexpr static RegisterField<USART3_CR3_IRLP> IRLP {};
		constexpr static RegisterField<USART3_CR3_HDSEL> HDSEL {};
		constexpr static RegisterField<USART3_CR3_NACK> NACK {};
		constexpr static RegisterField<USART3_CR3_SCEN> SCEN {};
		constexpr static RegisterField<USART3_CR3_DMAR> DMAR {};
		constexpr static RegisterField<USART3_CR3_DMAT> DMAT {};
		constexpr static RegisterField<USART3_CR3_RTSE> RTSE {};
		constexpr static RegisterField<USART3_CR3_CTSE> CTSE {};
		constexpr static RegisterField<USART3_CR3_CTSIE> CTSIE {};
		constexpr static RegisterField<USART3_CR3_ONEBIT> ONEBIT {};
		constexpr static RegisterField<USART3_CR3_OVRDIS> OVRDIS {};
		constexpr static RegisterField<USART3_CR3_DDRE> DDRE {};
		constexpr static RegisterField<USART3_CR3_DEM> DEM {};
		constexpr static RegisterField<USART3_CR3_DEP> DEP {};
		constexpr static RegisterField<USART3_CR3_SCARCNT> SCARCNT {};
		constexpr static RegisterField<USART3_CR3_WUS> WUS {};
		constexpr static RegisterField<USART3_CR3_WUFIE> WUFIE {};
		constexpr static RegisterField<USART3_CR3_TXFTIE> TXFTIE {};
		constexpr static RegisterField<USART3_CR3_TCBGTIE> TCBGTIE {};
		constexpr static RegisterField<USART3_CR3_RXFTCFG> RXFTCFG {};
		constexpr static RegisterField<USART3_CR3_RXFTIE> RXFTIE {};
		constexpr static RegisterField<USART3_CR3_TXFTCFG> TXFTCFG {};
	};

	struct BRR {
		DECL_REGISTER(USART3_BRR_BASE);
		constexpr static RegisterField<USART3_BRR_BRR_0_3> BRR_0_3 {};
		constexpr static RegisterField<USART3_BRR_BRR_4_15> BRR_4_15 {};
	};

	struct GTPR {
		DECL_REGISTER(USART3_GTPR_BASE);
		constexpr static RegisterField<USART3_GTPR_PSC> PSC {};
		constexpr static RegisterField<USART3_GTPR_GT> GT {};
	};

	struct RTOR {
		DECL_REGISTER(USART3_RTOR_BASE);
		constexpr static RegisterField<USART3_RTOR_RTO> RTO {};
		constexpr static RegisterField<USART3_RTOR_BLEN> BLEN {};
	};

	struct RQR {
		DECL_REGISTER(USART3_RQR_BASE);
		constexpr static RegisterField<USART3_RQR_ABRRQ> ABRRQ {};
		constexpr static RegisterField<USART3_RQR_SBKRQ> SBKRQ {};
		constexpr static RegisterField<USART3_RQR_MMRQ> MMRQ {};
		constexpr static RegisterField<USART3_RQR_RXFRQ> RXFRQ {};
		constexpr static RegisterField<USART3_RQR_TXFRQ> TXFRQ {};
	};

	struct ISR {
		DECL_REGISTER(USART3_ISR_BASE);
		constexpr static RegisterField<USART3_ISR_PE> PE {};
		constexpr static RegisterField<USART3_ISR_FE> FE {};
		constexpr static RegisterField<USART3_ISR_NF> NF {};
		constexpr static RegisterField<USART3_ISR_ORE> ORE {};
		constexpr static RegisterField<USART3_ISR_IDLE> IDLE {};
		constexpr static RegisterField<USART3_ISR_RXNE> RXNE {};
		constexpr static RegisterField<USART3_ISR_TC> TC {};
		constexpr static RegisterField<USART3_ISR_TXE> TXE {};
		constexpr static RegisterField<USART3_ISR_LBDF> LBDF {};
		constexpr static RegisterField<USART3_ISR_CTSIF> CTSIF {};
		constexpr static RegisterField<USART3_ISR_CTS> CTS {};
		constexpr static RegisterField<USART3_ISR_RTOF> RTOF {};
		constexpr static RegisterField<USART3_ISR_EOBF> EOBF {};
		constexpr static RegisterField<USART3_ISR_UDR> UDR {};
		constexpr static RegisterField<USART3_ISR_ABRE> ABRE {};
		constexpr static RegisterField<USART3_ISR_ABRF> ABRF {};
		constexpr static RegisterField<USART3_ISR_BUSY> BUSY {};
		constexpr static RegisterField<USART3_ISR_CMF> CMF {};
		constexpr static RegisterField<USART3_ISR_SBKF> SBKF {};
		constexpr static RegisterField<USART3_ISR_RWU> RWU {};
		constexpr static RegisterField<USART3_ISR_WUF> WUF {};
		constexpr static RegisterField<USART3_ISR_TEACK> TEACK {};
		constexpr static RegisterField<USART3_ISR_REACK> REACK {};
		constexpr static RegisterField<USART3_ISR_TXFE> TXFE {};
		constexpr static RegisterField<USART3_ISR_RXFF> RXFF {};
		constexpr static RegisterField<USART3_ISR_TCBGT> TCBGT {};
		constexpr static RegisterField<USART3_ISR_RXFT> RXFT {};
		constexpr static RegisterField<USART3_ISR_TXFT> TXFT {};
	};

	struct ICR {
		DECL_REGISTER(USART3_ICR_BASE);
		constexpr static RegisterField<USART3_ICR_PECF> PECF {};
		constexpr static RegisterField<USART3_ICR_FECF> FECF {};
		constexpr static RegisterField<USART3_ICR_NCF> NCF {};
		constexpr static RegisterField<USART3_ICR_ORECF> ORECF {};
		constexpr static RegisterField<USART3_ICR_IDLECF> IDLECF {};
		constexpr static RegisterField<USART3_ICR_TXFECF> TXFECF {};
		constexpr static RegisterField<USART3_ICR_TCCF> TCCF {};
		constexpr static RegisterField<USART3_ICR_TCBGTCF> TCBGTCF {};
		constexpr static RegisterField<USART3_ICR_LBDCF> LBDCF {};
		constexpr static RegisterField<USART3_ICR_CTSCF> CTSCF {};
		constexpr static RegisterField<USART3_ICR_RTOCF> RTOCF {};
		constexpr static RegisterField<USART3_ICR_EOBCF> EOBCF {};
		constexpr static RegisterField<USART3_ICR_UDRCF> UDRCF {};
		constexpr static RegisterField<USART3_ICR_CMCF> CMCF {};
		constexpr static RegisterField<USART3_ICR_WUCF> WUCF {};
	};

	struct RDR {
		DECL_REGISTER(USART3_RDR_BASE);
		constexpr static RegisterField<USART3_RDR_RDR> RDRV {};
	};

	struct TDR {
		DECL_REGISTER(USART3_TDR_BASE);
		constexpr static RegisterField<USART3_TDR_TDR> TDRV {};
	};

	struct PRESC {
		DECL_REGISTER(USART3_PRESC_BASE);
		constexpr static RegisterField<USART3_PRESC_PRESCALER> PRESCALER {};
	};
...
struct USART4 {
	struct CR1 {
		DECL_REGISTER(USART4_CR1_BASE);
		constexpr static RegisterField<USART4_CR1_UE> UE {};
		constexpr static RegisterField<USART4_CR1_UESM> UESM {};
		constexpr static RegisterField<USART4_CR1_RE> RE {};
		constexpr static RegisterField<USART4_CR1_TE> TE {};
		constexpr static RegisterField<USART4_CR1_IDLEIE> IDLEIE {};
		constexpr static RegisterField<USART4_CR1_RXNEIE> RXNEIE {};
		constexpr static RegisterField<USART4_CR1_TCIE> TCIE {};
		constexpr static RegisterField<USART4_CR1_TXEIE> TXEIE {};
		constexpr static RegisterField<USART4_CR1_PEIE> PEIE {};
		constexpr static RegisterField<USART4_CR1_PS> PS {};
		constexpr static RegisterField<USART4_CR1_PCE> PCE {};
		constexpr static RegisterField<USART4_CR1_WAKE> WAKE {};
		constexpr static RegisterField<USART4_CR1_M0> M0 {};
		constexpr static RegisterField<USART4_CR1_MME> MME {};
		constexpr static RegisterField<USART4_CR1_CMIE> CMIE {};
		constexpr static RegisterField<USART4_CR1_OVER8> OVER8 {};
		constexpr static RegisterField<USART4_CR1_DEDT> DEDT {};
		constexpr static RegisterField<USART4_CR1_DEAT> DEAT {};
		constexpr static RegisterField<USART4_CR1_RTOIE> RTOIE {};
		constexpr static RegisterField<USART4_CR1_EOBIE> EOBIE {};
		constexpr static RegisterField<USART4_CR1_M1> M1 {};
		constexpr static RegisterField<USART4_CR1_FIFOEN> FIFOEN {};
		constexpr static RegisterField<USART4_CR1_TXFEIE> TXFEIE {};
		constexpr static RegisterField<USART4_CR1_RXFFIE> RXFFIE {};
	};

	struct CR2 {
		DECL_REGISTER(USART4_CR2_BASE);
		constexpr static RegisterField<USART4_CR2_SLVEN> SLVEN {};
		constexpr static RegisterField<USART4_CR2_DIS_NSS> DIS_NSS {};
		constexpr static RegisterField<USART4_CR2_ADDM7> ADDM7 {};
		constexpr static RegisterField<USART4_CR2_LBDL> LBDL {};
		constexpr static RegisterField<USART4_CR2_LBDIE> LBDIE {};
		constexpr static RegisterField<USART4_CR2_LBCL> LBCL {};
		constexpr static RegisterField<USART4_CR2_CPHA> CPHA {};
		constexpr static RegisterField<USART4_CR2_CPOL> CPOL {};
		constexpr static RegisterField<USART4_CR2_CLKEN> CLKEN {};
		constexpr static RegisterField<USART4_CR2_STOP> STOP {};
		constexpr static RegisterField<USART4_CR2_LINEN> LINEN {};
		constexpr static RegisterField<USART4_CR2_SWAP> SWAP {};
		constexpr static RegisterField<USART4_CR2_RXINV> RXINV {};
		constexpr static RegisterField<USART4_CR2_TXINV> TXINV {};
		constexpr static RegisterField<USART4_CR2_TAINV> TAINV {};
		constexpr static RegisterField<USART4_CR2_MSBFIRST> MSBFIRST {};
		constexpr static RegisterField<USART4_CR2_ABREN> ABREN {};
		constexpr static RegisterField<USART4_CR2_ABRMOD> ABRMOD {};
		constexpr static RegisterField<USART4_CR2_RTOEN> RTOEN {};
		constexpr static RegisterField<USART4_CR2_ADD0_3> ADD0_3 {};
		constexpr static RegisterField<USART4_CR2_ADD4_7> ADD4_7 {};
	};

	struct CR3 {
		DECL_REGISTER(USART4_CR3_BASE);
		constexpr static RegisterField<USART4_CR3_EIE> EIE {};
		constexpr static RegisterField<USART4_CR3_IREN> IREN {};
		constexpr static RegisterField<USART4_CR3_IRLP> IRLP {};
		constexpr static RegisterField<USART4_CR3_HDSEL> HDSEL {};
		constexpr static RegisterField<USART4_CR3_NACK> NACK {};
		constexpr static RegisterField<USART4_CR3_SCEN> SCEN {};
		constexpr static RegisterField<USART4_CR3_DMAR> DMAR {};
		constexpr static RegisterField<USART4_CR3_DMAT> DMAT {};
		constexpr static RegisterField<USART4_CR3_RTSE> RTSE {};
		constexpr static RegisterField<USART4_CR3_CTSE> CTSE {};
		constexpr static RegisterField<USART4_CR3_CTSIE> CTSIE {};
		constexpr static RegisterField<USART4_CR3_ONEBIT> ONEBIT {};
		constexpr static RegisterField<USART4_CR3_OVRDIS> OVRDIS {};
		constexpr static RegisterField<USART4_CR3_DDRE> DDRE {};
		constexpr static RegisterField<USART4_CR3_DEM> DEM {};
		constexpr static RegisterField<USART4_CR3_DEP> DEP {};
		constexpr static RegisterField<USART4_CR3_SCARCNT> SCARCNT {};
		constexpr static RegisterField<USART4_CR3_WUS> WUS {};
		constexpr static RegisterField<USART4_CR3_WUFIE> WUFIE {};
		constexpr static RegisterField<USART4_CR3_TXFTIE> TXFTIE {};
		constexpr static RegisterField<USART4_CR3_TCBGTIE> TCBGTIE {};
		constexpr static RegisterField<USART4_CR3_RXFTCFG> RXFTCFG {};
		constexpr static RegisterField<USART4_CR3_RXFTIE> RXFTIE {};
		constexpr static RegisterField<USART4_CR3_TXFTCFG> TXFTCFG {};
	};

	struct BRR {
		DECL_REGISTER(USART4_BRR_BASE);
		constexpr static RegisterField<USART4_BRR_BRR_0_3> BRR_0_3 {};
		constexpr static RegisterField<USART4_BRR_BRR_4_15> BRR_4_15 {};
	};

	struct GTPR {
		DECL_REGISTER(USART4_GTPR_BASE);
		constexpr static RegisterField<USART4_GTPR_PSC> PSC {};
		constexpr static RegisterField<USART4_GTPR_GT> GT {};
	};

	struct RTOR {
		DECL_REGISTER(USART4_RTOR_BASE);
		constexpr static RegisterField<USART4_RTOR_RTO> RTO {};
		constexpr static RegisterField<USART4_RTOR_BLEN> BLEN {};
	};

	struct RQR {
		DECL_REGISTER(USART4_RQR_BASE);
		constexpr static RegisterField<USART4_RQR_ABRRQ> ABRRQ {};
		constexpr static RegisterField<USART4_RQR_SBKRQ> SBKRQ {};
		constexpr static RegisterField<USART4_RQR_MMRQ> MMRQ {};
		constexpr static RegisterField<USART4_RQR_RXFRQ> RXFRQ {};
		constexpr static RegisterField<USART4_RQR_TXFRQ> TXFRQ {};
	};

	struct ISR {
		DECL_REGISTER(USART4_ISR_BASE);
		constexpr static RegisterField<USART4_ISR_PE> PE {};
		constexpr static RegisterField<USART4_ISR_FE> FE {};
		constexpr static RegisterField<USART4_ISR_NF> NF {};
		constexpr static RegisterField<USART4_ISR_ORE> ORE {};
		constexpr static RegisterField<USART4_ISR_IDLE> IDLE {};
		constexpr static RegisterField<USART4_ISR_RXNE> RXNE {};
		constexpr static RegisterField<USART4_ISR_TC> TC {};
		constexpr static RegisterField<USART4_ISR_TXE> TXE {};
		constexpr static RegisterField<USART4_ISR_LBDF> LBDF {};
		constexpr static RegisterField<USART4_ISR_CTSIF> CTSIF {};
		constexpr static RegisterField<USART4_ISR_CTS> CTS {};
		constexpr static RegisterField<USART4_ISR_RTOF> RTOF {};
		constexpr static RegisterField<USART4_ISR_EOBF> EOBF {};
		constexpr static RegisterField<USART4_ISR_UDR> UDR {};
		constexpr static RegisterField<USART4_ISR_ABRE> ABRE {};
		constexpr static RegisterField<USART4_ISR_ABRF> ABRF {};
		constexpr static RegisterField<USART4_ISR_BUSY> BUSY {};
		constexpr static RegisterField<USART4_ISR_CMF> CMF {};
		constexpr static RegisterField<USART4_ISR_SBKF> SBKF {};
		constexpr static RegisterField<USART4_ISR_RWU> RWU {};
		constexpr static RegisterField<USART4_ISR_WUF> WUF {};
		constexpr static RegisterField<USART4_ISR_TEACK> TEACK {};
		constexpr static RegisterField<USART4_ISR_REACK> REACK {};
		constexpr static RegisterField<USART4_ISR_TXFE> TXFE {};
		constexpr static RegisterField<USART4_ISR_RXFF> RXFF {};
		constexpr static RegisterField<USART4_ISR_TCBGT> TCBGT {};
		constexpr static RegisterField<USART4_ISR_RXFT> RXFT {};
		constexpr static RegisterField<USART4_ISR_TXFT> TXFT {};
	};

	struct ICR {
		DECL_REGISTER(USART4_ICR_BASE);
		constexpr static RegisterField<USART4_ICR_PECF> PECF {};
		constexpr static RegisterField<USART4_ICR_FECF> FECF {};
		constexpr static RegisterField<USART4_ICR_NCF> NCF {};
		constexpr static RegisterField<USART4_ICR_ORECF> ORECF {};
		constexpr static RegisterField<USART4_ICR_IDLECF> IDLECF {};
		constexpr static RegisterField<USART4_ICR_TXFECF> TXFECF {};
		constexpr static RegisterField<USART4_ICR_TCCF> TCCF {};
		constexpr static RegisterField<USART4_ICR_TCBGTCF> TCBGTCF {};
		constexpr static RegisterField<USART4_ICR_LBDCF> LBDCF {};
		constexpr static RegisterField<USART4_ICR_CTSCF> CTSCF {};
		constexpr static RegisterField<USART4_ICR_RTOCF> RTOCF {};
		constexpr static RegisterField<USART4_ICR_EOBCF> EOBCF {};
		constexpr static RegisterField<USART4_ICR_UDRCF> UDRCF {};
		constexpr static RegisterField<USART4_ICR_CMCF> CMCF {};
		constexpr static RegisterField<USART4_ICR_WUCF> WUCF {};
	};

	struct RDR {
		DECL_REGISTER(USART4_RDR_BASE);
		constexpr static RegisterField<USART4_RDR_RDR> RDRV {};
	};

	struct TDR {
		DECL_REGISTER(USART4_TDR_BASE);
		constexpr static RegisterField<USART4_TDR_TDR> TDRV {};
	};

	struct PRESC {
		DECL_REGISTER(USART4_PRESC_BASE);
		constexpr static RegisterField<USART4_PRESC_PRESCALER> PRESCALER {};
	};
...
struct SPI1 {
	...
	struct HWCFGR {
		DECL_REGISTER(SPI1_HWCFGR_BASE);
		constexpr static RegisterField<SPI1_HWCFGR_CRCCFG> CRCCFG {};
		constexpr static RegisterField<SPI1_HWCFGR_I2SCFG> I2SCFG {};
		constexpr static RegisterField<SPI1_HWCFGR_I2SCKCFG> I2SCKCFG {};
		constexpr static RegisterField<SPI1_HWCFGR_DSCFG> DSCFG {};
		constexpr static RegisterField<SPI1_HWCFGR_NSSCFG> NSSCFG {};
	};

	struct VERR {
		DECL_REGISTER(SPI1_VERR_BASE);
		constexpr static RegisterField<SPI1_VERR_MINREV> MINREV {};
		constexpr static RegisterField<SPI1_VERR_MAJREV> MAJREV {};
	};

	struct IPIDR {
		DECL_REGISTER(SPI1_IPIDR_BASE);
		constexpr static RegisterField<SPI1_IPIDR_IPID> IPID {};
	};

	struct SIDR {
		DECL_REGISTER(SPI1_SIDR_BASE);
		constexpr static RegisterField<SPI1_SIDR_SID> SID {};
	};
...
struct SPI2 {
	...
	struct HWCFGR {
		DECL_REGISTER(SPI2_HWCFGR_BASE);
		constexpr static RegisterField<SPI2_HWCFGR_CRCCFG> CRCCFG {};
		constexpr static RegisterField<SPI2_HWCFGR_I2SCFG> I2SCFG {};
		constexpr static RegisterField<SPI2_HWCFGR_I2SCKCFG> I2SCKCFG {};
		constexpr static RegisterField<SPI2_HWCFGR_DSCFG> DSCFG {};
		constexpr static RegisterField<SPI2_HWCFGR_NSSCFG> NSSCFG {};
	};

	struct VERR {
		DECL_REGISTER(SPI2_VERR_BASE);
		constexpr static RegisterField<SPI2_VERR_MINREV> MINREV {};
		constexpr static RegisterField<SPI2_VERR_MAJREV> MAJREV {};
	};

	struct IPIDR {
		DECL_REGISTER(SPI2_IPIDR_BASE);
		constexpr static RegisterField<SPI2_IPIDR_IPID> IPID {};
	};

	struct SIDR {
		DECL_REGISTER(SPI2_SIDR_BASE);
		constexpr static RegisterField<SPI2_SIDR_SID> SID {};
	};
...
struct ADC {
	...
	struct ADC_CHSELRMOD0 {
		DECL_REGISTER(ADC_ADC_CHSELRMOD0_BASE);
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL0> CHSEL0 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL1> CHSEL1 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL2> CHSEL2 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL3> CHSEL3 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL4> CHSEL4 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL5> CHSEL5 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL6> CHSEL6 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL7> CHSEL7 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL8> CHSEL8 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL9> CHSEL9 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL10> CHSEL10 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL11> CHSEL11 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL12> CHSEL12 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL13> CHSEL13 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL14> CHSEL14 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL15> CHSEL15 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL16> CHSEL16 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL17> CHSEL17 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD0_CHSEL18> CHSEL18 {};
	};

	struct ADC_CHSELRMOD1 {
		DECL_REGISTER(ADC_ADC_CHSELRMOD1_BASE);
		constexpr static RegisterField<ADC_ADC_CHSELRMOD1_SQ1> SQ1 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD1_SQ2> SQ2 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD1_SQ3> SQ3 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD1_SQ4> SQ4 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD1_SQ5> SQ5 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD1_SQ6> SQ6 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD1_SQ7> SQ7 {};
		constexpr static RegisterField<ADC_ADC_CHSELRMOD1_SQ8> SQ8 {};
	};
...
struct COMP {
	struct COMP1_CSR {
		DECL_REGISTER(COMP_COMP1_CSR_BASE);
		constexpr static RegisterField<COMP_COMP1_CSR_EN> EN {};
		constexpr static RegisterField<COMP_COMP1_CSR_INMSEL> INMSEL {};
		constexpr static RegisterField<COMP_COMP1_CSR_INPSEL> INPSEL {};
		constexpr static RegisterField<COMP_COMP1_CSR_WINMODE> WINMODE {};
		constexpr static RegisterField<COMP_COMP1_CSR_WINOUT> WINOUT {};
		constexpr static RegisterField<COMP_COMP1_CSR_POLARITY> POLARITY {};
		constexpr static RegisterField<COMP_COMP1_CSR_HYST> HYST {};
		constexpr static RegisterField<COMP_COMP1_CSR_PWRMODE> PWRMODE {};
		constexpr static RegisterField<COMP_COMP1_CSR_BLANKSEL> BLANKSEL {};
		constexpr static RegisterField<COMP_COMP1_CSR_VALUE> VALUE {};
		constexpr static RegisterField<COMP_COMP1_CSR_LOCK> LOCK {};
	};

	struct COMP2_CSR {
		DECL_REGISTER(COMP_COMP2_CSR_BASE);
		constexpr static RegisterField<COMP_COMP2_CSR_EN> EN {};
		constexpr static RegisterField<COMP_COMP2_CSR_INMSEL> INMSEL {};
		constexpr static RegisterField<COMP_COMP2_CSR_INPSEL> INPSEL {};
		constexpr static RegisterField<COMP_COMP2_CSR_WINMODE> WINMODE {};
		constexpr static RegisterField<COMP_COMP2_CSR_WINOUT> WINOUT {};
		constexpr static RegisterField<COMP_COMP2_CSR_POLARITY> POLARITY {};
		constexpr static RegisterField<COMP_COMP2_CSR_HYST> HYST {};
		constexpr static RegisterField<COMP_COMP2_CSR_PWRMODE> PWRMODE {};
		constexpr static RegisterField<COMP_COMP2_CSR_BLANKSEL> BLANKSEL {};
		constexpr static RegisterField<COMP_COMP2_CSR_VALUE> VALUE {};
		constexpr static RegisterField<COMP_COMP2_CSR_LOCK> LOCK {};
	};
...
struct SYSCFG {
	...
	struct ITLINE4 {
		...
		constexpr static RegisterField<SYSCFG_ITLINE4_CRS> CRS {};
	};
	...
	struct ITLINE8 {
		...
		constexpr static RegisterField<SYSCFG_ITLINE8_UCPD1> UCPD1 {};
		constexpr static RegisterField<SYSCFG_ITLINE8_UCPD2> UCPD2 {};
	...
	struct ITLINE12 {
		...
		constexpr static RegisterField<SYSCFG_ITLINE12_COMP1> COMP1 {};
		constexpr static RegisterField<SYSCFG_ITLINE12_COMP2> COMP2 {};
		constexpr static RegisterField<SYSCFG_ITLINE12_COMP3> COMP3 {};
	};
	...
	struct ITLINE15 {
		DECL_REGISTER(SYSCFG_ITLINE15_BASE);
		constexpr static RegisterField<SYSCFG_ITLINE15_TIM2> TIM2 {};
	};
	...
	struct ITLINE17 {
		...
		constexpr static RegisterField<SYSCFG_ITLINE17_DAC> DAC {};
		constexpr static RegisterField<SYSCFG_ITLINE17_LPTIM1> LPTIM1 {};
	};

	struct ITLINE18 {
		DECL_REGISTER(SYSCFG_ITLINE18_BASE);
		constexpr static RegisterField<SYSCFG_ITLINE18_TIM7> TIM7 {};
		constexpr static RegisterField<SYSCFG_ITLINE18_LPTIM2> LPTIM2 {};
	};
	...
	struct ITLINE21 {
		...
		constexpr static RegisterField<SYSCFG_ITLINE21_FDCAN1_IT0> FDCAN1_IT0 {};
		constexpr static RegisterField<SYSCFG_ITLINE21_FDCAN2_IT0> FDCAN2_IT0 {};
	};

	struct ITLINE22 {
		DECL_REGISTER(SYSCFG_ITLINE22_BASE);
		constexpr static RegisterField<SYSCFG_ITLINE22_TIM17> TIM17 {};
		constexpr static RegisterField<SYSCFG_ITLINE22_FDCAN1_IT1> FDCAN1_IT1 {};
		constexpr static RegisterField<SYSCFG_ITLINE22_FDCAN2_IT1> FDCAN2_IT1 {};
	};
	...
	struct ITLINE28 {
		...
		constexpr static RegisterField<SYSCFG_ITLINE28_LPUART2> LPUART2 {};
	};
	...
	struct ITLINE29 {
		...
		constexpr static RegisterField<SYSCFG_ITLINE29_LPUART1> LPUART1 {};
		constexpr static RegisterField<SYSCFG_ITLINE29_USART5> USART5 {};
		constexpr static RegisterField<SYSCFG_ITLINE29_USART6> USART6 {};
	};

	struct ITLINE30 {
		DECL_REGISTER(SYSCFG_ITLINE30_BASE);
		constexpr static RegisterField<SYSCFG_ITLINE30_CEC> CEC {};
	};

	struct ITLINE31 {
		DECL_REGISTER(SYSCFG_ITLINE31_BASE);
		constexpr static RegisterField<SYSCFG_ITLINE31_RNG> RNG {};
		constexpr static RegisterField<SYSCFG_ITLINE31_AES> AES {};
	};
...
struct TAMP {
	struct CR1 {
		DECL_REGISTER(TAMP_CR1_BASE);
		constexpr static RegisterField<TAMP_CR1_TAMP1E> TAMP1E {};
		constexpr static RegisterField<TAMP_CR1_TAMP2E> TAMP2E {};
		constexpr static RegisterField<TAMP_CR1_ITAMP1E> ITAMP1E {};
		constexpr static RegisterField<TAMP_CR1_ITAMP3E> ITAMP3E {};
		constexpr static RegisterField<TAMP_CR1_ITAMP4E> ITAMP4E {};
		constexpr static RegisterField<TAMP_CR1_ITAMP5E> ITAMP5E {};
		constexpr static RegisterField<TAMP_CR1_ITAMP6E> ITAMP6E {};
	};

	struct CR2 {
		DECL_REGISTER(TAMP_CR2_BASE);
		constexpr static RegisterField<TAMP_CR2_TAMP1NOER> TAMP1NOER {};
		constexpr static RegisterField<TAMP_CR2_TAMP2NOER> TAMP2NOER {};
		constexpr static RegisterField<TAMP_CR2_TAMP1MSK> TAMP1MSK {};
		constexpr static RegisterField<TAMP_CR2_TAMP2MSK> TAMP2MSK {};
		constexpr static RegisterField<TAMP_CR2_TAMP1TRG> TAMP1TRG {};
		constexpr static RegisterField<TAMP_CR2_TAMP2TRG> TAMP2TRG {};
	};

	struct FLTCR {
		DECL_REGISTER(TAMP_FLTCR_BASE);
		constexpr static RegisterField<TAMP_FLTCR_TAMPFREQ> TAMPFREQ {};
		constexpr static RegisterField<TAMP_FLTCR_TAMPFLT> TAMPFLT {};
		constexpr static RegisterField<TAMP_FLTCR_TAMPPRCH> TAMPPRCH {};
		constexpr static RegisterField<TAMP_FLTCR_TAMPPUDIS> TAMPPUDIS {};
	};

	struct IER {
		DECL_REGISTER(TAMP_IER_BASE);
		constexpr static RegisterField<TAMP_IER_TAMP1IE> TAMP1IE {};
		constexpr static RegisterField<TAMP_IER_TAMP2IE> TAMP2IE {};
		constexpr static RegisterField<TAMP_IER_ITAMP1IE> ITAMP1IE {};
		constexpr static RegisterField<TAMP_IER_ITAMP3IE> ITAMP3IE {};
		constexpr static RegisterField<TAMP_IER_ITAMP4IE> ITAMP4IE {};
		constexpr static RegisterField<TAMP_IER_ITAMP5IE> ITAMP5IE {};
		constexpr static RegisterField<TAMP_IER_ITAMP6IE> ITAMP6IE {};
	};

	struct SR {
		DECL_REGISTER(TAMP_SR_BASE);
		constexpr static RegisterField<TAMP_SR_TAMP1F> TAMP1F {};
		constexpr static RegisterField<TAMP_SR_TAMP2F> TAMP2F {};
		constexpr static RegisterField<TAMP_SR_ITAMP1F> ITAMP1F {};
		constexpr static RegisterField<TAMP_SR_ITAMP3F> ITAMP3F {};
		constexpr static RegisterField<TAMP_SR_ITAMP4F> ITAMP4F {};
		constexpr static RegisterField<TAMP_SR_ITAMP5F> ITAMP5F {};
		constexpr static RegisterField<TAMP_SR_ITAMP6F> ITAMP6F {};
		constexpr static RegisterField<TAMP_SR_ITAMP7F> ITAMP7F {};
	};

	struct MISR {
		DECL_REGISTER(TAMP_MISR_BASE);
		constexpr static RegisterField<TAMP_MISR_TAMP1MF> TAMP1MF {};
		constexpr static RegisterField<TAMP_MISR_TAMP2MF> TAMP2MF {};
		constexpr static RegisterField<TAMP_MISR_ITAMP1MF> ITAMP1MF {};
		constexpr static RegisterField<TAMP_MISR_ITAMP3MF> ITAMP3MF {};
		constexpr static RegisterField<TAMP_MISR_ITAMP4MF> ITAMP4MF {};
		constexpr static RegisterField<TAMP_MISR_ITAMP5MF> ITAMP5MF {};
		constexpr static RegisterField<TAMP_MISR_ITAMP6MF> ITAMP6MF {};
	};

	struct SCR {
		DECL_REGISTER(TAMP_SCR_BASE);
		constexpr static RegisterField<TAMP_SCR_CTAMP1F> CTAMP1F {};
		constexpr static RegisterField<TAMP_SCR_CTAMP2F> CTAMP2F {};
		constexpr static RegisterField<TAMP_SCR_CITAMP1F> CITAMP1F {};
		constexpr static RegisterField<TAMP_SCR_CITAMP3F> CITAMP3F {};
		constexpr static RegisterField<TAMP_SCR_CITAMP4F> CITAMP4F {};
		constexpr static RegisterField<TAMP_SCR_CITAMP5F> CITAMP5F {};
		constexpr static RegisterField<TAMP_SCR_CITAMP6F> CITAMP6F {};
		constexpr static RegisterField<TAMP_SCR_CITAMP7F> CITAMP7F {};
	};

	struct BKP0R {
		DECL_REGISTER(TAMP_BKP0R_BASE);
		constexpr static RegisterField<TAMP_BKP0R_BKP> BKP {};
	};

	struct BKP1R {
		DECL_REGISTER(TAMP_BKP1R_BASE);
		constexpr static RegisterField<TAMP_BKP1R_BKP> BKP {};
	};

	struct BKP2R {
		DECL_REGISTER(TAMP_BKP2R_BASE);
		constexpr static RegisterField<TAMP_BKP2R_BKP> BKP {};
	};

	struct BKP3R {
		DECL_REGISTER(TAMP_BKP3R_BASE);
		constexpr static RegisterField<TAMP_BKP3R_BKP> BKP {};
	};

	struct BKP4R {
		DECL_REGISTER(TAMP_BKP4R_BASE);
		constexpr static RegisterField<TAMP_BKP4R_BKP> BKP {};
	};

	struct HWCFGR2 {
		DECL_REGISTER(TAMP_HWCFGR2_BASE);
		constexpr static RegisterField<TAMP_HWCFGR2_PTIONREG_OUT> PTIONREG_OUT {};
		constexpr static RegisterField<TAMP_HWCFGR2_TRUST_ZONE> TRUST_ZONE {};
	};

	struct HWCFGR1 {
		DECL_REGISTER(TAMP_HWCFGR1_BASE);
		constexpr static RegisterField<TAMP_HWCFGR1_BACKUP_REGS> BACKUP_REGS {};
		constexpr static RegisterField<TAMP_HWCFGR1_TAMPER> TAMPER {};
		constexpr static RegisterField<TAMP_HWCFGR1_ACTIVE_TAMPER> ACTIVE_TAMPER {};
		constexpr static RegisterField<TAMP_HWCFGR1_INT_TAMPER> INT_TAMPER {};
	};

	struct VERR {
		DECL_REGISTER(TAMP_VERR_BASE);
		constexpr static RegisterField<TAMP_VERR_MINREV> MINREV {};
		constexpr static RegisterField<TAMP_VERR_MAJREV> MAJREV {};
	};

	struct IPIDR {
		DECL_REGISTER(TAMP_IPIDR_BASE);
		constexpr static RegisterField<TAMP_IPIDR_IPID> IPID {};
	};

	struct SIDR {
		DECL_REGISTER(TAMP_SIDR_BASE);
		constexpr static RegisterField<TAMP_SIDR_SID> SID {};
	};
...
struct UCPD1 {
	struct CFG1 {
		DECL_REGISTER(UCPD1_CFG1_BASE);
		constexpr static RegisterField<UCPD1_CFG1_HBITCLKDIV> HBITCLKDIV {};
		constexpr static RegisterField<UCPD1_CFG1_IFRGAP> IFRGAP {};
		constexpr static RegisterField<UCPD1_CFG1_TRANSWIN> TRANSWIN {};
		constexpr static RegisterField<UCPD1_CFG1_PSC_USBPDCLK> PSC_USBPDCLK {};
		constexpr static RegisterField<UCPD1_CFG1_RXORDSETEN> RXORDSETEN {};
		constexpr static RegisterField<UCPD1_CFG1_TXDMAEN> TXDMAEN {};
		constexpr static RegisterField<UCPD1_CFG1_RXDMAEN> RXDMAEN {};
		constexpr static RegisterField<UCPD1_CFG1_UCPDEN> UCPDEN {};
	};

	struct CFG2 {
		DECL_REGISTER(UCPD1_CFG2_BASE);
		constexpr static RegisterField<UCPD1_CFG2_RXFILTDIS> RXFILTDIS {};
		constexpr static RegisterField<UCPD1_CFG2_RXFILT2N3> RXFILT2N3 {};
		constexpr static RegisterField<UCPD1_CFG2_FORCECLK> FORCECLK {};
		constexpr static RegisterField<UCPD1_CFG2_WUPEN> WUPEN {};
	};

	struct CFG3 {
		DECL_REGISTER(UCPD1_CFG3_BASE);
		constexpr static RegisterField<UCPD1_CFG3_TRIM1_NG_CCRPD> TRIM1_NG_CCRPD {};
		constexpr static RegisterField<UCPD1_CFG3_TRIM1_NG_CC1A5> TRIM1_NG_CC1A5 {};
		constexpr static RegisterField<UCPD1_CFG3_TRIM1_NG_CC3A0> TRIM1_NG_CC3A0 {};
		constexpr static RegisterField<UCPD1_CFG3_TRIM2_NG_CCRPD> TRIM2_NG_CCRPD {};
		constexpr static RegisterField<UCPD1_CFG3_TRIM2_NG_CC1A5> TRIM2_NG_CC1A5 {};
		constexpr static RegisterField<UCPD1_CFG3_TRIM2_NG_CC3A0> TRIM2_NG_CC3A0 {};
	};

	struct CR {
		DECL_REGISTER(UCPD1_CR_BASE);
		constexpr static RegisterField<UCPD1_CR_TXMODE> TXMODE {};
		constexpr static RegisterField<UCPD1_CR_TXSEND> TXSEND {};
		constexpr static RegisterField<UCPD1_CR_TXHRST> TXHRST {};
		constexpr static RegisterField<UCPD1_CR_RXMODE> RXMODE {};
		constexpr static RegisterField<UCPD1_CR_PHYRXEN> PHYRXEN {};
		constexpr static RegisterField<UCPD1_CR_PHYCCSEL> PHYCCSEL {};
		constexpr static RegisterField<UCPD1_CR_ANASUBMODE> ANASUBMODE {};
		constexpr static RegisterField<UCPD1_CR_ANAMODE> ANAMODE {};
		constexpr static RegisterField<UCPD1_CR_CCENABLE> CCENABLE {};
		constexpr static RegisterField<UCPD1_CR_DBATTEN> DBATTEN {};
		constexpr static RegisterField<UCPD1_CR_FRSRXEN> FRSRXEN {};
		constexpr static RegisterField<UCPD1_CR_FRSTX> FRSTX {};
		constexpr static RegisterField<UCPD1_CR_RDCH> RDCH {};
		constexpr static RegisterField<UCPD1_CR_CC1TCDIS> CC1TCDIS {};
		constexpr static RegisterField<UCPD1_CR_CC2TCDIS> CC2TCDIS {};
	};

	struct IMR {
		DECL_REGISTER(UCPD1_IMR_BASE);
		constexpr static RegisterField<UCPD1_IMR_TXISIE> TXISIE {};
		constexpr static RegisterField<UCPD1_IMR_TXMSGDISCIE> TXMSGDISCIE {};
		constexpr static RegisterField<UCPD1_IMR_TXMSGSENTIE> TXMSGSENTIE {};
		constexpr static RegisterField<UCPD1_IMR_TXMSGABTIE> TXMSGABTIE {};
		constexpr static RegisterField<UCPD1_IMR_HRSTDISCIE> HRSTDISCIE {};
		constexpr static RegisterField<UCPD1_IMR_HRSTSENTIE> HRSTSENTIE {};
		constexpr static RegisterField<UCPD1_IMR_TXUNDIE> TXUNDIE {};
		constexpr static RegisterField<UCPD1_IMR_RXNEIE> RXNEIE {};
		constexpr static RegisterField<UCPD1_IMR_RXORDDETIE> RXORDDETIE {};
		constexpr static RegisterField<UCPD1_IMR_RXHRSTDETIE> RXHRSTDETIE {};
		constexpr static RegisterField<UCPD1_IMR_RXOVRIE> RXOVRIE {};
		constexpr static RegisterField<UCPD1_IMR_RXMSGENDIE> RXMSGENDIE {};
		constexpr static RegisterField<UCPD1_IMR_TYPECEVT1IE> TYPECEVT1IE {};
		constexpr static RegisterField<UCPD1_IMR_TYPECEVT2IE> TYPECEVT2IE {};
		constexpr static RegisterField<UCPD1_IMR_FRSEVTIE> FRSEVTIE {};
	};

	struct SR {
		DECL_REGISTER(UCPD1_SR_BASE);
		constexpr static RegisterField<UCPD1_SR_TXIS> TXIS {};
		constexpr static RegisterField<UCPD1_SR_TXMSGDISC> TXMSGDISC {};
		constexpr static RegisterField<UCPD1_SR_TXMSGSENT> TXMSGSENT {};
		constexpr static RegisterField<UCPD1_SR_TXMSGABT> TXMSGABT {};
		constexpr static RegisterField<UCPD1_SR_HRSTDISC> HRSTDISC {};
		constexpr static RegisterField<UCPD1_SR_HRSTSENT> HRSTSENT {};
		constexpr static RegisterField<UCPD1_SR_TXUND> TXUND {};
		constexpr static RegisterField<UCPD1_SR_RXNE> RXNE {};
		constexpr static RegisterField<UCPD1_SR_RXORDDET> RXORDDET {};
		constexpr static RegisterField<UCPD1_SR_RXHRSTDET> RXHRSTDET {};
		constexpr static RegisterField<UCPD1_SR_RXOVR> RXOVR {};
		constexpr static RegisterField<UCPD1_SR_RXMSGEND> RXMSGEND {};
		constexpr static RegisterField<UCPD1_SR_RXERR> RXERR {};
		constexpr static RegisterField<UCPD1_SR_TYPECEVT1> TYPECEVT1 {};
		constexpr static RegisterField<UCPD1_SR_TYPECEVT2> TYPECEVT2 {};
		constexpr static RegisterField<UCPD1_SR_TYPEC_VSTATE_CC1> TYPEC_VSTATE_CC1 {};
		constexpr static RegisterField<UCPD1_SR_TYPEC_VSTATE_CC2> TYPEC_VSTATE_CC2 {};
		constexpr static RegisterField<UCPD1_SR_FRSEVT> FRSEVT {};
	};

	struct ICR {
		DECL_REGISTER(UCPD1_ICR_BASE);
		constexpr static RegisterField<UCPD1_ICR_TXMSGDISCCF> TXMSGDISCCF {};
		constexpr static RegisterField<UCPD1_ICR_TXMSGSENTCF> TXMSGSENTCF {};
		constexpr static RegisterField<UCPD1_ICR_TXMSGABTCF> TXMSGABTCF {};
		constexpr static RegisterField<UCPD1_ICR_HRSTDISCCF> HRSTDISCCF {};
		constexpr static RegisterField<UCPD1_ICR_HRSTSENTCF> HRSTSENTCF {};
		constexpr static RegisterField<UCPD1_ICR_TXUNDCF> TXUNDCF {};
		constexpr static RegisterField<UCPD1_ICR_RXORDDETCF> RXORDDETCF {};
		constexpr static RegisterField<UCPD1_ICR_RXHRSTDETCF> RXHRSTDETCF {};
		constexpr static RegisterField<UCPD1_ICR_RXOVRCF> RXOVRCF {};
		constexpr static RegisterField<UCPD1_ICR_RXMSGENDCF> RXMSGENDCF {};
		constexpr static RegisterField<UCPD1_ICR_TYPECEVT1CF> TYPECEVT1CF {};
		constexpr static RegisterField<UCPD1_ICR_TYPECEVT2CF> TYPECEVT2CF {};
		constexpr static RegisterField<UCPD1_ICR_FRSEVTCF> FRSEVTCF {};
	};

	struct TX_ORDSET {
		DECL_REGISTER(UCPD1_TX_ORDSET_BASE);
		constexpr static RegisterField<UCPD1_TX_ORDSET_TXORDSET> TXORDSET {};
	};

	struct TX_PAYSZ {
		DECL_REGISTER(UCPD1_TX_PAYSZ_BASE);
		constexpr static RegisterField<UCPD1_TX_PAYSZ_TXPAYSZ> TXPAYSZ {};
	};

	struct TXDR {
		DECL_REGISTER(UCPD1_TXDR_BASE);
		constexpr static RegisterField<UCPD1_TXDR_TXDATA> TXDATA {};
	};

	struct RX_ORDSET {
		DECL_REGISTER(UCPD1_RX_ORDSET_BASE);
		constexpr static RegisterField<UCPD1_RX_ORDSET_RXORDSET> RXORDSET {};
		constexpr static RegisterField<UCPD1_RX_ORDSET_RXSOP3OF4> RXSOP3OF4 {};
		constexpr static RegisterField<UCPD1_RX_ORDSET_RXSOPKINVALID> RXSOPKINVALID {};
	};

	struct RX_PAYSZ {
		DECL_REGISTER(UCPD1_RX_PAYSZ_BASE);
		constexpr static RegisterField<UCPD1_RX_PAYSZ_RXPAYSZ> RXPAYSZ {};
	};

	struct RXDR {
		DECL_REGISTER(UCPD1_RXDR_BASE);
		constexpr static RegisterField<UCPD1_RXDR_RXDATA> RXDATA {};
	};

	struct RX_ORDEXT1 {
		DECL_REGISTER(UCPD1_RX_ORDEXT1_BASE);
		constexpr static RegisterField<UCPD1_RX_ORDEXT1_RXSOPX1> RXSOPX1 {};
	};

	struct RX_ORDEXT2 {
		DECL_REGISTER(UCPD1_RX_ORDEXT2_BASE);
		constexpr static RegisterField<UCPD1_RX_ORDEXT2_RXSOPX2> RXSOPX2 {};
	};

	struct IPVER {
		DECL_REGISTER(UCPD1_IPVER_BASE);
		constexpr static RegisterField<UCPD1_IPVER_IPVER> IPVERV {};
	};

	struct IPID {
		DECL_REGISTER(UCPD1_IPID_BASE);
		constexpr static RegisterField<UCPD1_IPID_IPID> IPIDV {};
	};

	struct MID {
		DECL_REGISTER(UCPD1_MID_BASE);
		constexpr static RegisterField<UCPD1_MID_IPID> IPID {};
	};
...
struct UCPD2 {
	struct CFG1 {
		DECL_REGISTER(UCPD2_CFG1_BASE);
		constexpr static RegisterField<UCPD2_CFG1_HBITCLKDIV> HBITCLKDIV {};
		constexpr static RegisterField<UCPD2_CFG1_IFRGAP> IFRGAP {};
		constexpr static RegisterField<UCPD2_CFG1_TRANSWIN> TRANSWIN {};
		constexpr static RegisterField<UCPD2_CFG1_PSC_USBPDCLK> PSC_USBPDCLK {};
		constexpr static RegisterField<UCPD2_CFG1_RXORDSETEN> RXORDSETEN {};
		constexpr static RegisterField<UCPD2_CFG1_TXDMAEN> TXDMAEN {};
		constexpr static RegisterField<UCPD2_CFG1_RXDMAEN> RXDMAEN {};
		constexpr static RegisterField<UCPD2_CFG1_UCPDEN> UCPDEN {};
	};

	struct CFG2 {
		DECL_REGISTER(UCPD2_CFG2_BASE);
		constexpr static RegisterField<UCPD2_CFG2_RXFILTDIS> RXFILTDIS {};
		constexpr static RegisterField<UCPD2_CFG2_RXFILT2N3> RXFILT2N3 {};
		constexpr static RegisterField<UCPD2_CFG2_FORCECLK> FORCECLK {};
		constexpr static RegisterField<UCPD2_CFG2_WUPEN> WUPEN {};
	};

	struct CFG3 {
		DECL_REGISTER(UCPD2_CFG3_BASE);
		constexpr static RegisterField<UCPD2_CFG3_TRIM1_NG_CCRPD> TRIM1_NG_CCRPD {};
		constexpr static RegisterField<UCPD2_CFG3_TRIM1_NG_CC1A5> TRIM1_NG_CC1A5 {};
		constexpr static RegisterField<UCPD2_CFG3_TRIM1_NG_CC3A0> TRIM1_NG_CC3A0 {};
		constexpr static RegisterField<UCPD2_CFG3_TRIM2_NG_CCRPD> TRIM2_NG_CCRPD {};
		constexpr static RegisterField<UCPD2_CFG3_TRIM2_NG_CC1A5> TRIM2_NG_CC1A5 {};
		constexpr static RegisterField<UCPD2_CFG3_TRIM2_NG_CC3A0> TRIM2_NG_CC3A0 {};
	};

	struct CR {
		DECL_REGISTER(UCPD2_CR_BASE);
		constexpr static RegisterField<UCPD2_CR_TXMODE> TXMODE {};
		constexpr static RegisterField<UCPD2_CR_TXSEND> TXSEND {};
		constexpr static RegisterField<UCPD2_CR_TXHRST> TXHRST {};
		constexpr static RegisterField<UCPD2_CR_RXMODE> RXMODE {};
		constexpr static RegisterField<UCPD2_CR_PHYRXEN> PHYRXEN {};
		constexpr static RegisterField<UCPD2_CR_PHYCCSEL> PHYCCSEL {};
		constexpr static RegisterField<UCPD2_CR_ANASUBMODE> ANASUBMODE {};
		constexpr static RegisterField<UCPD2_CR_ANAMODE> ANAMODE {};
		constexpr static RegisterField<UCPD2_CR_CCENABLE> CCENABLE {};
		constexpr static RegisterField<UCPD2_CR_DBATTEN> DBATTEN {};
		constexpr static RegisterField<UCPD2_CR_FRSRXEN> FRSRXEN {};
		constexpr static RegisterField<UCPD2_CR_FRSTX> FRSTX {};
		constexpr static RegisterField<UCPD2_CR_RDCH> RDCH {};
		constexpr static RegisterField<UCPD2_CR_CC1TCDIS> CC1TCDIS {};
		constexpr static RegisterField<UCPD2_CR_CC2TCDIS> CC2TCDIS {};
	};

	struct IMR {
		DECL_REGISTER(UCPD2_IMR_BASE);
		constexpr static RegisterField<UCPD2_IMR_TXISIE> TXISIE {};
		constexpr static RegisterField<UCPD2_IMR_TXMSGDISCIE> TXMSGDISCIE {};
		constexpr static RegisterField<UCPD2_IMR_TXMSGSENTIE> TXMSGSENTIE {};
		constexpr static RegisterField<UCPD2_IMR_TXMSGABTIE> TXMSGABTIE {};
		constexpr static RegisterField<UCPD2_IMR_HRSTDISCIE> HRSTDISCIE {};
		constexpr static RegisterField<UCPD2_IMR_HRSTSENTIE> HRSTSENTIE {};
		constexpr static RegisterField<UCPD2_IMR_TXUNDIE> TXUNDIE {};
		constexpr static RegisterField<UCPD2_IMR_RXNEIE> RXNEIE {};
		constexpr static RegisterField<UCPD2_IMR_RXORDDETIE> RXORDDETIE {};
		constexpr static RegisterField<UCPD2_IMR_RXHRSTDETIE> RXHRSTDETIE {};
		constexpr static RegisterField<UCPD2_IMR_RXOVRIE> RXOVRIE {};
		constexpr static RegisterField<UCPD2_IMR_RXMSGENDIE> RXMSGENDIE {};
		constexpr static RegisterField<UCPD2_IMR_TYPECEVT1IE> TYPECEVT1IE {};
		constexpr static RegisterField<UCPD2_IMR_TYPECEVT2IE> TYPECEVT2IE {};
		constexpr static RegisterField<UCPD2_IMR_FRSEVTIE> FRSEVTIE {};
	};

	struct SR {
		DECL_REGISTER(UCPD2_SR_BASE);
		constexpr static RegisterField<UCPD2_SR_TXIS> TXIS {};
		constexpr static RegisterField<UCPD2_SR_TXMSGDISC> TXMSGDISC {};
		constexpr static RegisterField<UCPD2_SR_TXMSGSENT> TXMSGSENT {};
		constexpr static RegisterField<UCPD2_SR_TXMSGABT> TXMSGABT {};
		constexpr static RegisterField<UCPD2_SR_HRSTDISC> HRSTDISC {};
		constexpr static RegisterField<UCPD2_SR_HRSTSENT> HRSTSENT {};
		constexpr static RegisterField<UCPD2_SR_TXUND> TXUND {};
		constexpr static RegisterField<UCPD2_SR_RXNE> RXNE {};
		constexpr static RegisterField<UCPD2_SR_RXORDDET> RXORDDET {};
		constexpr static RegisterField<UCPD2_SR_RXHRSTDET> RXHRSTDET {};
		constexpr static RegisterField<UCPD2_SR_RXOVR> RXOVR {};
		constexpr static RegisterField<UCPD2_SR_RXMSGEND> RXMSGEND {};
		constexpr static RegisterField<UCPD2_SR_RXERR> RXERR {};
		constexpr static RegisterField<UCPD2_SR_TYPECEVT1> TYPECEVT1 {};
		constexpr static RegisterField<UCPD2_SR_TYPECEVT2> TYPECEVT2 {};
		constexpr static RegisterField<UCPD2_SR_TYPEC_VSTATE_CC1> TYPEC_VSTATE_CC1 {};
		constexpr static RegisterField<UCPD2_SR_TYPEC_VSTATE_CC2> TYPEC_VSTATE_CC2 {};
		constexpr static RegisterField<UCPD2_SR_FRSEVT> FRSEVT {};
	};

	struct ICR {
		DECL_REGISTER(UCPD2_ICR_BASE);
		constexpr static RegisterField<UCPD2_ICR_TXMSGDISCCF> TXMSGDISCCF {};
		constexpr static RegisterField<UCPD2_ICR_TXMSGSENTCF> TXMSGSENTCF {};
		constexpr static RegisterField<UCPD2_ICR_TXMSGABTCF> TXMSGABTCF {};
		constexpr static RegisterField<UCPD2_ICR_HRSTDISCCF> HRSTDISCCF {};
		constexpr static RegisterField<UCPD2_ICR_HRSTSENTCF> HRSTSENTCF {};
		constexpr static RegisterField<UCPD2_ICR_TXUNDCF> TXUNDCF {};
		constexpr static RegisterField<UCPD2_ICR_RXORDDETCF> RXORDDETCF {};
		constexpr static RegisterField<UCPD2_ICR_RXHRSTDETCF> RXHRSTDETCF {};
		constexpr static RegisterField<UCPD2_ICR_RXOVRCF> RXOVRCF {};
		constexpr static RegisterField<UCPD2_ICR_RXMSGENDCF> RXMSGENDCF {};
		constexpr static RegisterField<UCPD2_ICR_TYPECEVT1CF> TYPECEVT1CF {};
		constexpr static RegisterField<UCPD2_ICR_TYPECEVT2CF> TYPECEVT2CF {};
		constexpr static RegisterField<UCPD2_ICR_FRSEVTCF> FRSEVTCF {};
	};

	struct TX_ORDSET {
		DECL_REGISTER(UCPD2_TX_ORDSET_BASE);
		constexpr static RegisterField<UCPD2_TX_ORDSET_TXORDSET> TXORDSET {};
	};

	struct TX_PAYSZ {
		DECL_REGISTER(UCPD2_TX_PAYSZ_BASE);
		constexpr static RegisterField<UCPD2_TX_PAYSZ_TXPAYSZ> TXPAYSZ {};
	};

	struct TXDR {
		DECL_REGISTER(UCPD2_TXDR_BASE);
		constexpr static RegisterField<UCPD2_TXDR_TXDATA> TXDATA {};
	};

	struct RX_ORDSET {
		DECL_REGISTER(UCPD2_RX_ORDSET_BASE);
		constexpr static RegisterField<UCPD2_RX_ORDSET_RXORDSET> RXORDSET {};
		constexpr static RegisterField<UCPD2_RX_ORDSET_RXSOP3OF4> RXSOP3OF4 {};
		constexpr static RegisterField<UCPD2_RX_ORDSET_RXSOPKINVALID> RXSOPKINVALID {};
	};

	struct RX_PAYSZ {
		DECL_REGISTER(UCPD2_RX_PAYSZ_BASE);
		constexpr static RegisterField<UCPD2_RX_PAYSZ_RXPAYSZ> RXPAYSZ {};
	};

	struct RXDR {
		DECL_REGISTER(UCPD2_RXDR_BASE);
		constexpr static RegisterField<UCPD2_RXDR_RXDATA> RXDATA {};
	};

	struct RX_ORDEXT1 {
		DECL_REGISTER(UCPD2_RX_ORDEXT1_BASE);
		constexpr static RegisterField<UCPD2_RX_ORDEXT1_RXSOPX1> RXSOPX1 {};
	};

	struct RX_ORDEXT2 {
		DECL_REGISTER(UCPD2_RX_ORDEXT2_BASE);
		constexpr static RegisterField<UCPD2_RX_ORDEXT2_RXSOPX2> RXSOPX2 {};
	};

	struct IPVER {
		DECL_REGISTER(UCPD2_IPVER_BASE);
		constexpr static RegisterField<UCPD2_IPVER_IPVER> IPVERV {};
	};

	struct IPID {
		DECL_REGISTER(UCPD2_IPID_BASE);
		constexpr static RegisterField<UCPD2_IPID_IPID> IPIDV {};
	};

	struct MID {
		DECL_REGISTER(UCPD2_MID_BASE);
		constexpr static RegisterField<UCPD2_MID_IPID> IPID {};
	};
...
struct LPTIM1 {
	struct ISR {
		DECL_REGISTER(LPTIM1_ISR_BASE);
		constexpr static RegisterField<LPTIM1_ISR_CMPM> CMPM {};
		constexpr static RegisterField<LPTIM1_ISR_ARRM> ARRM {};
		constexpr static RegisterField<LPTIM1_ISR_EXTTRIG> EXTTRIG {};
		constexpr static RegisterField<LPTIM1_ISR_CMPOK> CMPOK {};
		constexpr static RegisterField<LPTIM1_ISR_ARROK> ARROK {};
		constexpr static RegisterField<LPTIM1_ISR_UP> UP {};
		constexpr static RegisterField<LPTIM1_ISR_DOWN> DOWN {};
	};

	struct ICR {
		DECL_REGISTER(LPTIM1_ICR_BASE);
		constexpr static RegisterField<LPTIM1_ICR_CMPMCF> CMPMCF {};
		constexpr static RegisterField<LPTIM1_ICR_ARRMCF> ARRMCF {};
		constexpr static RegisterField<LPTIM1_ICR_EXTTRIGCF> EXTTRIGCF {};
		constexpr static RegisterField<LPTIM1_ICR_CMPOKCF> CMPOKCF {};
		constexpr static RegisterField<LPTIM1_ICR_ARROKCF> ARROKCF {};
		constexpr static RegisterField<LPTIM1_ICR_UPCF> UPCF {};
		constexpr static RegisterField<LPTIM1_ICR_DOWNCF> DOWNCF {};
	};

	struct IER {
		DECL_REGISTER(LPTIM1_IER_BASE);
		constexpr static RegisterField<LPTIM1_IER_CMPMIE> CMPMIE {};
		constexpr static RegisterField<LPTIM1_IER_ARRMIE> ARRMIE {};
		constexpr static RegisterField<LPTIM1_IER_EXTTRIGIE> EXTTRIGIE {};
		constexpr static RegisterField<LPTIM1_IER_CMPOKIE> CMPOKIE {};
		constexpr static RegisterField<LPTIM1_IER_ARROKIE> ARROKIE {};
		constexpr static RegisterField<LPTIM1_IER_UPIE> UPIE {};
		constexpr static RegisterField<LPTIM1_IER_DOWNIE> DOWNIE {};
	};

	struct CFGR {
		DECL_REGISTER(LPTIM1_CFGR_BASE);
		constexpr static RegisterField<LPTIM1_CFGR_CKSEL> CKSEL {};
		constexpr static RegisterField<LPTIM1_CFGR_CKPOL> CKPOL {};
		constexpr static RegisterField<LPTIM1_CFGR_CKFLT> CKFLT {};
		constexpr static RegisterField<LPTIM1_CFGR_TRGFLT> TRGFLT {};
		constexpr static RegisterField<LPTIM1_CFGR_PRESC> PRESC {};
		constexpr static RegisterField<LPTIM1_CFGR_TRIGSEL> TRIGSEL {};
		constexpr static RegisterField<LPTIM1_CFGR_TRIGEN> TRIGEN {};
		constexpr static RegisterField<LPTIM1_CFGR_TIMOUT> TIMOUT {};
		constexpr static RegisterField<LPTIM1_CFGR_WAVE> WAVE {};
		constexpr static RegisterField<LPTIM1_CFGR_WAVPOL> WAVPOL {};
		constexpr static RegisterField<LPTIM1_CFGR_PRELOAD> PRELOAD {};
		constexpr static RegisterField<LPTIM1_CFGR_COUNTMODE> COUNTMODE {};
		constexpr static RegisterField<LPTIM1_CFGR_ENC> ENC {};
	};

	struct CR {
		DECL_REGISTER(LPTIM1_CR_BASE);
		constexpr static RegisterField<LPTIM1_CR_ENABLE> ENABLE {};
		constexpr static RegisterField<LPTIM1_CR_SNGSTRT> SNGSTRT {};
		constexpr static RegisterField<LPTIM1_CR_CNTSTRT> CNTSTRT {};
		constexpr static RegisterField<LPTIM1_CR_COUNTRST> COUNTRST {};
		constexpr static RegisterField<LPTIM1_CR_RSTARE> RSTARE {};
	};

	struct CMP {
		DECL_REGISTER(LPTIM1_CMP_BASE);
		constexpr static RegisterField<LPTIM1_CMP_CMP> CMPV {};
	};

	struct ARR {
		DECL_REGISTER(LPTIM1_ARR_BASE);
		constexpr static RegisterField<LPTIM1_ARR_ARR> ARRV {};
	};

	struct CNT {
		DECL_REGISTER(LPTIM1_CNT_BASE);
		constexpr static RegisterField<LPTIM1_CNT_CNT> CNTV {};
	};

	struct CFGR2 {
		DECL_REGISTER(LPTIM1_CFGR2_BASE);
		constexpr static RegisterField<LPTIM1_CFGR2_IN1SEL> IN1SEL {};
		constexpr static RegisterField<LPTIM1_CFGR2_IN2SEL> IN2SEL {};
	};
...
struct LPTIM2 {
	struct ISR {
		DECL_REGISTER(LPTIM2_ISR_BASE);
		constexpr static RegisterField<LPTIM2_ISR_CMPM> CMPM {};
		constexpr static RegisterField<LPTIM2_ISR_ARRM> ARRM {};
		constexpr static RegisterField<LPTIM2_ISR_EXTTRIG> EXTTRIG {};
		constexpr static RegisterField<LPTIM2_ISR_CMPOK> CMPOK {};
		constexpr static RegisterField<LPTIM2_ISR_ARROK> ARROK {};
		constexpr static RegisterField<LPTIM2_ISR_UP> UP {};
		constexpr static RegisterField<LPTIM2_ISR_DOWN> DOWN {};
	};

	struct ICR {
		DECL_REGISTER(LPTIM2_ICR_BASE);
		constexpr static RegisterField<LPTIM2_ICR_CMPMCF> CMPMCF {};
		constexpr static RegisterField<LPTIM2_ICR_ARRMCF> ARRMCF {};
		constexpr static RegisterField<LPTIM2_ICR_EXTTRIGCF> EXTTRIGCF {};
		constexpr static RegisterField<LPTIM2_ICR_CMPOKCF> CMPOKCF {};
		constexpr static RegisterField<LPTIM2_ICR_ARROKCF> ARROKCF {};
		constexpr static RegisterField<LPTIM2_ICR_UPCF> UPCF {};
		constexpr static RegisterField<LPTIM2_ICR_DOWNCF> DOWNCF {};
	};

	struct IER {
		DECL_REGISTER(LPTIM2_IER_BASE);
		constexpr static RegisterField<LPTIM2_IER_CMPMIE> CMPMIE {};
		constexpr static RegisterField<LPTIM2_IER_ARRMIE> ARRMIE {};
		constexpr static RegisterField<LPTIM2_IER_EXTTRIGIE> EXTTRIGIE {};
		constexpr static RegisterField<LPTIM2_IER_CMPOKIE> CMPOKIE {};
		constexpr static RegisterField<LPTIM2_IER_ARROKIE> ARROKIE {};
		constexpr static RegisterField<LPTIM2_IER_UPIE> UPIE {};
		constexpr static RegisterField<LPTIM2_IER_DOWNIE> DOWNIE {};
	};

	struct CFGR {
		DECL_REGISTER(LPTIM2_CFGR_BASE);
		constexpr static RegisterField<LPTIM2_CFGR_CKSEL> CKSEL {};
		constexpr static RegisterField<LPTIM2_CFGR_CKPOL> CKPOL {};
		constexpr static RegisterField<LPTIM2_CFGR_CKFLT> CKFLT {};
		constexpr static RegisterField<LPTIM2_CFGR_TRGFLT> TRGFLT {};
		constexpr static RegisterField<LPTIM2_CFGR_PRESC> PRESC {};
		constexpr static RegisterField<LPTIM2_CFGR_TRIGSEL> TRIGSEL {};
		constexpr static RegisterField<LPTIM2_CFGR_TRIGEN> TRIGEN {};
		constexpr static RegisterField<LPTIM2_CFGR_TIMOUT> TIMOUT {};
		constexpr static RegisterField<LPTIM2_CFGR_WAVE> WAVE {};
		constexpr static RegisterField<LPTIM2_CFGR_WAVPOL> WAVPOL {};
		constexpr static RegisterField<LPTIM2_CFGR_PRELOAD> PRELOAD {};
		constexpr static RegisterField<LPTIM2_CFGR_COUNTMODE> COUNTMODE {};
		constexpr static RegisterField<LPTIM2_CFGR_ENC> ENC {};
	};

	struct CR {
		DECL_REGISTER(LPTIM2_CR_BASE);
		constexpr static RegisterField<LPTIM2_CR_ENABLE> ENABLE {};
		constexpr static RegisterField<LPTIM2_CR_SNGSTRT> SNGSTRT {};
		constexpr static RegisterField<LPTIM2_CR_CNTSTRT> CNTSTRT {};
		constexpr static RegisterField<LPTIM2_CR_COUNTRST> COUNTRST {};
		constexpr static RegisterField<LPTIM2_CR_RSTARE> RSTARE {};
	};

	struct CMP {
		DECL_REGISTER(LPTIM2_CMP_BASE);
		constexpr static RegisterField<LPTIM2_CMP_CMP> CMPV {};
	};

	struct ARR {
		DECL_REGISTER(LPTIM2_ARR_BASE);
		constexpr static RegisterField<LPTIM2_ARR_ARR> ARRV {};
	};

	struct CNT {
		DECL_REGISTER(LPTIM2_CNT_BASE);
		constexpr static RegisterField<LPTIM2_CNT_CNT> CNTV {};
	};

	struct CFGR2 {
		DECL_REGISTER(LPTIM2_CFGR2_BASE);
		constexpr static RegisterField<LPTIM2_CFGR2_IN1SEL> IN1SEL {};
		constexpr static RegisterField<LPTIM2_CFGR2_IN2SEL> IN2SEL {};
	};
...
struct LPUART {
	struct CR1 {
		DECL_REGISTER(LPUART_CR1_BASE);
		constexpr static RegisterField<LPUART_CR1_UE> UE {};
		constexpr static RegisterField<LPUART_CR1_UESM> UESM {};
		constexpr static RegisterField<LPUART_CR1_RE> RE {};
		constexpr static RegisterField<LPUART_CR1_TE> TE {};
		constexpr static RegisterField<LPUART_CR1_IDLEIE> IDLEIE {};
		constexpr static RegisterField<LPUART_CR1_RXNEIE> RXNEIE {};
		constexpr static RegisterField<LPUART_CR1_TCIE> TCIE {};
		constexpr static RegisterField<LPUART_CR1_TXEIE> TXEIE {};
		constexpr static RegisterField<LPUART_CR1_PEIE> PEIE {};
		constexpr static RegisterField<LPUART_CR1_PS> PS {};
		constexpr static RegisterField<LPUART_CR1_PCE> PCE {};
		constexpr static RegisterField<LPUART_CR1_WAKE> WAKE {};
		constexpr static RegisterField<LPUART_CR1_M0> M0 {};
		constexpr static RegisterField<LPUART_CR1_MME> MME {};
		constexpr static RegisterField<LPUART_CR1_CMIE> CMIE {};
		constexpr static RegisterField<LPUART_CR1_DEDT0> DEDT0 {};
		constexpr static RegisterField<LPUART_CR1_DEAT> DEAT {};
		constexpr static RegisterField<LPUART_CR1_M1> M1 {};
		constexpr static RegisterField<LPUART_CR1_FIFOEN> FIFOEN {};
		constexpr static RegisterField<LPUART_CR1_TXFEIE> TXFEIE {};
		constexpr static RegisterField<LPUART_CR1_RXFFIE> RXFFIE {};
	};

	struct CR2 {
		DECL_REGISTER(LPUART_CR2_BASE);
		constexpr static RegisterField<LPUART_CR2_ADDM7> ADDM7 {};
		constexpr static RegisterField<LPUART_CR2_STOP> STOP {};
		constexpr static RegisterField<LPUART_CR2_SWAP> SWAP {};
		constexpr static RegisterField<LPUART_CR2_RXINV> RXINV {};
		constexpr static RegisterField<LPUART_CR2_TXINV> TXINV {};
		constexpr static RegisterField<LPUART_CR2_TAINV> TAINV {};
		constexpr static RegisterField<LPUART_CR2_MSBFIRST> MSBFIRST {};
		constexpr static RegisterField<LPUART_CR2_ADD0_3> ADD0_3 {};
		constexpr static RegisterField<LPUART_CR2_ADD4_7> ADD4_7 {};
	};

	struct CR3 {
		DECL_REGISTER(LPUART_CR3_BASE);
		constexpr static RegisterField<LPUART_CR3_EIE> EIE {};
		constexpr static RegisterField<LPUART_CR3_HDSEL> HDSEL {};
		constexpr static RegisterField<LPUART_CR3_DMAR> DMAR {};
		constexpr static RegisterField<LPUART_CR3_DMAT> DMAT {};
		constexpr static RegisterField<LPUART_CR3_RTSE> RTSE {};
		constexpr static RegisterField<LPUART_CR3_CTSE> CTSE {};
		constexpr static RegisterField<LPUART_CR3_CTSIE> CTSIE {};
		constexpr static RegisterField<LPUART_CR3_OVRDIS> OVRDIS {};
		constexpr static RegisterField<LPUART_CR3_DDRE> DDRE {};
		constexpr static RegisterField<LPUART_CR3_DEM> DEM {};
		constexpr static RegisterField<LPUART_CR3_DEP> DEP {};
		constexpr static RegisterField<LPUART_CR3_WUS> WUS {};
		constexpr static RegisterField<LPUART_CR3_WUFIE> WUFIE {};
		constexpr static RegisterField<LPUART_CR3_TXFTIE> TXFTIE {};
		constexpr static RegisterField<LPUART_CR3_RXFTCFG> RXFTCFG {};
		constexpr static RegisterField<LPUART_CR3_RXFTIE> RXFTIE {};
		constexpr static RegisterField<LPUART_CR3_TXFTCFG> TXFTCFG {};
	};

	struct BRR {
		DECL_REGISTER(LPUART_BRR_BASE);
		constexpr static RegisterField<LPUART_BRR_BRR> BRRV {};
	};

	struct RQR {
		DECL_REGISTER(LPUART_RQR_BASE);
		constexpr static RegisterField<LPUART_RQR_ABRRQ> ABRRQ {};
		constexpr static RegisterField<LPUART_RQR_SBKRQ> SBKRQ {};
		constexpr static RegisterField<LPUART_RQR_MMRQ> MMRQ {};
		constexpr static RegisterField<LPUART_RQR_RXFRQ> RXFRQ {};
		constexpr static RegisterField<LPUART_RQR_TXFRQ> TXFRQ {};
	};

	struct ISR {
		DECL_REGISTER(LPUART_ISR_BASE);
		constexpr static RegisterField<LPUART_ISR_PE> PE {};
		constexpr static RegisterField<LPUART_ISR_FE> FE {};
		constexpr static RegisterField<LPUART_ISR_NF> NF {};
		constexpr static RegisterField<LPUART_ISR_ORE> ORE {};
		constexpr static RegisterField<LPUART_ISR_IDLE> IDLE {};
		constexpr static RegisterField<LPUART_ISR_RXNE> RXNE {};
		constexpr static RegisterField<LPUART_ISR_TC> TC {};
		constexpr static RegisterField<LPUART_ISR_TXE> TXE {};
		constexpr static RegisterField<LPUART_ISR_CTSIF> CTSIF {};
		constexpr static RegisterField<LPUART_ISR_CTS> CTS {};
		constexpr static RegisterField<LPUART_ISR_BUSY> BUSY {};
		constexpr static RegisterField<LPUART_ISR_CMF> CMF {};
		constexpr static RegisterField<LPUART_ISR_SBKF> SBKF {};
		constexpr static RegisterField<LPUART_ISR_RWU> RWU {};
		constexpr static RegisterField<LPUART_ISR_WUF> WUF {};
		constexpr static RegisterField<LPUART_ISR_TEACK> TEACK {};
		constexpr static RegisterField<LPUART_ISR_REACK> REACK {};
		constexpr static RegisterField<LPUART_ISR_TXFE> TXFE {};
		constexpr static RegisterField<LPUART_ISR_RXFF> RXFF {};
		constexpr static RegisterField<LPUART_ISR_RXFT> RXFT {};
		constexpr static RegisterField<LPUART_ISR_TXFT> TXFT {};
	};

	struct ICR {
		DECL_REGISTER(LPUART_ICR_BASE);
		constexpr static RegisterField<LPUART_ICR_PECF> PECF {};
		constexpr static RegisterField<LPUART_ICR_FECF> FECF {};
		constexpr static RegisterField<LPUART_ICR_NCF> NCF {};
		constexpr static RegisterField<LPUART_ICR_ORECF> ORECF {};
		constexpr static RegisterField<LPUART_ICR_IDLECF> IDLECF {};
		constexpr static RegisterField<LPUART_ICR_TCCF> TCCF {};
		constexpr static RegisterField<LPUART_ICR_CTSCF> CTSCF {};
		constexpr static RegisterField<LPUART_ICR_CMCF> CMCF {};
		constexpr static RegisterField<LPUART_ICR_WUCF> WUCF {};
	};

	struct RDR {
		DECL_REGISTER(LPUART_RDR_BASE);
		constexpr static RegisterField<LPUART_RDR_RDR> RDRV {};
	};

	struct TDR {
		DECL_REGISTER(LPUART_TDR_BASE);
		constexpr static RegisterField<LPUART_TDR_TDR> TDRV {};
	};

	struct PRESC {
		DECL_REGISTER(LPUART_PRESC_BASE);
		constexpr static RegisterField<LPUART_PRESC_PRESCALER> PRESCALER {};
	};

	struct HWCFGR2 {
		DECL_REGISTER(LPUART_HWCFGR2_BASE);
		constexpr static RegisterField<LPUART_HWCFGR2_CFG1> CFG1 {};
		constexpr static RegisterField<LPUART_HWCFGR2_CFG2> CFG2 {};
	};

	struct HWCFGR1 {
		DECL_REGISTER(LPUART_HWCFGR1_BASE);
		constexpr static RegisterField<LPUART_HWCFGR1_CFG1> CFG1 {};
		constexpr static RegisterField<LPUART_HWCFGR1_CFG2> CFG2 {};
		constexpr static RegisterField<LPUART_HWCFGR1_CFG3> CFG3 {};
		constexpr static RegisterField<LPUART_HWCFGR1_CFG4> CFG4 {};
		constexpr static RegisterField<LPUART_HWCFGR1_CFG5> CFG5 {};
		constexpr static RegisterField<LPUART_HWCFGR1_CFG6> CFG6 {};
		constexpr static RegisterField<LPUART_HWCFGR1_CFG7> CFG7 {};
		constexpr static RegisterField<LPUART_HWCFGR1_CFG8> CFG8 {};
	};

	struct VERR {
		DECL_REGISTER(LPUART_VERR_BASE);
		constexpr static RegisterField<LPUART_VERR_MINREV> MINREV {};
		constexpr static RegisterField<LPUART_VERR_MAJREV> MAJREV {};
	};

	struct IPIDR {
		DECL_REGISTER(LPUART_IPIDR_BASE);
		constexpr static RegisterField<LPUART_IPIDR_IPID> IPID {};
	};

	struct SIDR {
		DECL_REGISTER(LPUART_SIDR_BASE);
		constexpr static RegisterField<LPUART_SIDR_SID> SID {};
	};
...
struct HDMI_CEC {
	struct CEC_CR {
		DECL_REGISTER(HDMI_CEC_CEC_CR_BASE);
		constexpr static RegisterField<HDMI_CEC_CEC_CR_CECEN> CECEN {};
		constexpr static RegisterField<HDMI_CEC_CEC_CR_TXSOM> TXSOM {};
		constexpr static RegisterField<HDMI_CEC_CEC_CR_TXEOM> TXEOM {};
	};

	struct CEC_CFGR {
		DECL_REGISTER(HDMI_CEC_CEC_CFGR_BASE);
		constexpr static RegisterField<HDMI_CEC_CEC_CFGR_SFT> SFT {};
		constexpr static RegisterField<HDMI_CEC_CEC_CFGR_RXTOL> RXTOL {};
		constexpr static RegisterField<HDMI_CEC_CEC_CFGR_BRESTP> BRESTP {};
		constexpr static RegisterField<HDMI_CEC_CEC_CFGR_BREGEN> BREGEN {};
		constexpr static RegisterField<HDMI_CEC_CEC_CFGR_LBPEGEN> LBPEGEN {};
		constexpr static RegisterField<HDMI_CEC_CEC_CFGR_BRDNOGEN> BRDNOGEN {};
		constexpr static RegisterField<HDMI_CEC_CEC_CFGR_SFTOPT> SFTOPT {};
		constexpr static RegisterField<HDMI_CEC_CEC_CFGR_OAR> OAR {};
		constexpr static RegisterField<HDMI_CEC_CEC_CFGR_LSTN> LSTN {};
	};

	struct CEC_TXDR {
		DECL_REGISTER(HDMI_CEC_CEC_TXDR_BASE);
		constexpr static RegisterField<HDMI_CEC_CEC_TXDR_TXD> TXD {};
	};

	struct CEC_RXDR {
		DECL_REGISTER(HDMI_CEC_CEC_RXDR_BASE);
		constexpr static RegisterField<HDMI_CEC_CEC_RXDR_RXD> RXD {};
	};

	struct CEC_ISR {
		DECL_REGISTER(HDMI_CEC_CEC_ISR_BASE);
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_RXBR> RXBR {};
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_RXEND> RXEND {};
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_RXOVR> RXOVR {};
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_BRE> BRE {};
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_SBPE> SBPE {};
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_LBPE> LBPE {};
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_RXACKE> RXACKE {};
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_ARBLST> ARBLST {};
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_TXBR> TXBR {};
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_TXEND> TXEND {};
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_TXUDR> TXUDR {};
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_TXERR> TXERR {};
		constexpr static RegisterField<HDMI_CEC_CEC_ISR_TXACKE> TXACKE {};
	};

	struct CEC_IER {
		DECL_REGISTER(HDMI_CEC_CEC_IER_BASE);
		constexpr static RegisterField<HDMI_CEC_CEC_IER_RXBRIE> RXBRIE {};
		constexpr static RegisterField<HDMI_CEC_CEC_IER_RXENDIE> RXENDIE {};
		constexpr static RegisterField<HDMI_CEC_CEC_IER_RXOVRIE> RXOVRIE {};
		constexpr static RegisterField<HDMI_CEC_CEC_IER_BREIE> BREIE {};
		constexpr static RegisterField<HDMI_CEC_CEC_IER_SBPEIE> SBPEIE {};
		constexpr static RegisterField<HDMI_CEC_CEC_IER_LBPEIE> LBPEIE {};
		constexpr static RegisterField<HDMI_CEC_CEC_IER_RXACKIE> RXACKIE {};
		constexpr static RegisterField<HDMI_CEC_CEC_IER_ARBLSTIE> ARBLSTIE {};
		constexpr static RegisterField<HDMI_CEC_CEC_IER_TXBRIE> TXBRIE {};
		constexpr static RegisterField<HDMI_CEC_CEC_IER_TXENDIE> TXENDIE {};
		constexpr static RegisterField<HDMI_CEC_CEC_IER_TXUDRIE> TXUDRIE {};
		constexpr static RegisterField<HDMI_CEC_CEC_IER_TXERRIE> TXERRIE {};
		constexpr static RegisterField<HDMI_CEC_CEC_IER_TXACKIE> TXACKIE {};
	};
...
struct DAC {
	struct DAC_CR {
		DECL_REGISTER(DAC_DAC_CR_BASE);
		constexpr static RegisterField<DAC_DAC_CR_EN1> EN1 {};
		constexpr static RegisterField<DAC_DAC_CR_TEN1> TEN1 {};
		constexpr static RegisterField<DAC_DAC_CR_TSEL1> TSEL1 {};
		constexpr static RegisterField<DAC_DAC_CR_WAVE1> WAVE1 {};
		constexpr static RegisterField<DAC_DAC_CR_MAMP1> MAMP1 {};
		constexpr static RegisterField<DAC_DAC_CR_DMAEN1> DMAEN1 {};
		constexpr static RegisterField<DAC_DAC_CR_DMAUDRIE1> DMAUDRIE1 {};
		constexpr static RegisterField<DAC_DAC_CR_CEN1> CEN1 {};
		constexpr static RegisterField<DAC_DAC_CR_EN2> EN2 {};
		constexpr static RegisterField<DAC_DAC_CR_TEN2> TEN2 {};
		constexpr static RegisterField<DAC_DAC_CR_TSEL2> TSEL2 {};
		constexpr static RegisterField<DAC_DAC_CR_WAVE2> WAVE2 {};
		constexpr static RegisterField<DAC_DAC_CR_MAMP2> MAMP2 {};
		constexpr static RegisterField<DAC_DAC_CR_DMAEN2> DMAEN2 {};
		constexpr static RegisterField<DAC_DAC_CR_DMAUDRIE2> DMAUDRIE2 {};
		constexpr static RegisterField<DAC_DAC_CR_CEN2> CEN2 {};
	};

	struct DAC_SWTRGR {
		DECL_REGISTER(DAC_DAC_SWTRGR_BASE);
		constexpr static RegisterField<DAC_DAC_SWTRGR_SWTRIG1> SWTRIG1 {};
		constexpr static RegisterField<DAC_DAC_SWTRGR_SWTRIG2> SWTRIG2 {};
	};

	struct DAC_DHR12R1 {
		DECL_REGISTER(DAC_DAC_DHR12R1_BASE);
		constexpr static RegisterField<DAC_DAC_DHR12R1_DACC1DHR> DACC1DHR {};
	};

	struct DAC_DHR12L1 {
		DECL_REGISTER(DAC_DAC_DHR12L1_BASE);
		constexpr static RegisterField<DAC_DAC_DHR12L1_DACC1DHR> DACC1DHR {};
	};

	struct DAC_DHR8R1 {
		DECL_REGISTER(DAC_DAC_DHR8R1_BASE);
		constexpr static RegisterField<DAC_DAC_DHR8R1_DACC1DHR> DACC1DHR {};
	};

	struct DAC_DHR12R2 {
		DECL_REGISTER(DAC_DAC_DHR12R2_BASE);
		constexpr static RegisterField<DAC_DAC_DHR12R2_DACC2DHR> DACC2DHR {};
	};

	struct DAC_DHR12L2 {
		DECL_REGISTER(DAC_DAC_DHR12L2_BASE);
		constexpr static RegisterField<DAC_DAC_DHR12L2_DACC2DHR> DACC2DHR {};
	};

	struct DAC_DHR8R2 {
		DECL_REGISTER(DAC_DAC_DHR8R2_BASE);
		constexpr static RegisterField<DAC_DAC_DHR8R2_DACC2DHR> DACC2DHR {};
	};

	struct DAC_DHR12RD {
		DECL_REGISTER(DAC_DAC_DHR12RD_BASE);
		constexpr static RegisterField<DAC_DAC_DHR12RD_DACC1DHR> DACC1DHR {};
		constexpr static RegisterField<DAC_DAC_DHR12RD_DACC2DHR> DACC2DHR {};
	};

	struct DAC_DHR12LD {
		DECL_REGISTER(DAC_DAC_DHR12LD_BASE);
		constexpr static RegisterField<DAC_DAC_DHR12LD_DACC1DHR> DACC1DHR {};
		constexpr static RegisterField<DAC_DAC_DHR12LD_DACC2DHR> DACC2DHR {};
	};

	struct DAC_DHR8RD {
		DECL_REGISTER(DAC_DAC_DHR8RD_BASE);
		constexpr static RegisterField<DAC_DAC_DHR8RD_DACC1DHR> DACC1DHR {};
		constexpr static RegisterField<DAC_DAC_DHR8RD_DACC2DHR> DACC2DHR {};
	};

	struct DAC_DOR1 {
		DECL_REGISTER(DAC_DAC_DOR1_BASE);
		constexpr static RegisterField<DAC_DAC_DOR1_DACC1DOR> DACC1DOR {};
	};

	struct DAC_DOR2 {
		DECL_REGISTER(DAC_DAC_DOR2_BASE);
		constexpr static RegisterField<DAC_DAC_DOR2_DACC2DOR> DACC2DOR {};
	};

	struct DAC_SR {
		DECL_REGISTER(DAC_DAC_SR_BASE);
		constexpr static RegisterField<DAC_DAC_SR_DMAUDR1> DMAUDR1 {};
		constexpr static RegisterField<DAC_DAC_SR_CAL_FLAG1> CAL_FLAG1 {};
		constexpr static RegisterField<DAC_DAC_SR_BWST1> BWST1 {};
		constexpr static RegisterField<DAC_DAC_SR_DMAUDR2> DMAUDR2 {};
		constexpr static RegisterField<DAC_DAC_SR_CAL_FLAG2> CAL_FLAG2 {};
		constexpr static RegisterField<DAC_DAC_SR_BWST2> BWST2 {};
	};

	struct DAC_CCR {
		DECL_REGISTER(DAC_DAC_CCR_BASE);
		constexpr static RegisterField<DAC_DAC_CCR_OTRIM1> OTRIM1 {};
		constexpr static RegisterField<DAC_DAC_CCR_OTRIM2> OTRIM2 {};
	};

	struct DAC_MCR {
		DECL_REGISTER(DAC_DAC_MCR_BASE);
		constexpr static RegisterField<DAC_DAC_MCR_MODE1> MODE1 {};
		constexpr static RegisterField<DAC_DAC_MCR_MODE2> MODE2 {};
	};

	struct DAC_SHSR1 {
		DECL_REGISTER(DAC_DAC_SHSR1_BASE);
		constexpr static RegisterField<DAC_DAC_SHSR1_TSAMPLE1> TSAMPLE1 {};
	};

	struct DAC_SHSR2 {
		DECL_REGISTER(DAC_DAC_SHSR2_BASE);
		constexpr static RegisterField<DAC_DAC_SHSR2_TSAMPLE2> TSAMPLE2 {};
	};

	struct DAC_SHHR {
		DECL_REGISTER(DAC_DAC_SHHR_BASE);
		constexpr static RegisterField<DAC_DAC_SHHR_THOLD1> THOLD1 {};
		constexpr static RegisterField<DAC_DAC_SHHR_THOLD2> THOLD2 {};
	};

	struct DAC_SHRR {
		DECL_REGISTER(DAC_DAC_SHRR_BASE);
		constexpr static RegisterField<DAC_DAC_SHRR_TREFRESH1> TREFRESH1 {};
		constexpr static RegisterField<DAC_DAC_SHRR_TREFRESH2> TREFRESH2 {};
	};

	struct IP_HWCFGR0 {
		DECL_REGISTER(DAC_IP_HWCFGR0_BASE);
		constexpr static RegisterField<DAC_IP_HWCFGR0_DUAL> DUAL {};
		constexpr static RegisterField<DAC_IP_HWCFGR0_LFSR> LFSR {};
		constexpr static RegisterField<DAC_IP_HWCFGR0_TRIANGLE> TRIANGLE {};
		constexpr static RegisterField<DAC_IP_HWCFGR0_SAMPLE> SAMPLE {};
		constexpr static RegisterField<DAC_IP_HWCFGR0_OR_CFG> OR_CFG {};
	};

	struct VERR {
		DECL_REGISTER(DAC_VERR_BASE);
		constexpr static RegisterField<DAC_VERR_MINREV> MINREV {};
		constexpr static RegisterField<DAC_VERR_MAJREV> MAJREV {};
	};

	struct IPIDR {
		DECL_REGISTER(DAC_IPIDR_BASE);
		constexpr static RegisterField<DAC_IPIDR_IPID> IPID {};
	};

	struct SIDR {
		DECL_REGISTER(DAC_SIDR_BASE);
		constexpr static RegisterField<DAC_SIDR_SID> SID {};
	};
...
struct RTC {
	struct TR {
		DECL_REGISTER(RTC_TR_BASE);
		constexpr static RegisterField<RTC_TR_SU> SU {};
		constexpr static RegisterField<RTC_TR_ST> ST {};
		constexpr static RegisterField<RTC_TR_MNU> MNU {};
		constexpr static RegisterField<RTC_TR_MNT> MNT {};
		constexpr static RegisterField<RTC_TR_HU> HU {};
		constexpr static RegisterField<RTC_TR_HT> HT {};
		constexpr static RegisterField<RTC_TR_PM> PM {};
	};

	struct DR {
		DECL_REGISTER(RTC_DR_BASE);
		constexpr static RegisterField<RTC_DR_DU> DU {};
		constexpr static RegisterField<RTC_DR_DT> DT {};
		constexpr static RegisterField<RTC_DR_MU> MU {};
		constexpr static RegisterField<RTC_DR_MT> MT {};
		constexpr static RegisterField<RTC_DR_WDU> WDU {};
		constexpr static RegisterField<RTC_DR_YU> YU {};
		constexpr static RegisterField<RTC_DR_YT> YT {};
	};

	struct SSR {
		DECL_REGISTER(RTC_SSR_BASE);
		constexpr static RegisterField<RTC_SSR_SS> SS {};
	};

	struct ICSR {
		DECL_REGISTER(RTC_ICSR_BASE);
		constexpr static RegisterField<RTC_ICSR_ALRAWF> ALRAWF {};
		constexpr static RegisterField<RTC_ICSR_ALRBWF> ALRBWF {};
		constexpr static RegisterField<RTC_ICSR_WUTWF> WUTWF {};
		constexpr static RegisterField<RTC_ICSR_SHPF> SHPF {};
		constexpr static RegisterField<RTC_ICSR_INITS> INITS {};
		constexpr static RegisterField<RTC_ICSR_RSF> RSF {};
		constexpr static RegisterField<RTC_ICSR_INITF> INITF {};
		constexpr static RegisterField<RTC_ICSR_INIT> INIT {};
		constexpr static RegisterField<RTC_ICSR_RECALPF> RECALPF {};
	};

	struct PRER {
		DECL_REGISTER(RTC_PRER_BASE);
		constexpr static RegisterField<RTC_PRER_PREDIV_S> PREDIV_S {};
		constexpr static RegisterField<RTC_PRER_PREDIV_A> PREDIV_A {};
	};

	struct WUTR {
		DECL_REGISTER(RTC_WUTR_BASE);
		constexpr static RegisterField<RTC_WUTR_WUT> WUT {};
	};

	struct CR {
		DECL_REGISTER(RTC_CR_BASE);
		constexpr static RegisterField<RTC_CR_WUCKSEL> WUCKSEL {};
		constexpr static RegisterField<RTC_CR_TSEDGE> TSEDGE {};
		constexpr static RegisterField<RTC_CR_REFCKON> REFCKON {};
		constexpr static RegisterField<RTC_CR_BYPSHAD> BYPSHAD {};
		constexpr static RegisterField<RTC_CR_FMT> FMT {};
		constexpr static RegisterField<RTC_CR_ALRAE> ALRAE {};
		constexpr static RegisterField<RTC_CR_ALRBE> ALRBE {};
		constexpr static RegisterField<RTC_CR_WUTE> WUTE {};
		constexpr static RegisterField<RTC_CR_TSE> TSE {};
		constexpr static RegisterField<RTC_CR_ALRAIE> ALRAIE {};
		constexpr static RegisterField<RTC_CR_ALRBIE> ALRBIE {};
		constexpr static RegisterField<RTC_CR_WUTIE> WUTIE {};
		constexpr static RegisterField<RTC_CR_TSIE> TSIE {};
		constexpr static RegisterField<RTC_CR_ADD1H> ADD1H {};
		constexpr static RegisterField<RTC_CR_SUB1H> SUB1H {};
		constexpr static RegisterField<RTC_CR_BKP> BKP {};
		constexpr static RegisterField<RTC_CR_COSEL> COSEL {};
		constexpr static RegisterField<RTC_CR_POL> POL {};
		constexpr static RegisterField<RTC_CR_OSEL> OSEL {};
		constexpr static RegisterField<RTC_CR_COE> COE {};
		constexpr static RegisterField<RTC_CR_ITSE> ITSE {};
		constexpr static RegisterField<RTC_CR_TAMPTS> TAMPTS {};
		constexpr static RegisterField<RTC_CR_TAMPOE> TAMPOE {};
		constexpr static RegisterField<RTC_CR_TAMPALRM_PU> TAMPALRM_PU {};
		constexpr static RegisterField<RTC_CR_TAMPALRM_TYPE> TAMPALRM_TYPE {};
		constexpr static RegisterField<RTC_CR_OUT2EN> OUT2EN {};
	};

	struct WPR {
		DECL_REGISTER(RTC_WPR_BASE);
		constexpr static RegisterField<RTC_WPR_KEY> KEY {};
	};

	struct CALR {
		DECL_REGISTER(RTC_CALR_BASE);
		constexpr static RegisterField<RTC_CALR_CALM> CALM {};
		constexpr static RegisterField<RTC_CALR_CALW16> CALW16 {};
		constexpr static RegisterField<RTC_CALR_CALW8> CALW8 {};
		constexpr static RegisterField<RTC_CALR_CALP> CALP {};
	};

	struct SHIFTR {
		DECL_REGISTER(RTC_SHIFTR_BASE);
		constexpr static RegisterField<RTC_SHIFTR_SUBFS> SUBFS {};
		constexpr static RegisterField<RTC_SHIFTR_ADD1S> ADD1S {};
	};

	struct TSTR {
		DECL_REGISTER(RTC_TSTR_BASE);
		constexpr static RegisterField<RTC_TSTR_SU> SU {};
		constexpr static RegisterField<RTC_TSTR_ST> ST {};
		constexpr static RegisterField<RTC_TSTR_MNU> MNU {};
		constexpr static RegisterField<RTC_TSTR_MNT> MNT {};
		constexpr static RegisterField<RTC_TSTR_HU> HU {};
		constexpr static RegisterField<RTC_TSTR_HT> HT {};
		constexpr static RegisterField<RTC_TSTR_PM> PM {};
	};

	struct TSDR {
		DECL_REGISTER(RTC_TSDR_BASE);
		constexpr static RegisterField<RTC_TSDR_DU> DU {};
		constexpr static RegisterField<RTC_TSDR_DT> DT {};
		constexpr static RegisterField<RTC_TSDR_MU> MU {};
		constexpr static RegisterField<RTC_TSDR_MT> MT {};
		constexpr static RegisterField<RTC_TSDR_WDU> WDU {};
	};

	struct TSSSR {
		DECL_REGISTER(RTC_TSSSR_BASE);
		constexpr static RegisterField<RTC_TSSSR_SS> SS {};
	};

	struct ALRMAR {
		DECL_REGISTER(RTC_ALRMAR_BASE);
		constexpr static RegisterField<RTC_ALRMAR_SU> SU {};
		constexpr static RegisterField<RTC_ALRMAR_ST> ST {};
		constexpr static RegisterField<RTC_ALRMAR_MSK1> MSK1 {};
		constexpr static RegisterField<RTC_ALRMAR_MNU> MNU {};
		constexpr static RegisterField<RTC_ALRMAR_MNT> MNT {};
		constexpr static RegisterField<RTC_ALRMAR_MSK2> MSK2 {};
		constexpr static RegisterField<RTC_ALRMAR_HU> HU {};
		constexpr static RegisterField<RTC_ALRMAR_HT> HT {};
		constexpr static RegisterField<RTC_ALRMAR_PM> PM {};
		constexpr static RegisterField<RTC_ALRMAR_MSK3> MSK3 {};
		constexpr static RegisterField<RTC_ALRMAR_DU> DU {};
		constexpr static RegisterField<RTC_ALRMAR_DT> DT {};
		constexpr static RegisterField<RTC_ALRMAR_WDSEL> WDSEL {};
		constexpr static RegisterField<RTC_ALRMAR_MSK4> MSK4 {};
	};

	struct ALRMASSR {
		DECL_REGISTER(RTC_ALRMASSR_BASE);
		constexpr static RegisterField<RTC_ALRMASSR_SS> SS {};
		constexpr static RegisterField<RTC_ALRMASSR_MASKSS> MASKSS {};
	};

	struct ALRMBR {
		DECL_REGISTER(RTC_ALRMBR_BASE);
		constexpr static RegisterField<RTC_ALRMBR_SU> SU {};
		constexpr static RegisterField<RTC_ALRMBR_ST> ST {};
		constexpr static RegisterField<RTC_ALRMBR_MSK1> MSK1 {};
		constexpr static RegisterField<RTC_ALRMBR_MNU> MNU {};
		constexpr static RegisterField<RTC_ALRMBR_MNT> MNT {};
		constexpr static RegisterField<RTC_ALRMBR_MSK2> MSK2 {};
		constexpr static RegisterField<RTC_ALRMBR_HU> HU {};
		constexpr static RegisterField<RTC_ALRMBR_HT> HT {};
		constexpr static RegisterField<RTC_ALRMBR_PM> PM {};
		constexpr static RegisterField<RTC_ALRMBR_MSK3> MSK3 {};
		constexpr static RegisterField<RTC_ALRMBR_DU> DU {};
		constexpr static RegisterField<RTC_ALRMBR_DT> DT {};
		constexpr static RegisterField<RTC_ALRMBR_WDSEL> WDSEL {};
		constexpr static RegisterField<RTC_ALRMBR_MSK4> MSK4 {};
	};

	struct ALRMBSSR {
		DECL_REGISTER(RTC_ALRMBSSR_BASE);
		constexpr static RegisterField<RTC_ALRMBSSR_SS> SS {};
		constexpr static RegisterField<RTC_ALRMBSSR_MASKSS> MASKSS {};
	};

	struct SR {
		DECL_REGISTER(RTC_SR_BASE);
		constexpr static RegisterField<RTC_SR_ALRAF> ALRAF {};
		constexpr static RegisterField<RTC_SR_ALRBF> ALRBF {};
		constexpr static RegisterField<RTC_SR_WUTF> WUTF {};
		constexpr static RegisterField<RTC_SR_TSF> TSF {};
		constexpr static RegisterField<RTC_SR_TSOVF> TSOVF {};
		constexpr static RegisterField<RTC_SR_ITSF> ITSF {};
	};

	struct MISR {
		DECL_REGISTER(RTC_MISR_BASE);
		constexpr static RegisterField<RTC_MISR_ALRAMF> ALRAMF {};
		constexpr static RegisterField<RTC_MISR_ALRBMF> ALRBMF {};
		constexpr static RegisterField<RTC_MISR_WUTMF> WUTMF {};
		constexpr static RegisterField<RTC_MISR_TSMF> TSMF {};
		constexpr static RegisterField<RTC_MISR_TSOVMF> TSOVMF {};
		constexpr static RegisterField<RTC_MISR_ITSMF> ITSMF {};
	};

	struct SCR {
		DECL_REGISTER(RTC_SCR_BASE);
		constexpr static RegisterField<RTC_SCR_CALRAF> CALRAF {};
		constexpr static RegisterField<RTC_SCR_CALRBF> CALRBF {};
		constexpr static RegisterField<RTC_SCR_CWUTF> CWUTF {};
		constexpr static RegisterField<RTC_SCR_CTSF> CTSF {};
		constexpr static RegisterField<RTC_SCR_CTSOVF> CTSOVF {};
		constexpr static RegisterField<RTC_SCR_CITSF> CITSF {};
	};

	struct HWCFGR {
		DECL_REGISTER(RTC_HWCFGR_BASE);
		constexpr static RegisterField<RTC_HWCFGR_ALARMB> ALARMB {};
		constexpr static RegisterField<RTC_HWCFGR_WAKEUP> WAKEUP {};
		constexpr static RegisterField<RTC_HWCFGR_SMOOTH_CALIB> SMOOTH_CALIB {};
		constexpr static RegisterField<RTC_HWCFGR_TIMESTAMP> TIMESTAMP {};
		constexpr static RegisterField<RTC_HWCFGR_OPTIONREG_OUT> OPTIONREG_OUT {};
		constexpr static RegisterField<RTC_HWCFGR_TRUST_ZONE> TRUST_ZONE {};
	};

	struct VERR {
		DECL_REGISTER(RTC_VERR_BASE);
		constexpr static RegisterField<RTC_VERR_MINREV> MINREV {};
		constexpr static RegisterField<RTC_VERR_MAJREV> MAJREV {};
	};

	struct IPIDR {
		DECL_REGISTER(RTC_IPIDR_BASE);
		constexpr static RegisterField<RTC_IPIDR_IPID> IPID {};
	};

	struct SIDR {
		DECL_REGISTER(RTC_SIDR_BASE);
		constexpr static RegisterField<RTC_SIDR_SID> SID {};
	};
...
struct TIM6 {
	struct CR1 {
		DECL_REGISTER(TIM6_CR1_BASE);
		constexpr static RegisterField<TIM6_CR1_CEN> CEN {};
		constexpr static RegisterField<TIM6_CR1_UDIS> UDIS {};
		constexpr static RegisterField<TIM6_CR1_URS> URS {};
		constexpr static RegisterField<TIM6_CR1_OPM> OPM {};
		constexpr static RegisterField<TIM6_CR1_ARPE> ARPE {};
		constexpr static RegisterField<TIM6_CR1_UIFREMAP> UIFREMAP {};
	};

	struct CR2 {
		DECL_REGISTER(TIM6_CR2_BASE);
		constexpr static RegisterField<TIM6_CR2_MMS> MMS {};
	};

	struct DIER {
		DECL_REGISTER(TIM6_DIER_BASE);
		constexpr static RegisterField<TIM6_DIER_UIE> UIE {};
		constexpr static RegisterField<TIM6_DIER_UDE> UDE {};
	};

	struct SR {
		DECL_REGISTER(TIM6_SR_BASE);
		constexpr static RegisterField<TIM6_SR_UIF> UIF {};
	};

	struct EGR {
		DECL_REGISTER(TIM6_EGR_BASE);
		constexpr static RegisterField<TIM6_EGR_UG> UG {};
	};

	struct CNT {
		DECL_REGISTER(TIM6_CNT_BASE);
		constexpr static RegisterField<TIM6_CNT_CNT> CNTV {};
		constexpr static RegisterField<TIM6_CNT_UIFCPY> UIFCPY {};
	};

	struct PSC {
		DECL_REGISTER(TIM6_PSC_BASE);
		constexpr static RegisterField<TIM6_PSC_PSC> PSCV {};
	};

	struct ARR {
		DECL_REGISTER(TIM6_ARR_BASE);
		constexpr static RegisterField<TIM6_ARR_ARR> ARRV {};
	};
...
struct TIM7 {
	struct CR1 {
		DECL_REGISTER(TIM7_CR1_BASE);
		constexpr static RegisterField<TIM7_CR1_CEN> CEN {};
		constexpr static RegisterField<TIM7_CR1_UDIS> UDIS {};
		constexpr static RegisterField<TIM7_CR1_URS> URS {};
		constexpr static RegisterField<TIM7_CR1_OPM> OPM {};
		constexpr static RegisterField<TIM7_CR1_ARPE> ARPE {};
		constexpr static RegisterField<TIM7_CR1_UIFREMAP> UIFREMAP {};
	};

	struct CR2 {
		DECL_REGISTER(TIM7_CR2_BASE);
		constexpr static RegisterField<TIM7_CR2_MMS> MMS {};
	};

	struct DIER {
		DECL_REGISTER(TIM7_DIER_BASE);
		constexpr static RegisterField<TIM7_DIER_UIE> UIE {};
		constexpr static RegisterField<TIM7_DIER_UDE> UDE {};
	};

	struct SR {
		DECL_REGISTER(TIM7_SR_BASE);
		constexpr static RegisterField<TIM7_SR_UIF> UIF {};
	};

	struct EGR {
		DECL_REGISTER(TIM7_EGR_BASE);
		constexpr static RegisterField<TIM7_EGR_UG> UG {};
	};

	struct CNT {
		DECL_REGISTER(TIM7_CNT_BASE);
		constexpr static RegisterField<TIM7_CNT_CNT> CNTV {};
		constexpr static RegisterField<TIM7_CNT_UIFCPY> UIFCPY {};
	};

	struct PSC {
		DECL_REGISTER(TIM7_PSC_BASE);
		constexpr static RegisterField<TIM7_PSC_PSC> PSCV {};
	};

	struct ARR {
		DECL_REGISTER(TIM7_ARR_BASE);
		constexpr static RegisterField<TIM7_ARR_ARR> ARRV {};
	};
...
struct VREFBUF {
	struct VREFBUF_CSR {
		DECL_REGISTER(VREFBUF_VREFBUF_CSR_BASE);
		constexpr static RegisterField<VREFBUF_VREFBUF_CSR_ENVR> ENVR {};
		constexpr static RegisterField<VREFBUF_VREFBUF_CSR_HIZ> HIZ {};
		constexpr static RegisterField<VREFBUF_VREFBUF_CSR_VRS> VRS {};
		constexpr static RegisterField<VREFBUF_VREFBUF_CSR_VRR> VRR {};
	};

	struct VREFBUF_CCR {
		DECL_REGISTER(VREFBUF_VREFBUF_CCR_BASE);
		constexpr static RegisterField<VREFBUF_VREFBUF_CCR_TRIM> TRIM {};
	};
